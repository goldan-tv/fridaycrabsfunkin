...
class HXCPP_CLASS_ATTRIBUTES GraphicInteractive_obj : public  ::openfl::display::BitmapData_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< GraphicInteractive_obj > __new(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
		static ::hx::ObjectPtr< GraphicInteractive_obj > __alloc(::hx::Ctx *_hx_ctx,int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA);
