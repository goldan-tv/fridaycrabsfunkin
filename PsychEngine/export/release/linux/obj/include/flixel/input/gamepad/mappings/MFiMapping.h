...
class HXCPP_CLASS_ATTRIBUTES MFiMapping_obj : public  ::flixel::input::gamepad::mappings::FlxGamepadMapping_obj
{
	...
	public:
		...
		static ::hx::ObjectPtr< MFiMapping_obj > __alloc(::hx::Ctx *_hx_ctx, ::flixel::input::gamepad::FlxGamepadAttachment attachment);
		...
		::String __ToString() const { return HX_("MFiMapping",fe,35,e5,0b); }
