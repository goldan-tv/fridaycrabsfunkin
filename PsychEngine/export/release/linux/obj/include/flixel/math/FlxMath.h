...
class HXCPP_CLASS_ATTRIBUTES FlxMath_obj : public ::hx::Object
{
	...
	public:
		...
		static int distanceToPoint( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Target);
		static ::Dynamic distanceToPoint_dyn();

		static bool isDistanceToPointWithin( ::flixel::FlxSprite Sprite, ::flixel::math::FlxBasePoint Target,Float Distance,::hx::Null< bool >  IncludeEqual);
