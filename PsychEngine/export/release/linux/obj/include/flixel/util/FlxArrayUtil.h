...
class HXCPP_CLASS_ATTRIBUTES FlxArrayUtil_obj : public ::hx::Object
{
	...
	public:
		...
		static ::cpp::VirtualArray swapByIndex(::cpp::VirtualArray array,int index1,int index2);
		static ::Dynamic swapByIndex_dyn();

		static ::cpp::VirtualArray safeSwapByIndex(::cpp::VirtualArray array,int index1,int index2);
		static ::Dynamic safeSwapByIndex_dyn();

		static ::cpp::VirtualArray swap(::cpp::VirtualArray array, ::Dynamic item1, ::Dynamic item2);
		static ::Dynamic swap_dyn();

		static ::cpp::VirtualArray safeSwap(::cpp::VirtualArray array, ::Dynamic item1, ::Dynamic item2);
		static ::Dynamic safeSwap_dyn();
		...
		static bool safeContains(::cpp::VirtualArray array, ::Dynamic element);
		static ::Dynamic safeContains_dyn();
