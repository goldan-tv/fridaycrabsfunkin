...
class HXCPP_CLASS_ATTRIBUTES FlxAtlas_obj : public ::hx::Object
{
	...
	public:
		...
		static ::hx::ObjectPtr< FlxAtlas_obj > __new(::String name,::hx::Null< bool >  __o_powerOfTwo,::hx::Null< int >  __o_border,::hx::Null< bool >  __o_rotate, ::flixel::math::FlxBasePoint minSize, ::flixel::math::FlxBasePoint maxSize);
		static ::hx::ObjectPtr< FlxAtlas_obj > __alloc(::hx::Ctx *_hx_ctx,::String name,::hx::Null< bool >  __o_powerOfTwo,::hx::Null< int >  __o_border,::hx::Null< bool >  __o_rotate, ::flixel::math::FlxBasePoint minSize, ::flixel::math::FlxBasePoint maxSize);
		...
		static  ::flixel::math::FlxBasePoint defaultMinSize;
		static  ::flixel::math::FlxBasePoint defaultMaxSize;
