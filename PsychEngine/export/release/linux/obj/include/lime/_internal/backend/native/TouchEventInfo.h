...
HX_DECLARE_STACK_FRAME(_hx_pos_dc6fd8f0bbdab31a_918_new)
...
HXLINE( 919)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 920)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->x = x;
HXLINE( 921)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->y = y;
HXLINE( 922)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->id = id;
HXLINE( 923)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dx = dx;
HXLINE( 924)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->dy = dy;
HXLINE( 925)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->pressure = pressure;
HXLINE( 926)		( ( ::lime::_internal::backend::native::TouchEventInfo)(__this) )->device = device;
            	}
