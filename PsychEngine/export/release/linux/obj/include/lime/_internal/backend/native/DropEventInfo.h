...
HX_DECLARE_STACK_FRAME(_hx_pos_a21879e7650910f2_678_new)
...
HXLINE( 679)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->type = ( (int)(type) );
HXLINE( 680)		( ( ::lime::_internal::backend::native::DropEventInfo)(__this) )->file = file;
            	}
