...
#define INCLUDED_objects_CheckboxThingie
...
HX_DECLARE_CLASS1(objects,CheckboxThingie)
...
class HXCPP_CLASS_ATTRIBUTES CheckboxThingie_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		enum { _hx_ClassId = 0x02ec3fff };

		void __construct(::hx::Null< Float >  __o_x,::hx::Null< Float >  __o_y, ::Dynamic __o_checked);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="objects.CheckboxThingie")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"objects.CheckboxThingie"); }
...
#endif /* INCLUDED_objects_CheckboxThingie */ 
