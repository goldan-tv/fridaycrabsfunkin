...
#define INCLUDED_objects_AttachedText
...
HX_DECLARE_CLASS1(objects,AttachedText)

namespace objects{


class HXCPP_CLASS_ATTRIBUTES AttachedText_obj : public  ::objects::Alphabet_obj
{
	public:
	...
	public:
		enum { _hx_ClassId = 0x3c49ca5d };

		void __construct(::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold, ::Dynamic __o_scale);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="objects.AttachedText")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"objects.AttachedText"); }
...
#endif /* INCLUDED_objects_AttachedText */ 
