...
#define INCLUDED_shaders_ColorSwap
...
class HXCPP_CLASS_ATTRIBUTES ColorSwap_obj : public ::hx::Object
{
	...
	public:
		enum { _hx_ClassId = 0x6d398e88 };

		void __construct();
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="shaders.ColorSwap")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"shaders.ColorSwap"); }
...
#endif /* INCLUDED_shaders_ColorSwap */ 
