...
#define INCLUDED_states_stages_objects_TankmenBG
...
HX_DECLARE_CLASS3(states,stages,objects,TankmenBG)
...
class HXCPP_CLASS_ATTRIBUTES TankmenBG_obj : public  ::flixel::FlxSprite_obj
{
	...
	public:
		enum { _hx_ClassId = 0x2a940a58 };

		void __construct(Float x,Float y,bool facingRight);
		inline void *operator new(size_t inSize, bool inContainer=true,const char *inName="states.stages.objects.TankmenBG")
			{ return ::hx::Object::operator new(inSize,inContainer,inName); }
		inline void *operator new(size_t inSize, int extra)
			{ return ::hx::Object::operator new(inSize+extra,true,"states.stages.objects.TankmenBG"); }
...
#endif /* INCLUDED_states_stages_objects_TankmenBG */ 
