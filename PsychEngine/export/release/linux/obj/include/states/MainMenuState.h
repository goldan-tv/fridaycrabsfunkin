...
class HXCPP_CLASS_ATTRIBUTES MainMenuState_obj : public  ::backend::MusicBeatState_obj
{
	...
	public:
		...
		static  ::states::MainMenuColumn curColumn;
		static bool showOutdatedWarning;
		bool allowMouse;
		 ::flixel::group::FlxTypedGroup menuItems;
		 ::flixel::FlxSprite leftItem;
		 ::flixel::FlxSprite rightItem;
		...
		::Dynamic createMenuItem_dyn();

		bool selectedSomethin;
		Float timeNotMoving;
		void update(Float elapsed);

		void changeItem(::hx::Null< int >  change);
