...
HXLINE( 121)					path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath);
HXLINE( 125)					worker->sendComplete(( ( ::Dynamic)(path) ));
            				}
            				break;
            				case (int)1: {
HXLINE( 129)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 129)						title1[0] = HX_("Open Files",a1,d5,ea,6e);
            					}
HXLINE( 132)					 ::hx::Object * paths = ::hx::DynamicPtr(null());
HXLINE( 145)					paths = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_files(title1->__get(0),filter,defaultPath);
...
HXLINE( 176)					 ::hx::Object * path1 = ::hx::DynamicPtr(null());
HXLINE( 185)					path1 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath);
HXLINE( 189)					worker->sendComplete(( ( ::Dynamic)(path1) ));
            				}
            				break;
            				case (int)3: {
HXLINE( 153)					if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 153)						title1[0] = HX_("Open Directory",97,c6,32,a3);
            					}
HXLINE( 156)					 ::hx::Object * path2 = ::hx::DynamicPtr(null());
HXLINE( 165)					path2 = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_directory(title1->__get(0),filter,defaultPath);
HXLINE( 169)					worker->sendComplete(( ( ::Dynamic)(path2) ));
            				}
            				break;
            			}
            		}
...
HXLINE( 203)							_hx_tmp2 = ::hx::IsNotNull( filter );
            						}
            						else {
HXLINE( 203)							_hx_tmp2 = false;
            						}
HXDLIN( 203)						if (_hx_tmp2) {
HXLINE( 203)							_hx_tmp1 = (path.indexOf(HX_(".",2e,00,00,00),null()) == -1);
            						}
            						else {
...
HXLINE( 257)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 257)				title1[0] = HX_("Open File",92,6a,32,1d);
            			}
HXLINE( 260)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 266)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_open_file(title1->__get(0),filter,defaultPath);
...
HXDLIN( 250)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 254)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(worker,filter,title1,defaultPath)),null(),null());
...
HXLINE( 327)			if (::hx::IsNull( title1->__get(0) )) {
HXLINE( 327)				title1[0] = HX_("Save File",3f,02,ba,38);
            			}
HXLINE( 330)			 ::hx::Object * path = ::hx::DynamicPtr(null());
HXLINE( 336)			path = ::lime::_internal::backend::native::NativeCFFI_obj::lime_file_dialog_save_file(title1->__get(0),filter,defaultPath);
...
HXDLIN( 314)		::Array< ::String > title1 = ::Array_obj< ::String >::__new(1)->init(0,title);
...
HXLINE( 324)		worker->doWork->add( ::Dynamic(new _hx_Closure_0(worker,filter,title1,defaultPath)),null(),null());
