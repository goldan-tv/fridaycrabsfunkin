...
HX_LOCAL_STACK_FRAME(_hx_pos_1f03a5186095f658_81_get_guid,"lime.ui.Joystick","get_guid",0xa0372443,"lime.ui.Joystick.get_guid","lime/ui/Joystick.hx",81,0x26e848e1)
...
::String Joystick_obj::get_guid(){
            	HX_STACKFRAME(&_hx_pos_1f03a5186095f658_81_get_guid)
HXDLIN(  81)		return ( ( ::Dynamic)(::lime::_internal::backend::native::NativeCFFI_obj::lime_joystick_get_device_guid(this->id)) );
            	}
