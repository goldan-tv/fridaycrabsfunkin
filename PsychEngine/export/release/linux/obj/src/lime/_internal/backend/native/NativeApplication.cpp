...
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_363_handleRenderEvent,"lime._internal.backend.native.NativeApplication","handleRenderEvent",0x1dcebc95,"lime._internal.backend.native.NativeApplication.handleRenderEvent","lime/_internal/backend/native/NativeApplication.hx",363,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_415_handleSensorEvent,"lime._internal.backend.native.NativeApplication","handleSensorEvent",0x98787b31,"lime._internal.backend.native.NativeApplication.handleSensorEvent","lime/_internal/backend/native/NativeApplication.hx",415,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_425_handleTextEvent,"lime._internal.backend.native.NativeApplication","handleTextEvent",0xd6b1219e,"lime._internal.backend.native.NativeApplication.handleTextEvent","lime/_internal/backend/native/NativeApplication.hx",425,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_446_handleTouchEvent,"lime._internal.backend.native.NativeApplication","handleTouchEvent",0xa647254a,"lime._internal.backend.native.NativeApplication.handleTouchEvent","lime/_internal/backend/native/NativeApplication.hx",446,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_507_handleWindowEvent,"lime._internal.backend.native.NativeApplication","handleWindowEvent",0x42f025bb,"lime._internal.backend.native.NativeApplication.handleWindowEvent","lime/_internal/backend/native/NativeApplication.hx",507,0xc1eba895)
HX_LOCAL_STACK_FRAME(_hx_pos_8a85bd2a97260674_579_updateTimer,"lime._internal.backend.native.NativeApplication","updateTimer",0xd6c37ab5,"lime._internal.backend.native.NativeApplication.updateTimer","lime/_internal/backend/native/NativeApplication.hx",579,0xc1eba895)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE(  52)		this->mouseEventInfo =  ::lime::_internal::backend::native::MouseEventInfo_obj::__alloc( HX_CTX ,null(),null(),null(),null(),null(),null(),null(),null());
...
HXLINE( 335)			switch((int)(this->mouseEventInfo->type)){
            				case (int)0: {
HXLINE( 338)					window->clickCount = this->mouseEventInfo->clickCount;
HXLINE( 339)					window->onMouseDown->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
HXLINE( 340)					window->clickCount = 0;
            				}
            				break;
            				case (int)1: {
HXLINE( 343)					window->clickCount = this->mouseEventInfo->clickCount;
HXLINE( 344)					window->onMouseUp->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,this->mouseEventInfo->button);
HXLINE( 345)					window->clickCount = 0;
            				}
            				break;
            				case (int)2: {
HXLINE( 348)					window->onMouseMove->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y);
HXLINE( 349)					window->onMouseMoveRelative->dispatch(this->mouseEventInfo->movementX,this->mouseEventInfo->movementY);
            				}
            				break;
            				case (int)3: {
HXLINE( 352)					window->onMouseWheel->dispatch(this->mouseEventInfo->x,this->mouseEventInfo->y,::lime::ui::MouseWheelMode_obj::UNKNOWN_dyn());
            				}
            				break;
            				default:{
            				}
...
void NativeApplication_obj::handleRenderEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_363_handleRenderEvent)
HXDLIN( 363)		int _g = 0;
HXDLIN( 363)		::Array< ::Dynamic> _g1 = this->parent->_hx___windows;
HXDLIN( 363)		while((_g < _g1->length)){
HXDLIN( 363)			 ::lime::ui::Window window = _g1->__get(_g).StaticCast<  ::lime::ui::Window >();
HXDLIN( 363)			_g = (_g + 1);
HXLINE( 365)			if (::hx::IsNull( window )) {
HXLINE( 365)				continue;
            			}
HXLINE( 369)			switch((int)(this->renderEventInfo->type)){
            				case (int)0: {
HXLINE( 372)					if (::hx::IsNotNull( window->context )) {
HXLINE( 374)						window->_hx___backend->render();
HXLINE( 375)						window->onRender->dispatch(window->context);
HXLINE( 377)						if (!(window->onRender->canceled)) {
HXLINE( 379)							window->_hx___backend->contextFlip();
            						}
            					}
            				}
            				break;
...
HXDLIN( 384)					if (window->_hx___backend->useHardware) {
HXLINE( 384)						_hx_tmp = ::hx::IsNotNull( window->context );
            					}
            					else {
HXLINE( 384)						_hx_tmp = false;
            					}
HXDLIN( 384)					if (_hx_tmp) {
HXLINE( 386)						::String _hx_switch_0 = window->context->type;
            						if (  (_hx_switch_0==HX_("opengl",6f,64,94,21)) ||  (_hx_switch_0==HX_("opengles",9d,f6,c9,fa)) ||  (_hx_switch_0==HX_("webgl",b9,4b,bc,c7)) ){
HXLINE( 390)							 ::lime::_internal::backend::native::NativeOpenGLRenderContext gl = window->context->gl;
HXLINE( 391)							gl->_hx___contextLost();
HXLINE( 392)							if (::hx::IsInstanceEq( ::lime::graphics::opengl::GL_obj::context,gl )) {
HXLINE( 392)								::lime::graphics::opengl::GL_obj::context = null();
            							}
HXLINE( 388)							goto _hx_goto_14;
            						...
            						_hx_goto_14:;
HXLINE( 398)						window->context = null();
HXLINE( 399)						window->onRenderContextLost->dispatch();
            					}
            				}
            				break;
            				case (int)2: {
HXLINE( 403)					if (window->_hx___backend->useHardware) {
HXLINE( 408)						window->onRenderContextRestored->dispatch(window->context);
            					}
            				}
            				break;
            			}
...
void NativeApplication_obj::handleSensorEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_415_handleSensorEvent)
HXLINE( 416)		 ::lime::_hx_system::Sensor sensor = ( ( ::lime::_hx_system::Sensor)(::lime::_hx_system::Sensor_obj::sensorByID->get(this->sensorEventInfo->id)) );
HXLINE( 418)		if (::hx::IsNotNull( sensor )) {
HXLINE( 420)			sensor->onUpdate->dispatch(this->sensorEventInfo->x,this->sensorEventInfo->y,this->sensorEventInfo->z);
            		}
            	}
...
void NativeApplication_obj::handleTextEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_425_handleTextEvent)
HXLINE( 426)		 ::lime::ui::Window window = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->textEventInfo->windowID)) );
HXLINE( 428)		if (::hx::IsNotNull( window )) {
HXLINE( 430)			switch((int)(this->textEventInfo->type)){
            				case (int)0: {
HXLINE( 433)					window->onTextInput->dispatch(this->textEventInfo->text);
            				}
            				break;
            				case (int)1: {
HXLINE( 436)					window->onTextEdit->dispatch(this->textEventInfo->text,this->textEventInfo->start,this->textEventInfo->length);
            				}
            				break;
            				default:{
            				}
...
void NativeApplication_obj::handleTouchEvent(){
            	HX_GC_STACKFRAME(&_hx_pos_8a85bd2a97260674_446_handleTouchEvent)
HXDLIN( 446)		switch((int)(this->touchEventInfo->type)){
            			case (int)0: {
HXLINE( 449)				 ::lime::ui::Touch touch = this->unusedTouchesPool->pop().StaticCast<  ::lime::ui::Touch >();
HXLINE( 451)				if (::hx::IsNull( touch )) {
HXLINE( 453)					touch =  ::lime::ui::Touch_obj::__alloc( HX_CTX ,this->touchEventInfo->x,this->touchEventInfo->y,this->touchEventInfo->id,this->touchEventInfo->dx,this->touchEventInfo->dy,this->touchEventInfo->pressure,this->touchEventInfo->device);
            				}
            				else {
...
HXLINE( 467)				this->currentTouches->set(touch->id,touch);
HXLINE( 469)				::lime::ui::Touch_obj::onStart->dispatch(touch);
            			}
            			break;
            			case (int)1: {
HXLINE( 472)				 ::lime::ui::Touch touch1 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 474)				if (::hx::IsNotNull( touch1 )) {
HXLINE( 476)					touch1->x = this->touchEventInfo->x;
HXLINE( 477)					touch1->y = this->touchEventInfo->y;
HXLINE( 478)					touch1->dx = this->touchEventInfo->dx;
HXLINE( 479)					touch1->dy = this->touchEventInfo->dy;
HXLINE( 480)					touch1->pressure = this->touchEventInfo->pressure;
HXLINE( 482)					::lime::ui::Touch_obj::onEnd->dispatch(touch1);
HXLINE( 484)					this->currentTouches->remove(this->touchEventInfo->id);
HXLINE( 485)					this->unusedTouchesPool->add(touch1);
            				}
            			}
            			break;
            			case (int)2: {
HXLINE( 489)				 ::lime::ui::Touch touch2 = ( ( ::lime::ui::Touch)(this->currentTouches->get(this->touchEventInfo->id)) );
HXLINE( 491)				if (::hx::IsNotNull( touch2 )) {
HXLINE( 493)					touch2->x = this->touchEventInfo->x;
HXLINE( 494)					touch2->y = this->touchEventInfo->y;
HXLINE( 495)					touch2->dx = this->touchEventInfo->dx;
HXLINE( 496)					touch2->dy = this->touchEventInfo->dy;
HXLINE( 497)					touch2->pressure = this->touchEventInfo->pressure;
HXLINE( 499)					::lime::ui::Touch_obj::onMove->dispatch(touch2);
            				}
            			}
            			break;
            			default:{
...
void NativeApplication_obj::handleWindowEvent(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_507_handleWindowEvent)
HXLINE( 508)		 ::lime::ui::Window window = ( ( ::lime::ui::Window)(this->parent->_hx___windowByID->get(this->windowEventInfo->windowID)) );
HXLINE( 510)		if (::hx::IsNotNull( window )) {
HXLINE( 512)			switch((int)(this->windowEventInfo->type)){
            				case (int)0: {
HXLINE( 515)					this->advanceTimer();
HXLINE( 516)					window->onActivate->dispatch();
HXLINE( 517)					::lime::media::AudioManager_obj::resume();
            				}
            				break;
            				case (int)1: {
HXLINE( 520)					window->close();
            				}
            				break;
            				case (int)2: {
HXLINE( 523)					window->onDeactivate->dispatch();
HXLINE( 524)					::lime::media::AudioManager_obj::suspend();
HXLINE( 525)					this->pauseTimer = ::lime::_hx_system::System_obj::getTimer();
            				}
            				break;
            				case (int)3: {
HXLINE( 528)					window->onEnter->dispatch();
            				}
            				break;
            				case (int)4: {
HXLINE( 531)					window->onExpose->dispatch();
            				}
            				break;
            				case (int)5: {
HXLINE( 534)					window->onFocusIn->dispatch();
            				}
            				break;
            				case (int)6: {
HXLINE( 537)					window->onFocusOut->dispatch();
            				}
            				break;
            				case (int)7: {
HXLINE( 540)					window->onLeave->dispatch();
            				}
            				break;
            				case (int)8: {
HXLINE( 543)					window->_hx___maximized = true;
HXLINE( 544)					window->_hx___fullscreen = false;
HXLINE( 545)					window->_hx___minimized = false;
HXLINE( 546)					window->onMaximize->dispatch();
            				}
            				break;
            				case (int)9: {
HXLINE( 549)					window->_hx___minimized = true;
HXLINE( 550)					window->_hx___maximized = false;
HXLINE( 551)					window->_hx___fullscreen = false;
HXLINE( 552)					window->onMinimize->dispatch();
            				}
            				break;
            				case (int)10: {
HXLINE( 555)					window->_hx___x = this->windowEventInfo->x;
HXLINE( 556)					window->_hx___y = this->windowEventInfo->y;
HXLINE( 557)					window->onMove->dispatch(( (Float)(this->windowEventInfo->x) ),( (Float)(this->windowEventInfo->y) ));
            				}
            				break;
            				case (int)11: {
...
HXLINE( 567)					window->onRestore->dispatch();
            				...
            				break;
            				case (int)13: {
HXLINE( 570)					window->onShow->dispatch();
            				}
            				break;
            				case (int)14: {
HXLINE( 573)					window->onHide->dispatch();
            				}
            				break;
            			}
            		}
...
void NativeApplication_obj::updateTimer(){
            	HX_STACKFRAME(&_hx_pos_8a85bd2a97260674_579_updateTimer)
HXLINE( 581)		if ((::haxe::Timer_obj::sRunningTimers->length > 0)) {
HXLINE( 583)			int currentTime = ::lime::_hx_system::System_obj::getTimer();
HXLINE( 584)			bool foundNull = false;
HXLINE( 585)			 ::haxe::Timer timer;
HXLINE( 587)			{
HXLINE( 587)				int _g = 0;
HXDLIN( 587)				int _g1 = ::haxe::Timer_obj::sRunningTimers->length;
HXDLIN( 587)				while((_g < _g1)){
HXLINE( 587)					_g = (_g + 1);
HXDLIN( 587)					int i = (_g - 1);
HXLINE( 589)					timer = ::haxe::Timer_obj::sRunningTimers->__get(i).StaticCast<  ::haxe::Timer >();
HXLINE( 591)					if (::hx::IsNotNull( timer )) {
HXLINE( 593)						bool _hx_tmp;
HXDLIN( 593)						if (timer->mRunning) {
HXLINE( 593)							_hx_tmp = (currentTime >= timer->mFireAt);
            						}
            						else {
HXLINE( 593)							_hx_tmp = false;
            						}
HXDLIN( 593)						if (_hx_tmp) {
HXLINE( 595)							 ::haxe::Timer timer1 = timer;
HXDLIN( 595)							timer1->mFireAt = (timer1->mFireAt + timer->mTime);
HXLINE( 596)							timer->run();
            						}
            					}
            					else {
HXLINE( 601)						foundNull = true;
            					}
            				}
            			}
HXLINE( 605)			if (foundNull) {
HXLINE( 607)				::Array< ::Dynamic> _g2 = ::Array_obj< ::Dynamic>::__new(0);
HXDLIN( 607)				{
HXLINE( 607)					int _g3 = 0;
HXDLIN( 607)					::Array< ::Dynamic> _g4 = ::haxe::Timer_obj::sRunningTimers;
HXDLIN( 607)					while((_g3 < _g4->length)){
HXLINE( 607)						 ::haxe::Timer v = _g4->__get(_g3).StaticCast<  ::haxe::Timer >();
HXDLIN( 607)						_g3 = (_g3 + 1);
HXDLIN( 607)						if (::hx::IsNotNull( v )) {
HXLINE( 607)							_g2->push(v);
            						}
            					}
            				}
HXDLIN( 607)				::haxe::Timer_obj::sRunningTimers = _g2;
            			}
            		}
HXLINE( 616)		::sys::thread::_Thread::Thread_Impl__obj::get_events(::sys::thread::_Thread::HaxeThread_obj::current())->progress();
            	}
