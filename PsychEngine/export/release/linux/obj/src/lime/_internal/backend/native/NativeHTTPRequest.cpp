...
HX_LOCAL_STACK_FRAME(_hx_pos_11449fe5de606ab4_611_multiProgressTimer_onRun,"lime._internal.backend.native.NativeHTTPRequest","multiProgressTimer_onRun",0x7d995edc,"lime._internal.backend.native.NativeHTTPRequest.multiProgressTimer_onRun","lime/_internal/backend/native/NativeHTTPRequest.hx",611,0xfe6a4b7e)
namespace lime{
namespace _internal{
namespace backend{
namespace native{
...
HXLINE( 415)		if (::StringTools_obj::startsWith(path,HX_("~/",f1,6d,00,00))) {
HXLINE( 417)			::String path1 = (::Sys_obj::getEnv(HX_("HOME",1f,92,d3,2f)) + HX_("/",2f,00,00,00));
HXDLIN( 417)			path = (path1 + path.substr(2,null()));
            		}
...
void NativeHTTPRequest_obj::localThreadPool_onError( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_466_localThreadPool_onError)
...
HXLINE( 468)		promise->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX , ::Dynamic(state->__Field(HX_("error",c8,cb,29,73),::hx::paccDynamic)),null()));
...
void NativeHTTPRequest_obj::multiThreadPool_onProgress( ::Dynamic state){
            	HX_GC_STACKFRAME(&_hx_pos_11449fe5de606ab4_559_multiThreadPool_onProgress)
...
HXLINE( 579)						::String error = instance->bytes->getString(0,instance->bytes->length,null());
HXLINE( 580)						 ::haxe::io::Bytes responseData = instance->buildBuffer();
HXLINE( 581)						 ::lime::app::Promise_haxe_io_Bytes instance2 = instance->promise;
HXDLIN( 581)						instance2->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error,responseData));
            					}
            					else {
HXLINE( 585)						::String error1 = ( (::String)((HX_("Status ",8e,8c,bf,03) + state->__Field(HX_("status",32,e7,fb,05),::hx::paccDynamic))) );
HXLINE( 586)						 ::haxe::io::Bytes responseData1 = instance->buildBuffer();
HXLINE( 587)						 ::lime::app::Promise_haxe_io_Bytes instance3 = instance->promise;
HXDLIN( 587)						instance3->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error1,responseData1));
            					}
            				}
            			}
            			else {
HXLINE( 592)				::String error2 = ::lime::net::curl::CURL_obj::strerror(( (int)(state->__Field(HX_("result",dd,68,84,08),::hx::paccDynamic)) ));
HXLINE( 593)				 ::lime::app::Promise_haxe_io_Bytes instance4 = instance->promise;
HXDLIN( 593)				instance4->error( ::lime::net::_HTTPRequestErrorResponse_obj::__alloc( HX_CTX ,error2,null()));
            			}
HXLINE( 596)			if (::hx::IsNotNull( instance->timeout )) {
HXLINE( 598)				instance->timeout->stop();
HXLINE( 599)				instance->timeout = null();
            			}
HXLINE( 602)			instance->bytes = null();
HXLINE( 603)			instance->promise = null();
            		}
HXLINE( 606)		state->__SetField(HX_("curl",ec,4a,c9,41),null(),::hx::paccDynamic);
            	}
...
void NativeHTTPRequest_obj::multiProgressTimer_onRun(){
            	HX_STACKFRAME(&_hx_pos_11449fe5de606ab4_611_multiProgressTimer_onRun)
HXDLIN( 611)		int _g = 0;
HXDLIN( 611)		::Array< ::Dynamic> _g1 = ::lime::_internal::backend::native::NativeHTTPRequest_obj::activeInstances;
HXDLIN( 611)		while((_g < _g1->length)){
HXDLIN( 611)			 ::lime::_internal::backend::native::NativeHTTPRequest instance = _g1->__get(_g).StaticCast<  ::lime::_internal::backend::native::NativeHTTPRequest >();
HXDLIN( 611)			_g = (_g + 1);
HXLINE( 613)			bool _hx_tmp;
HXDLIN( 613)			if ((instance->bytesLoaded == instance->writeBytesLoaded)) {
HXLINE( 613)				_hx_tmp = (instance->bytesTotal != instance->writeBytesTotal);
            			}
            			else {
HXLINE( 613)				_hx_tmp = true;
            			}
HXDLIN( 613)			if (_hx_tmp) {
HXLINE( 615)				instance->bytesLoaded = instance->writeBytesLoaded;
HXLINE( 616)				instance->bytesTotal = instance->writeBytesTotal;
HXLINE( 617)				instance->promise->progress(instance->bytesLoaded,instance->bytesTotal);
            			}
            		}
            	}
