...
HXLINE(  76)		if (::hx::IsNull( ::lime::_hx_system::Clipboard_obj::_text )) {
HXLINE(  78)			::lime::_hx_system::Clipboard_obj::_hx___update();
HXLINE(  82)			::lime::_hx_system::Clipboard_obj::set_text(::lime::_hx_system::Clipboard_obj::_text);
            		}
