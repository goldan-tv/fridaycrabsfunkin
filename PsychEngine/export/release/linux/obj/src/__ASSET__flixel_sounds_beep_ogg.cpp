...
HX_DEFINE_STACK_FRAME(_hx_pos_fa6bbd6c5d089215_41_new,"__ASSET__flixel_sounds_beep_ogg","new",0x0aaf31f8,"__ASSET__flixel_sounds_beep_ogg.new","lime/_internal/macros/AssetsMacro.hx",41,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_fa6bbd6c5d089215_146_boot,"__ASSET__flixel_sounds_beep_ogg","boot",0x46b5879a,"__ASSET__flixel_sounds_beep_ogg.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)

void __ASSET__flixel_sounds_beep_ogg_obj::__construct( ::Dynamic length,::Array< unsigned char > bytesData){
            	HX_STACKFRAME(&_hx_pos_fa6bbd6c5d089215_41_new)
HXLINE(  42)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET__:file___ASSET__flixel_sounds_beep_ogg",6d,0a,6e,70));
...
{
{
            	HX_STACKFRAME(&_hx_pos_fa6bbd6c5d089215_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:file___ASSET__flixel_sounds_beep_ogg",6d,0a,6e,70);
            	}
}
