...
HXDLIN(  61)				return this->convertSymbolToProperType(s);
            			...
            			if (_hx_e.IsClass< ::String >() && _hx_e->toString()!=null() ){
            				...
            				::String e1 = _hx_e;
HXLINE(  64)				HX_STACK_DO_THROW(((((this->fileName + HX_(" on line ",0b,0c,b3,49)) + this->currentLine) + HX_(": ",a6,32,00,00)) + e1));
            			}
...
HXLINE(  56)				if (::Std_obj::isOfType(_g1->value,::hx::ClassOf< ::String >())) {
HXLINE(  63)					::String e1 = ( (::String)(_g1->value) );
HXLINE(  64)					HX_STACK_DO_THROW(((((this->fileName + HX_(" on line ",0b,0c,b3,49)) + this->currentLine) + HX_(": ",a6,32,00,00)) + e1));
            				}
            				else {
HXDLIN(  56)					HX_STACK_DO_THROW(_g1);
            				}
            			}
            			else {
...
HXLINE(  79)					_hx_tmp2 = ::hx::IsNotNull( o->__Field(HX_("TJ_unserialize",de,34,26,eb),::hx::paccDynamic) );
            				}
            				else {
...
HXLINE( 252)									_hx_tmp4 = ::hx::IsLessEq( nc,57 );
            								}
            								else {
...
HXLINE( 254)										_hx_tmp5 = ::hx::IsLessEq( nc,70 );
            									}
            									else {
...
HXLINE( 256)											_hx_tmp6 = ::hx::IsLessEq( nc,102 );
            										}
            										else {
