...
HXLINE( 365)			HX_STACK_DO_THROW(HX_("Provided object is not an object.",9b,ce,cc,4a));
            		}
...
HXLINE( 380)				::String x1 = this->encodeMap(( ( ::haxe::ds::StringMap)(obj) ),st,0);
HXDLIN( 380)				if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 380)					buffer->flush();
            				}
HXDLIN( 380)				if (::hx::IsNull( buffer->b )) {
HXLINE( 380)					buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            				}
            				else {
HXLINE( 380)					::Array< ::String > buffer2 = buffer->b;
HXDLIN( 380)					buffer2->push(::Std_obj::string(x1));
            				}
            			}
            			else {
HXLINE( 382)				this->cacheEncode(obj);
HXLINE( 383)				{
HXLINE( 383)					::String x2 = this->encodeObject(obj,st,0);
HXDLIN( 383)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 383)						buffer->flush();
            					}
HXDLIN( 383)					if (::hx::IsNull( buffer->b )) {
HXLINE( 383)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            					}
            					else {
HXLINE( 383)						::Array< ::String > buffer3 = buffer->b;
HXDLIN( 383)						buffer3->push(::Std_obj::string(x2));
            					}
            				}
            			}
            		}
...
HXLINE( 404)						::String x1 = ::tjson::EncodeStyle_obj::entrySeperator(style,depth);
HXDLIN( 404)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 404)							buffer->flush();
            						}
HXDLIN( 404)						if (::hx::IsNull( buffer->b )) {
HXLINE( 404)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            						}
            						else {
HXLINE( 404)							::Array< ::String > buffer2 = buffer->b;
HXDLIN( 404)							buffer2->push(::Std_obj::string(x1));
            						}
            					}
            					else {
HXLINE( 405)						::String x2 = ::tjson::EncodeStyle_obj::firstEntry(style,depth);
HXDLIN( 405)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 405)							buffer->flush();
            						}
HXDLIN( 405)						if (::hx::IsNull( buffer->b )) {
HXLINE( 405)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            						}
            						else {
HXLINE( 405)							::Array< ::String > buffer3 = buffer->b;
HXDLIN( 405)							buffer3->push(::Std_obj::string(x2));
            						}
            					}
HXLINE( 406)					{
HXLINE( 406)						::String x3 = (HX_("\"_hxcls\"",05,d4,1f,f6) + ::tjson::EncodeStyle_obj::keyValueSeperator(style,depth));
HXDLIN( 406)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 406)							buffer->flush();
            						}
HXDLIN( 406)						if (::hx::IsNull( buffer->b )) {
HXLINE( 406)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            						}
            						else {
HXLINE( 406)							::Array< ::String > buffer4 = buffer->b;
HXDLIN( 406)							buffer4->push(::Std_obj::string(x3));
            						}
            					}
HXLINE( 407)					{
HXLINE( 407)						::String x4 = this->encodeValue(::Type_obj::getClassName(c),style,depth);
HXDLIN( 407)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 407)							buffer->flush();
            						}
HXDLIN( 407)						if (::hx::IsNull( buffer->b )) {
HXLINE( 407)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            						}
            						else {
HXLINE( 407)							::Array< ::String > buffer5 = buffer->b;
HXDLIN( 407)							buffer5->push(::Std_obj::string(x4));
            						}
            					}
...
HXLINE( 420)						::String x5 = ::tjson::EncodeStyle_obj::entrySeperator(style,depth);
HXDLIN( 420)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 420)							buffer->flush();
            						}
HXDLIN( 420)						if (::hx::IsNull( buffer->b )) {
HXLINE( 420)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5));
            						}
            						else {
HXLINE( 420)							::Array< ::String > buffer6 = buffer->b;
HXDLIN( 420)							buffer6->push(::Std_obj::string(x5));
            						}
            					}
            					else {
HXLINE( 421)						::String x6 = ::tjson::EncodeStyle_obj::firstEntry(style,depth);
HXDLIN( 421)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 421)							buffer->flush();
            						}
HXDLIN( 421)						if (::hx::IsNull( buffer->b )) {
HXLINE( 421)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x6));
            						}
            						else {
HXLINE( 421)							::Array< ::String > buffer7 = buffer->b;
HXDLIN( 421)							buffer7->push(::Std_obj::string(x6));
            						}
            					}
HXLINE( 422)					{
HXLINE( 422)						::String x7 = ((((HX_("\"",22,00,00,00) + field) + HX_("\"",22,00,00,00)) + ::tjson::EncodeStyle_obj::keyValueSeperator(style,depth)) + vStr);
HXDLIN( 422)						if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 422)							buffer->flush();
            						}
HXDLIN( 422)						if (::hx::IsNull( buffer->b )) {
HXLINE( 422)							buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x7));
            						}
            						else {
HXLINE( 422)							::Array< ::String > buffer8 = buffer->b;
HXDLIN( 422)							buffer8->push(::Std_obj::string(x7));
            						}
            					}
            				}
            			}
...
HXLINE( 429)		{
HXLINE( 429)			::String x8 = ::tjson::EncodeStyle_obj::endObject(style,depth);
HXDLIN( 429)			if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 429)				buffer->flush();
            			}
HXDLIN( 429)			if (::hx::IsNull( buffer->b )) {
HXLINE( 429)				buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x8));
            			}
            			else {
HXLINE( 429)				::Array< ::String > buffer9 = buffer->b;
HXDLIN( 429)				buffer9->push(::Std_obj::string(x8));
            			}
            		}
...
HXLINE( 439)					::String x1 = ::tjson::EncodeStyle_obj::entrySeperator(style,depth);
HXDLIN( 439)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 439)						buffer->flush();
            					}
HXDLIN( 439)					if (::hx::IsNull( buffer->b )) {
HXLINE( 439)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            					}
            					else {
HXLINE( 439)						::Array< ::String > buffer2 = buffer->b;
HXDLIN( 439)						buffer2->push(::Std_obj::string(x1));
            					}
            				}
            				else {
HXLINE( 440)					::String x2 = ::tjson::EncodeStyle_obj::firstEntry(style,depth);
HXDLIN( 440)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 440)						buffer->flush();
            					}
HXDLIN( 440)					if (::hx::IsNull( buffer->b )) {
HXLINE( 440)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            					}
            					else {
HXLINE( 440)						::Array< ::String > buffer3 = buffer->b;
HXDLIN( 440)						buffer3->push(::Std_obj::string(x2));
            					}
            				}
HXLINE( 441)				 ::Dynamic value = obj->get(field1);
HXLINE( 442)				{
HXLINE( 442)					::String x3 = (((HX_("\"",22,00,00,00) + field1) + HX_("\"",22,00,00,00)) + ::tjson::EncodeStyle_obj::keyValueSeperator(style,depth));
HXDLIN( 442)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 442)						buffer->flush();
            					}
HXDLIN( 442)					if (::hx::IsNull( buffer->b )) {
HXLINE( 442)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            					}
            					else {
HXLINE( 442)						::Array< ::String > buffer4 = buffer->b;
HXDLIN( 442)						buffer4->push(::Std_obj::string(x3));
            					}
            				}
HXLINE( 443)				{
HXLINE( 443)					::String x4 = this->encodeValue(value,style,depth);
HXDLIN( 443)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 443)						buffer->flush();
            					}
HXDLIN( 443)					if (::hx::IsNull( buffer->b )) {
HXLINE( 443)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            					}
            					else {
HXLINE( 443)						::Array< ::String > buffer5 = buffer->b;
HXDLIN( 443)						buffer5->push(::Std_obj::string(x4));
            					}
            				}
            			}
            		}
HXLINE( 445)		{
HXLINE( 445)			::String x5 = ::tjson::EncodeStyle_obj::endObject(style,depth);
HXDLIN( 445)			if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 445)				buffer->flush();
            			}
HXDLIN( 445)			if (::hx::IsNull( buffer->b )) {
HXLINE( 445)				buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x5));
            			}
            			else {
HXLINE( 445)				::Array< ::String > buffer6 = buffer->b;
HXDLIN( 445)				buffer6->push(::Std_obj::string(x5));
            			}
            		}
...
HXLINE( 455)					::String x1 = ::tjson::EncodeStyle_obj::entrySeperator(style,depth);
HXDLIN( 455)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 455)						buffer->flush();
            					}
HXDLIN( 455)					if (::hx::IsNull( buffer->b )) {
HXLINE( 455)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x1));
            					}
            					else {
HXLINE( 455)						::Array< ::String > buffer2 = buffer->b;
HXDLIN( 455)						buffer2->push(::Std_obj::string(x1));
            					}
            				}
            				else {
HXLINE( 456)					::String x2 = ::tjson::EncodeStyle_obj::firstEntry(style,depth);
HXDLIN( 456)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 456)						buffer->flush();
            					}
HXDLIN( 456)					if (::hx::IsNull( buffer->b )) {
HXLINE( 456)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x2));
            					}
            					else {
HXLINE( 456)						::Array< ::String > buffer3 = buffer->b;
HXDLIN( 456)						buffer3->push(::Std_obj::string(x2));
            					}
            				}
HXLINE( 457)				{
HXLINE( 457)					::String x3 = this->encodeValue(value1,style,depth);
HXDLIN( 457)					if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 457)						buffer->flush();
            					}
HXDLIN( 457)					if (::hx::IsNull( buffer->b )) {
HXLINE( 457)						buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x3));
            					}
            					else {
HXLINE( 457)						::Array< ::String > buffer4 = buffer->b;
HXDLIN( 457)						buffer4->push(::Std_obj::string(x3));
            					}
            				}
            			}
            		}
HXLINE( 460)		{
HXLINE( 460)			::String x4 = ::tjson::EncodeStyle_obj::endArray(style,depth);
HXDLIN( 460)			if (::hx::IsNotNull( buffer->charBuf )) {
HXLINE( 460)				buffer->flush();
            			}
HXDLIN( 460)			if (::hx::IsNull( buffer->b )) {
HXLINE( 460)				buffer->b = ::Array_obj< ::String >::__new(1)->init(0,::Std_obj::string(x4));
            			}
            			else {
HXLINE( 460)				::Array< ::String > buffer5 = buffer->b;
HXDLIN( 460)				buffer5->push(::Std_obj::string(x4));
            			}
            		}
...
HXLINE( 480)				_hx_tmp1 = ::Std_obj::isOfType(value,( ( ::Dynamic)(::hx::ClassOf< ::haxe::ds::List >()) ));
            			}
            			else {
...
HXLINE( 485)					 ::haxe::ds::List v1 = ( ( ::haxe::ds::List)(value) );
HXLINE( 486)					return this->encodeIterable(v1,style,(depth + 1));
            				}
            				else {
