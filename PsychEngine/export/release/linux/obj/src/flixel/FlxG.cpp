...
HXLINE( 641)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp2 = ::flixel::FlxG_obj::inputs;
HXDLIN( 641)		::flixel::FlxG_obj::touches = _hx_tmp2->add_flixel_input_touch_FlxTouchManager( ::flixel::input::touch::FlxTouchManager_obj::__alloc( HX_CTX ));
HXLINE( 645)		 ::flixel::_hx_system::frontEnds::InputFrontEnd _hx_tmp3 = ::flixel::FlxG_obj::inputs;
HXDLIN( 645)		::flixel::FlxG_obj::gamepads = _hx_tmp3->add_flixel_input_gamepad_FlxGamepadManager( ::flixel::input::gamepad::FlxGamepadManager_obj::__alloc( HX_CTX ));
...
HXDLIN( 109)		VERSION =  ::flixel::_hx_system::FlxVersion_obj::__alloc( HX_CTX ,5,6,1);
            	}
{
