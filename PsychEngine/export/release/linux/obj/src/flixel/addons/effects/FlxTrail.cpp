...
HXLINE( 109)		 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 109)		point->_inPool = false;
HXDLIN( 109)		 ::flixel::math::FlxBasePoint this1 = point;
HXDLIN( 109)		 ::flixel::math::FlxBasePoint p = Target->origin;
HXDLIN( 109)		{
HXLINE( 109)			Float y = p->y;
HXDLIN( 109)			this1->set_x(p->x);
HXDLIN( 109)			this1->set_y(y);
            		}
HXDLIN( 109)		{
HXLINE( 109)			 ::flixel::math::FlxBasePoint _this = p;
HXDLIN( 109)			if (_this->_weak) {
HXLINE( 109)				_this->put();
            			}
            		}
HXDLIN( 109)		this->_spriteOrigin = this1;
...
HXLINE( 157)			 ::flixel::math::FlxBasePoint spritePosition = null();
HXLINE( 158)			if ((this->_recentPositions->length == this->_trailLength)) {
HXLINE( 160)				spritePosition = this->_recentPositions->pop().StaticCast<  ::flixel::math::FlxBasePoint >();
            			}
            			else {
HXLINE( 164)				 ::flixel::math::FlxBasePoint point = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 164)				point->_inPool = false;
HXDLIN( 164)				spritePosition = point;
            			}
HXLINE( 167)			{
HXLINE( 167)				Float y = (this->target->y - this->target->offset->y);
HXDLIN( 167)				spritePosition->set_x((this->target->x - this->target->offset->x));
HXDLIN( 167)				spritePosition->set_y(y);
            			}
...
HXLINE( 179)				 ::flixel::math::FlxBasePoint spriteScale = null();
HXLINE( 180)				if ((this->_recentScales->length == this->_trailLength)) {
HXLINE( 182)					spriteScale = this->_recentScales->pop().StaticCast<  ::flixel::math::FlxBasePoint >();
            				}
            				else {
HXLINE( 186)					 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 186)					point1->_inPool = false;
HXDLIN( 186)					spriteScale = point1;
            				}
HXLINE( 189)				{
HXLINE( 189)					Float y1 = this->target->scale->y;
HXDLIN( 189)					spriteScale->set_x(this->target->scale->x);
HXDLIN( 189)					spriteScale->set_y(y1);
            				}
HXLINE( 190)				this->_recentScales->unshift(spriteScale);
            			}
HXLINE( 194)			bool _hx_tmp1;
HXDLIN( 194)			if (this->framesEnabled) {
HXLINE( 194)				_hx_tmp1 = ::hx::IsNull( this->_graphic );
            			}
            			else {
...
HXLINE( 208)					trailSprite->set_x(this->_recentPositions->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x);
HXLINE( 209)					trailSprite->set_y(this->_recentPositions->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
...
HXLINE( 222)						trailSprite->scale->set_x(this->_recentScales->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x);
HXLINE( 223)						trailSprite->scale->set_y(this->_recentScales->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
            					}
HXLINE( 227)					bool _hx_tmp2;
HXDLIN( 227)					if (this->framesEnabled) {
HXLINE( 227)						_hx_tmp2 = ::hx::IsNull( this->_graphic );
            					}
            					else {
...
HXLINE( 301)				 ::flixel::addons::effects::FlxTrail _hx_tmp1 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 301)				_hx_tmp1->_transp = (_hx_tmp1->_transp - this->_difference);
...
::hx::Val FlxTrail_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 13:
		...
		if (HX_FIELD_EQ(inName,"_spriteOrigin") ) { _spriteOrigin=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
		break;
	case 16:
...
static ::hx::StorageInfo FlxTrail_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(FlxTrail_obj,_spriteOrigin),HX_("_spriteOrigin",aa,4e,52,c5)},
	{ ::hx::fsUnknown, 0, null()}
};
