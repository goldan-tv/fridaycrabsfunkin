...
HXLINE( 111)		if (::hx::IsInstanceNotEq( this->graphic,Value )) {
...
HXLINE( 146)			{
HXLINE( 146)				 ::flixel::math::FlxBasePoint this1 = this->renderSprite->scrollFactor;
HXDLIN( 146)				Float y = this->scrollFactor->y;
HXDLIN( 146)				this1->set_x(this->scrollFactor->x);
HXDLIN( 146)				this1->set_y(y);
            			}
HXLINE( 147)			this->renderSprite->_cameras = this->_cameras;
...
HXLINE( 181)			Float _hx_tmp4 = this->renderSprite->get_height();
HXDLIN( 181)			_hx_tmp2 = (_hx_tmp4 != this->get_height());
            		}
            		else {
HXLINE( 181)			_hx_tmp2 = true;
            		}
HXDLIN( 181)		if (_hx_tmp2) {
HXLINE( 183)			 ::flixel::FlxSprite _hx_tmp5 = this->renderSprite;
HXDLIN( 183)			int _hx_tmp6 = ::Std_obj::_hx_int(this->get_width());
HXDLIN( 183)			_hx_tmp5->makeGraphic(_hx_tmp6,::Std_obj::_hx_int(this->get_height()),0,true,null());
            		}
            		else {
HXLINE( 187)			 ::openfl::geom::Rectangle _hx_tmp7 = this->_flashRect2;
HXDLIN( 187)			Float _hx_tmp8 = this->get_width();
HXDLIN( 187)			_hx_tmp7->setTo(( (Float)(0) ),( (Float)(0) ),_hx_tmp8,this->get_height());
...
HXLINE( 193)			_hx_tmp9 = (this->scrollY != 0);
            		}
            		else {
HXLINE( 193)			_hx_tmp9 = true;
            		}
...
HXLINE( 229)			{
HXLINE( 229)				::Dynamic this7 = this->vertices;
HXDLIN( 229)				::Dynamic this8 = this->vertices;
...
HXDLIN( 229)				Float value2;
HXDLIN( 229)				bool value3;
HXDLIN( 229)				if (::hx::IsNotNull( Max )) {
HXLINE( 229)					value3 = ::hx::IsGreater( lowerBound,Max );
            				}
            				else {
HXLINE( 229)					value3 = false;
            				}
HXDLIN( 229)				if (value3) {
HXLINE( 229)					value2 = ( (Float)(Max) );
            				}
            				else {
HXLINE( 229)					value2 = lowerBound;
            				}
HXDLIN( 229)				( ( ::openfl::_Vector::FloatVector)(this7) )->set(0,( ( ::openfl::_Vector::FloatVector)(this8) )->set(6,value2));
            			}
HXLINE( 230)			{
HXLINE( 230)				::Dynamic this9 = this->vertices;
HXDLIN( 230)				::Dynamic this10 = this->vertices;
...
HXDLIN( 230)				Float value4;
HXDLIN( 230)				bool value5;
HXDLIN( 230)				if (::hx::IsNotNull( Max1 )) {
HXLINE( 230)					value5 = ::hx::IsGreater( lowerBound1,Max1 );
            				}
            				else {
HXLINE( 230)					value5 = false;
            				}
HXDLIN( 230)				if (value5) {
HXLINE( 230)					value4 = ( (Float)(Max1) );
            				}
            				else {
HXLINE( 230)					value4 = lowerBound1;
            				}
HXDLIN( 230)				( ( ::openfl::_Vector::FloatVector)(this9) )->set(2,( ( ::openfl::_Vector::FloatVector)(this10) )->set(4,value4));
            			}
...
HXLINE( 238)			{
HXLINE( 238)				::Dynamic this11 = this->uvtData;
HXDLIN( 238)				::Dynamic this12 = this->uvtData;
HXDLIN( 238)				Float value6 = this->vertices->get(0);
HXDLIN( 238)				( ( ::openfl::_Vector::FloatVector)(this11) )->set(0,( ( ::openfl::_Vector::FloatVector)(this12) )->set(6,((value6 - this->scrollX) / frame->sourceSize->x)));
            			}
HXLINE( 239)			{
HXLINE( 239)				::Dynamic this13 = this->uvtData;
HXDLIN( 239)				::Dynamic this14 = this->uvtData;
HXDLIN( 239)				Float value7 = this->uvtData->get(0);
HXDLIN( 239)				Float value8 = this->vertices->get(2);
HXDLIN( 239)				Float value9 = (value8 - this->vertices->get(0));
HXDLIN( 239)				( ( ::openfl::_Vector::FloatVector)(this13) )->set(2,( ( ::openfl::_Vector::FloatVector)(this14) )->set(4,(value7 + (value9 / frame->sourceSize->x))));
            			}
            		}
HXLINE( 242)		if (this->repeatY) {
HXLINE( 244)			{
HXLINE( 244)				::Dynamic this15 = this->vertices;
HXDLIN( 244)				( ( ::openfl::_Vector::FloatVector)(this15) )->set(1,this->vertices->set(3,((Float)0.0)));
            			}
HXLINE( 245)			{
HXLINE( 245)				::Dynamic this16 = this->vertices;
HXDLIN( 245)				::Dynamic this17 = this->vertices;
HXDLIN( 245)				( ( ::openfl::_Vector::FloatVector)(this16) )->set(5,( ( ::openfl::_Vector::FloatVector)(this17) )->set(7,this->get_height()));
            			}
HXLINE( 247)			{
HXLINE( 247)				::Dynamic this18 = this->uvtData;
HXDLIN( 247)				( ( ::openfl::_Vector::FloatVector)(this18) )->set(1,this->uvtData->set(3,(-(this->scrollY) / frame->sourceSize->y)));
            			}
HXLINE( 248)			{
HXLINE( 248)				::Dynamic this19 = this->uvtData;
HXDLIN( 248)				::Dynamic this20 = this->uvtData;
HXDLIN( 248)				Float value10 = this->uvtData->get(1);
HXDLIN( 248)				Float value11 = this->get_height();
HXDLIN( 248)				( ( ::openfl::_Vector::FloatVector)(this19) )->set(5,( ( ::openfl::_Vector::FloatVector)(this20) )->set(7,(value10 + (value11 / frame->sourceSize->y))));
            			}
            		}
            		else {
HXLINE( 252)			{
HXLINE( 252)				::Dynamic this21 = this->vertices;
HXDLIN( 252)				::Dynamic this22 = this->vertices;
HXDLIN( 252)				Float Value2 = this->scrollY;
HXDLIN( 252)				 ::Dynamic Max2 = this->get_height();
HXDLIN( 252)				Float lowerBound2;
HXDLIN( 252)				if ((Value2 < 0)) {
HXLINE( 252)					lowerBound2 = ( (Float)(0) );
            				}
            				else {
HXLINE( 252)					lowerBound2 = Value2;
            				}
HXDLIN( 252)				Float value12;
HXDLIN( 252)				bool value13;
HXDLIN( 252)				if (::hx::IsNotNull( Max2 )) {
HXLINE( 252)					value13 = ::hx::IsGreater( lowerBound2,Max2 );
            				}
            				else {
HXLINE( 252)					value13 = false;
            				}
HXDLIN( 252)				if (value13) {
HXLINE( 252)					value12 = ( (Float)(Max2) );
            				}
            				else {
HXLINE( 252)					value12 = lowerBound2;
            				}
HXDLIN( 252)				( ( ::openfl::_Vector::FloatVector)(this21) )->set(1,( ( ::openfl::_Vector::FloatVector)(this22) )->set(3,value12));
            			}
HXLINE( 253)			{
HXLINE( 253)				::Dynamic this23 = this->vertices;
HXDLIN( 253)				::Dynamic this24 = this->vertices;
HXDLIN( 253)				Float Value3 = (this->scrollY + frame->sourceSize->y);
HXDLIN( 253)				 ::Dynamic Max3 = this->get_height();
HXDLIN( 253)				Float lowerBound3;
HXDLIN( 253)				if ((Value3 < 0)) {
HXLINE( 253)					lowerBound3 = ( (Float)(0) );
            				}
            				else {
HXLINE( 253)					lowerBound3 = Value3;
            				}
HXDLIN( 253)				Float value14;
HXDLIN( 253)				bool value15;
HXDLIN( 253)				if (::hx::IsNotNull( Max3 )) {
HXLINE( 253)					value15 = ::hx::IsGreater( lowerBound3,Max3 );
            				}
            				else {
HXLINE( 253)					value15 = false;
            				}
HXDLIN( 253)				if (value15) {
HXLINE( 253)					value14 = ( (Float)(Max3) );
            				}
            				else {
HXLINE( 253)					value14 = lowerBound3;
            				}
HXDLIN( 253)				( ( ::openfl::_Vector::FloatVector)(this23) )->set(5,( ( ::openfl::_Vector::FloatVector)(this24) )->set(7,value14));
            			}
HXLINE( 255)			Float _hx_tmp1 = this->vertices->get(5);
HXDLIN( 255)			if (((_hx_tmp1 - this->vertices->get(1)) <= 0)) {
HXLINE( 257)				this->graphicVisible = false;
HXLINE( 258)				return;
            			}
HXLINE( 261)			{
HXLINE( 261)				::Dynamic this25 = this->uvtData;
HXDLIN( 261)				::Dynamic this26 = this->uvtData;
HXDLIN( 261)				Float value16 = this->vertices->get(1);
HXDLIN( 261)				( ( ::openfl::_Vector::FloatVector)(this25) )->set(1,( ( ::openfl::_Vector::FloatVector)(this26) )->set(3,((value16 - this->scrollY) / frame->sourceSize->y)));
            			}
HXLINE( 262)			{
HXLINE( 262)				::Dynamic this27 = this->uvtData;
HXDLIN( 262)				::Dynamic this28 = this->uvtData;
HXDLIN( 262)				Float value17 = this->uvtData->get(1);
HXDLIN( 262)				Float value18 = this->vertices->get(5);
HXDLIN( 262)				Float value19 = (value18 - this->vertices->get(1));
HXDLIN( 262)				( ( ::openfl::_Vector::FloatVector)(this27) )->set(5,( ( ::openfl::_Vector::FloatVector)(this28) )->set(7,(value17 + (value19 / frame->sourceSize->y))));
            			}
            		}
            	}
