...
HXLINE(  86)				_hx_tmp4 = (this->shapeHeight < CanvasHeight);
            			}
            			else {
...
HXLINE( 116)			Float _hx_tmp1 = this->get_width();
HXDLIN( 116)			int _hx_tmp2 = ::Std_obj::_hx_int((_hx_tmp1 + this->get_strokeBuffer()));
HXDLIN( 116)			Float _hx_tmp3 = this->get_height();
HXDLIN( 116)			this->makeGraphic(_hx_tmp2,::Std_obj::_hx_int((_hx_tmp3 + this->get_strokeBuffer())),0,true,null());
HXLINE( 117)			this->fixBoundaries(trueWidth,trueHeight);
            		}
            		else {
HXLINE( 121)			 ::openfl::display::BitmapData _hx_tmp4 = this->get_pixels();
HXDLIN( 121)			_hx_tmp4->fillRect(this->get_pixels()->rect,0);
            		}
