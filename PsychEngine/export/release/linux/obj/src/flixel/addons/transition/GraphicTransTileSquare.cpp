...
HX_LOCAL_STACK_FRAME(_hx_pos_44db7221ae9d3cdb_68_boot,"flixel.addons.transition.GraphicTransTileSquare","boot",0x10bf24a5,"flixel.addons.transition.GraphicTransTileSquare.boot","flixel/addons/transition/FlxTransitionSprite.hx",68,0xd14f1ac3)
namespace flixel{
namespace addons{
...
{
{
            	HX_STACKFRAME(&_hx_pos_44db7221ae9d3cdb_68_boot)
HXDLIN(  68)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileSquare",06,2a,6a,6d);
            	}
}
