...
HX_LOCAL_STACK_FRAME(_hx_pos_4254a9971902ea36_65_boot,"flixel.addons.transition.GraphicTransTileDiamond","boot",0xfb57124a,"flixel.addons.transition.GraphicTransTileDiamond.boot","flixel/addons/transition/FlxTransitionSprite.hx",65,0xd14f1ac3)
namespace flixel{
namespace addons{
...
{
{
            	HX_STACKFRAME(&_hx_pos_4254a9971902ea36_65_boot)
HXDLIN(  65)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileDiamond",cb,79,c6,30);
            	}
}
