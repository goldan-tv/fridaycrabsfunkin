...
HX_DEFINE_STACK_FRAME(_hx_pos_32af2379a60e4ba1_47_new,"flixel.addons.transition.GraphicTransTileCircle","new",0xafade640,"flixel.addons.transition.GraphicTransTileCircle.new","openfl/utils/_internal/AssetsMacro.hx",47,0xfdd54705)
HX_LOCAL_STACK_FRAME(_hx_pos_9c6082f0007bc203_62_boot,"flixel.addons.transition.GraphicTransTileCircle","boot",0x00949252,"flixel.addons.transition.GraphicTransTileCircle.boot","flixel/addons/transition/FlxTransitionSprite.hx",62,0xd14f1ac3)
namespace flixel{
namespace addons{
...
void GraphicTransTileCircle_obj::__construct(int width,int height, ::Dynamic __o_transparent, ::Dynamic __o_fillRGBA){
            	...
            	HX_STACKFRAME(&_hx_pos_32af2379a60e4ba1_47_new)
HXLINE(  71)		super::__construct(0,0,transparent,fillRGBA);
HXLINE(  73)		 ::openfl::utils::ByteArrayData byteArray = ::openfl::utils::_ByteArray::ByteArray_Impl__obj::fromBytes(::haxe::Resource_obj::getBytes(::flixel::addons::transition::GraphicTransTileCircle_obj::resourceName));
HXLINE(  74)		{
...
bool GraphicTransTileCircle_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x073e5103) {
		...
		return inClassId==(int)0x2391e9aa;
	}
}
...
static ::hx::StaticInfo GraphicTransTileCircle_obj_sStaticStorageInfo[] = {
	{::hx::fsString,(void *) &GraphicTransTileCircle_obj::resourceName,HX_("resourceName",39,7a,62,90)},
	{ ::hx::fsUnknown, 0, null()}
};
#endif
...
{
	GraphicTransTileCircle_obj _hx_dummy;
	GraphicTransTileCircle_obj::_hx_vtable = *(void **)&_hx_dummy;
	::hx::Static(__mClass) = new ::hx::Class_obj();
	__mClass->mName = HX_("flixel.addons.transition.GraphicTransTileCircle",4e,06,36,6d);
...
{
{
            	HX_STACKFRAME(&_hx_pos_9c6082f0007bc203_62_boot)
HXDLIN(  62)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition_GraphicTransTileCircle",79,9b,85,6a);
            	}
}
