...
HX_LOCAL_STACK_FRAME(_hx_pos_6b0a2037e268ad27_36_boot,"flixel.addons.transition._TransitionFade.GraphicDiagonalGradient","boot",0xf23c0021,"flixel.addons.transition._TransitionFade.GraphicDiagonalGradient.boot","flixel/addons/transition/TransitionFade.hx",36,0x307a6abc)
namespace flixel{
namespace addons{
...
{
{
            	HX_STACKFRAME(&_hx_pos_6b0a2037e268ad27_36_boot)
HXDLIN(  36)		resourceName = HX_("__ASSET__:bitmap_flixel_addons_transition__TransitionFade_GraphicDiagonalGradient",43,3b,8c,88);
            	}
}
