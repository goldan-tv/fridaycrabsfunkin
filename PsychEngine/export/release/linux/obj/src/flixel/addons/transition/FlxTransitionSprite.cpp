...
HX_LOCAL_STACK_FRAME(_hx_pos_c4312f005b5b0457_152_onFinishAnim,"flixel.addons.transition.FlxTransitionSprite","onFinishAnim",0xb87c9195,"flixel.addons.transition.FlxTransitionSprite.onFinishAnim","flixel/addons/transition/FlxTransitionSprite.hx",152,0xd14f1ac3)
HX_LOCAL_STACK_FRAME(_hx_pos_c4312f005b5b0457_167_update,"flixel.addons.transition.FlxTransitionSprite","update",0x8efd841b,"flixel.addons.transition.FlxTransitionSprite.update","flixel/addons/transition/FlxTransitionSprite.hx",167,0xd14f1ac3)
HX_LOCAL_STACK_FRAME(_hx_pos_c4312f005b5b0457_180_onTime,"flixel.addons.transition.FlxTransitionSprite","onTime",0xf77ed2de,"flixel.addons.transition.FlxTransitionSprite.onTime","flixel/addons/transition/FlxTransitionSprite.hx",180,0xd14f1ac3)
namespace flixel{
namespace addons{
...
HXLINE( 146)		this->animation->finishCallback = this->onFinishAnim_dyn();
HXLINE( 147)		this->status = Status;
            	}
...
void FlxTransitionSprite_obj::onFinishAnim(::String str){
            	HX_STACKFRAME(&_hx_pos_c4312f005b5b0457_152_onFinishAnim)
HXDLIN( 152)		if (!(this->_finished)) {
HXLINE( 154)			this->_finished = true;
HXLINE( 155)			switch((int)(this->status)){
            				case (int)0: {
HXLINE( 158)					this->setStatus(3);
            				}
            				break;
            				case (int)1: {
HXLINE( 160)					this->setStatus(2);
            				}
            				break;
            				default:{
            				}
...
void FlxTransitionSprite_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_c4312f005b5b0457_167_update)
HXLINE( 168)		this->super::update(elapsed);
HXLINE( 169)		if (this->_starting) {
HXLINE( 171)			 ::flixel::addons::transition::FlxTransitionSprite _hx_tmp = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 171)			_hx_tmp->_count = (_hx_tmp->_count + elapsed);
HXLINE( 172)			if ((this->_count >= this->_delay)) {
HXLINE( 174)				this->onTime();
            			}
            		}
            	}
...
void FlxTransitionSprite_obj::onTime(){
            	HX_STACKFRAME(&_hx_pos_c4312f005b5b0457_180_onTime)
HXLINE( 181)		this->_starting = false;
HXLINE( 182)		this->_count = ( (Float)(0) );
HXLINE( 183)		this->setStatus(this->_newStatus);
HXLINE( 184)		this->_newStatus = -1;
            	}
