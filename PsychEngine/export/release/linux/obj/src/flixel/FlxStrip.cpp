...
HXLINE(  55)					_hx_tmp2 = !(camera->exists);
            				}
            				else {
...
HXLINE(  58)				{
HXLINE(  58)					 ::flixel::math::FlxBasePoint this1 = this->getScreenPosition(this->_point,camera);
HXDLIN(  58)					 ::flixel::math::FlxBasePoint point = this->offset;
HXDLIN(  58)					{
HXLINE(  58)						Float y = point->y;
HXDLIN(  58)						this1->set_x((this1->x - point->x));
HXDLIN(  58)						this1->set_y((this1->y - y));
            					}
HXDLIN(  58)					{
HXLINE(  58)						 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(  58)						if (_this->_weak) {
HXLINE(  58)							_this->put();
            						}
            					}
            				}
HXLINE(  60)				camera->drawTriangles(this->graphic,this->vertices,this->indices,this->uvtData,this->colors,this->_point,this->blend,this->repeat,this->antialiasing,this->colorTransform,this->shader);
            			}
            		}
            	}
