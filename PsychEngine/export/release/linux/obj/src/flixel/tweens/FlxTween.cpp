...
HXLINE( 636)			Float _hx_tmp2;
HXDLIN( 636)			if (this->backward) {
HXLINE( 636)				_hx_tmp2 = ( (Float)(0) );
            			}
            			else {
HXLINE( 636)				_hx_tmp2 = ( (Float)(1) );
            			}
HXDLIN( 636)			this->scale = _hx_tmp2;
...
HXLINE( 716)				_hx_tmp1 = ::hx::IsNotNull( this->manager );
            			}
            			else {
...
HXLINE( 727)				_hx_tmp4 = (this->scale > 0);
            			}
            			else {
HXLINE( 727)				_hx_tmp4 = false;
            			}
HXDLIN( 727)			if (_hx_tmp4) {
HXLINE( 727)				_hx_tmp3 = (this->scale < 1);
            			}
            			else {
