...
HXDLIN( 217)				{
HXLINE( 217)					 ::flixel::math::FlxBasePoint _this = p;
...
HXDLIN( 218)				{
HXLINE( 218)					 ::flixel::math::FlxBasePoint _this1 = p3;
HXDLIN( 218)					if (_this1->_weak) {
HXLINE( 218)						_this1->put();
            					}
            				}
...
HXLINE( 222)				 ::Dynamic data2 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 222)				p1->set_x(p1->x);
HXDLIN( 222)				p1->set_y((p1->y + height));
HXDLIN( 222)				p2->set_x(p2->x);
HXDLIN( 222)				p2->set_y((p2->y + height));
HXLINE( 220)				_hx_tmp1 = ( ( ::flixel::tile::FlxBaseTilemap)(data2) )->ray(p1,p2,null());
            			}
            			else {
HXLINE( 220)				_hx_tmp1 = false;
            			}
HXDLIN( 220)			if (_hx_tmp1) {
HXLINE( 223)				 ::Dynamic data3 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 223)				p1->set_x((p1->x + -(width)));
HXDLIN( 223)				p1->set_y(p1->y);
HXDLIN( 223)				p2->set_x((p2->x + -(width)));
HXDLIN( 223)				p2->set_y(p2->y);
HXLINE( 220)				_hx_tmp = ( ( ::flixel::tile::FlxBaseTilemap)(data3) )->ray(p1,p2,null());
            			}
            			else {
...
HXDLIN( 329)				while((_g2 < neighbors->length)){
HXLINE( 329)					int neighbor1 = neighbors->__get(_g2);
HXDLIN( 329)					_g2 = (_g2 + 1);
HXLINE( 331)					if (this->isTileSolved(data,neighbor1)) {
HXLINE( 332)						( ( ::flixel::path::FlxTypedPathfinderData)(data) )->excluded->push(neighbor1);
            					}
            				}
            			}
...
HXLINE( 337)				_hx_tmp2 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->foundEnd;
            			}
            			else {
...
HXDLIN( 356)		HX_STACK_DO_THROW(HX_("FlxTilemapPathPolicy.getNeighbors should not be called, It must be overriden in derived classes",33,f6,83,a6));
...
HXDLIN( 370)		HX_STACK_DO_THROW(HX_("FlxTilemapPathPolicy.getDistance should not be called, It must be overriden in derived classes",bd,c0,de,31));
HXDLIN( 370)		return 0;
            	}
...
HXLINE( 407)			 ::Dynamic data2 = ( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map;
HXDLIN( 407)			return (( ( ::flixel::tile::FlxBaseTilemap)(data2) )->getTileCollisions(( ( ::flixel::tile::FlxBaseTilemap)(( ( ::flixel::path::FlxTypedPathfinderData)(data) )->map) )->getTileByIndex(( ( ::flixel::path::FlxTypedPathfinderData)(data) )->endIndex)) == 0);
            		}
            		else {
