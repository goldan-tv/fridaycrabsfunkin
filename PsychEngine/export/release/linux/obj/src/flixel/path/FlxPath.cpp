...
HXLINE( 354)				Float _hx_tmp1;
HXDLIN( 354)				if ((deltaY > 0)) {
HXLINE( 354)					_hx_tmp1 = deltaY;
            				}
            				else {
HXLINE( 354)					_hx_tmp1 = -(deltaY);
            				}
HXDLIN( 354)				if ((_hx_tmp1 < (this->speed * elapsed))) {
...
HXLINE( 368)			_hx_tmp2 = (this->speed != 0);
            		}
            		else {
...
HXLINE( 376)				 ::flixel::math::FlxBasePoint this2 = ::flixel::path::FlxPath_obj::_point;
HXDLIN( 376)				Float x1 = (this->object->get_width() * ((Float)0.5));
HXDLIN( 376)				Float y1 = (this->object->get_height() * ((Float)0.5));
HXDLIN( 376)				this2->set_x((this2->x + x1));
HXDLIN( 376)				this2->set_y((this2->y + y1));
            			}
...
HXLINE( 385)				 ::flixel::math::FlxBasePoint this3 = this->object->velocity;
HXDLIN( 385)				this3->set_x(( (Float)(0) ));
HXDLIN( 385)				this3->set_y(( (Float)(0) ));
            			}
...
HXLINE( 408)				_hx_tmp1 = ( (Float)(180) );
            			}
            			else {
HXLINE( 408)				_hx_tmp1 = ( (Float)(0) );
            			}
HXDLIN( 408)			this->angle = _hx_tmp1;
...
HXLINE( 415)				_hx_tmp2 = (::flixel::path::FlxPath_obj::_point->x == node->x);
            			}
            			else {
...
HXLINE( 418)				Float _hx_tmp3;
HXDLIN( 418)				if ((this->object->velocity->y < 0)) {
HXLINE( 418)					_hx_tmp3 = ( (Float)(-90) );
            				}
            				else {
HXLINE( 418)					_hx_tmp3 = ( (Float)(90) );
            				}
HXDLIN( 418)				this->angle = _hx_tmp3;
...
HXDLIN( 427)				{
HXLINE( 427)					Float y1 = node->y;
HXDLIN( 427)					this1->set_x(node->x);
HXDLIN( 427)					this1->set_y(y1);
            				}
HXDLIN( 427)				{
HXLINE( 427)					 ::flixel::math::FlxBasePoint _this = node;
...
HXDLIN( 427)				{
HXLINE( 427)					Float y2 = point->y;
HXDLIN( 427)					this2->set_x((this2->x - point->x));
HXDLIN( 427)					this2->set_y((this2->y - y2));
            				}
HXDLIN( 427)				{
HXLINE( 427)					 ::flixel::math::FlxBasePoint _this1 = point;
...
HXLINE( 428)						_hx_tmp4 = (::Math_obj::abs(velocity->y) < ((Float)0.0000001));
            					}
            					else {
...
HXLINE( 429)				Float _hx_tmp5 = ::flixel::math::_FlxPoint::FlxPoint_Impl__obj::get_radians(velocity);
HXDLIN( 429)				this->angle = (_hx_tmp5 * (( (Float)(180) ) / ::Math_obj::PI));
            			}
            		}
            	}
...
HXLINE( 455)						 ::flixel::FlxObject fh2 = this->object;
HXDLIN( 455)						Float fh3 = fh2->y;
HXDLIN( 455)						fh2->set_y((fh3 - (this->object->get_height() * ((Float)0.5))));
            					}
            				}
            			}
            		}
HXLINE( 460)		bool callComplete = false;
HXLINE( 461)		 ::flixel::path::FlxPath _hx_tmp2 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 461)		_hx_tmp2->nodeIndex = (_hx_tmp2->nodeIndex + this->_inc);
...
HXLINE( 532)			_hx_tmp3 = ::hx::IsNotNull( this->onComplete );
            		}
            		else {
