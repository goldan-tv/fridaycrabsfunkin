...
HX_DEFINE_STACK_FRAME(_hx_pos_389f2ddd7620ccce_134_new,"flixel.graphics.frames.bmfont.BMFontPadding","new",0xfd16ae4c,"flixel.graphics.frames.bmfont.BMFontPadding.new","flixel/graphics/frames/bmfont/BMFontInfo.hx",134,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_389f2ddd7620ccce_150_fromString,"flixel.graphics.frames.bmfont.BMFontPadding","fromString",0x9af8256f,"flixel.graphics.frames.bmfont.BMFontPadding.fromString","flixel/graphics/frames/bmfont/BMFontInfo.hx",150,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_389f2ddd7620ccce_163_fromBytes,"flixel.graphics.frames.bmfont.BMFontPadding","fromBytes",0xc9b1098d,"flixel.graphics.frames.bmfont.BMFontPadding.fromBytes","flixel/graphics/frames/bmfont/BMFontInfo.hx",163,0x8997cf99)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
void BMFontPadding_obj::__construct(::hx::Null< int >  __o_up,::hx::Null< int >  __o_right,::hx::Null< int >  __o_down,::hx::Null< int >  __o_left){
            	...
            	HX_STACKFRAME(&_hx_pos_389f2ddd7620ccce_134_new)
HXLINE( 139)		this->left = 0;
HXLINE( 138)		this->down = 0;
HXLINE( 137)		this->right = 0;
HXLINE( 136)		this->up = 0;
HXLINE( 143)		this->up = up;
HXLINE( 144)		this->right = right;
HXLINE( 145)		this->down = down;
HXLINE( 146)		this->left = left;
            	}
...
bool BMFontPadding_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontPadding BMFontPadding_obj::fromString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_389f2ddd7620ccce_150_fromString)
HXLINE( 151)		::Array< ::String > values = data.split(HX_(",",2c,00,00,00));
HXLINE( 154)		 ::Dynamic _g = ::Std_obj::parseInt(values->__get(0));
HXLINE( 155)		 ::Dynamic _g1 = ::Std_obj::parseInt(values->__get(1));
HXLINE( 156)		 ::Dynamic _g2 = ::Std_obj::parseInt(values->__get(2));
HXLINE( 153)		return  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,::Std_obj::parseInt(values->__get(3)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontPadding_obj,fromString,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontPadding BMFontPadding_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_389f2ddd7620ccce_163_fromBytes)
HXLINE( 165)		int _g = bytes->readByte();
HXLINE( 166)		int _g1 = bytes->readByte();
HXLINE( 167)		int _g2 = bytes->readByte();
HXLINE( 164)		return  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,bytes->readByte());
            	}
