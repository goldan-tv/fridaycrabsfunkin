...
HXLINE(  42)		int _g8 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(charNode,HX_("page",4f,da,51,4a),-1);
HXLINE(  43)		int _g9 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(charNode,HX_("chnl",23,6a,bf,41),-1);
...
HXDLIN(  51)				int _g10 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(_hx_char,HX_("page",4f,da,51,4a),-1);
HXDLIN(  51)				int _g11 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(_hx_char,HX_("chnl",23,6a,bf,41),-1);
