...
HXLINE(  36)			HX_STACK_DO_THROW((HX_("Invalid nodeType ",3b,e0,cb,e1) + ::_Xml::XmlType_Impl__obj::toString(xml->nodeType)));
            		}
HXDLIN(  36)		 ::Xml main = xml;
...
HXLINE(  93)					HX_STACK_DO_THROW((((HX_("Invalid binary .fnt file. Found ",18,03,19,53) + testByte) + HX_(", expected ",b4,e5,81,19)) + b));
            				}
            			}
            		}
...
HXLINE( 160)				 ::openfl::utils::ByteArrayData bytes1 = ::openfl::utils::Assets_obj::getBytes(dataStr);
HXLINE( 161)				if (::hx::IsNull( bytes1 )) {
HXLINE( 162)					return ::flixel::graphics::frames::bmfont::BMFont_obj::detectFromText(::openfl::utils::Assets_obj::getText(dataStr));
            				}
HXLINE( 164)				if (::flixel::graphics::frames::bmfont::BMFont_obj::isValidBytes(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes1))) {
HXLINE( 165)					return ::flixel::graphics::frames::bmfont::_BMFont::BMFontFileType_obj::BINARY(::openfl::utils::_ByteArray::ByteArray_Impl__obj::toBytes(bytes1));
            				}
HXLINE( 167)				return ::flixel::graphics::frames::bmfont::BMFont_obj::detectFromText(bytes1->toString());
            			}
            			else {
HXLINE( 172)				return ::flixel::graphics::frames::bmfont::BMFont_obj::detectFromText(dataStr);
            			}
            		}
HXLINE( 176)		HX_STACK_DO_THROW((HX_("Invalid FlxAngelCodeAsset: ",51,07,1f,ee) + ::Std_obj::string(data)));
