...
HXDLIN( 409)		{
HXLINE( 409)			 ::flixel::math::FlxBasePoint _this = point2;
HXDLIN( 409)			if (_this->_weak) {
HXLINE( 409)				_this->put();
            			}
            		}
...
HXDLIN( 409)		{
HXLINE( 409)			 ::flixel::math::FlxBasePoint _this1 = border;
HXDLIN( 409)			if (_this1->_weak) {
HXLINE( 409)				_this1->put();
            			}
            		}
