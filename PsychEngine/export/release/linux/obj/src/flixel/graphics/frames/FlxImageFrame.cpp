...
HXDLIN( 211)			 ::flixel::math::FlxBasePoint _this = border;
HXDLIN( 211)			 ::flixel::math::FlxBasePoint point = this->border;
HXDLIN( 211)			bool result3;
HXDLIN( 211)			if ((::Math_obj::abs((_this->x - point->x)) <= ((Float)0.0000001))) {
HXDLIN( 211)				result3 = (::Math_obj::abs((_this->y - point->y)) <= ((Float)0.0000001));
            			}
            			else {
...
HXDLIN( 237)		{
HXLINE( 237)			 ::flixel::math::FlxBasePoint _this = point2;
HXDLIN( 237)			if (_this->_weak) {
HXLINE( 237)				_this->put();
            			}
            		}
...
HXDLIN( 237)		{
HXLINE( 237)			 ::flixel::math::FlxBasePoint _this1 = border;
...
HXLINE( 112)			Float Width1 = ( (Float)(graphic->width) );
HXDLIN( 112)			Float Height1 = ( (Float)(graphic->height) );
HXDLIN( 112)			 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 112)			_this1->x = ( (Float)(0) );
HXDLIN( 112)			_this1->y = ( (Float)(0) );
...
HXLINE( 199)					 ::flixel::math::FlxBasePoint _this = frameBorder;
HXDLIN( 199)					 ::flixel::math::FlxBasePoint point2 = imageFrame->border;
HXDLIN( 199)					bool result3;
HXDLIN( 199)					if ((::Math_obj::abs((_this->x - point2->x)) <= ((Float)0.0000001))) {
HXLINE( 199)						result3 = (::Math_obj::abs((_this->y - point2->y)) <= ((Float)0.0000001));
            					}
            					else {
