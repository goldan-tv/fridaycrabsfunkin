...
HX_DEFINE_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_174_new,"flixel.graphics.frames.bmfont.BMFontSpacing","new",0x120848fe,"flixel.graphics.frames.bmfont.BMFontSpacing.new","flixel/graphics/frames/bmfont/BMFontInfo.hx",174,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_186_fromString,"flixel.graphics.frames.bmfont.BMFontSpacing","fromString",0x93e124fd,"flixel.graphics.frames.bmfont.BMFontSpacing.fromString","flixel/graphics/frames/bmfont/BMFontInfo.hx",186,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_319c3b7c9cf620d2_193_fromBytes,"flixel.graphics.frames.bmfont.BMFontSpacing","fromBytes",0x7cbeb5bf,"flixel.graphics.frames.bmfont.BMFontSpacing.fromBytes","flixel/graphics/frames/bmfont/BMFontInfo.hx",193,0x8997cf99)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
void BMFontSpacing_obj::__construct(::hx::Null< int >  __o_x,::hx::Null< int >  __o_y){
            	...
            	HX_STACKFRAME(&_hx_pos_319c3b7c9cf620d2_174_new)
HXLINE( 177)		this->y = 0;
HXLINE( 176)		this->x = 0;
HXLINE( 181)		this->x = x;
HXLINE( 182)		this->y = y;
...
bool BMFontSpacing_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontSpacing BMFontSpacing_obj::fromString(::String data){
            	HX_GC_STACKFRAME(&_hx_pos_319c3b7c9cf620d2_186_fromString)
HXLINE( 187)		::Array< ::String > values = data.split(HX_(",",2c,00,00,00));
HXLINE( 188)		 ::Dynamic _g = ::Std_obj::parseInt(values->__get(0));
HXDLIN( 188)		return  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,_g,::Std_obj::parseInt(values->__get(1)));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontSpacing_obj,fromString,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontSpacing BMFontSpacing_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_319c3b7c9cf620d2_193_fromBytes)
HXDLIN( 193)		int _g = bytes->readByte();
HXDLIN( 193)		return  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,_g,bytes->readByte());
            	}
