...
HX_LOCAL_STACK_FRAME(_hx_pos_2c0e2637f231fc17_33_fromXml,"flixel.graphics.frames.bmfont.BMFontInfo","fromXml",0x1dbf4764,"flixel.graphics.frames.bmfont.BMFontInfo.fromXml","flixel/graphics/frames/bmfont/BMFontInfo.hx",33,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_2c0e2637f231fc17_69_fromText,"flixel.graphics.frames.bmfont.BMFontInfo","fromText",0xe6f44e80,"flixel.graphics.frames.bmfont.BMFontInfo.fromText","flixel/graphics/frames/bmfont/BMFontInfo.hx",69,0x8997cf99)
HX_LOCAL_STACK_FRAME(_hx_pos_2c0e2637f231fc17_51_fromText,"flixel.graphics.frames.bmfont.BMFontInfo","fromText",0xe6f44e80,"flixel.graphics.frames.bmfont.BMFontInfo.fromText","flixel/graphics/frames/bmfont/BMFontInfo.hx",51,0x8997cf99)
...
HX_LOCAL_STACK_FRAME(_hx_pos_2c0e2637f231fc17_107_fromBytes,"flixel.graphics.frames.bmfont.BMFontInfo","fromBytes",0xdecf1f38,"flixel.graphics.frames.bmfont.BMFontInfo.fromBytes","flixel/graphics/frames/bmfont/BMFontInfo.hx",107,0x8997cf99)
namespace flixel{
namespace graphics{
namespace frames{
namespace bmfont{
...
bool BMFontInfo_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::graphics::frames::bmfont::BMFontInfo BMFontInfo_obj::fromXml( ::Xml infoNode){
            	HX_GC_STACKFRAME(&_hx_pos_2c0e2637f231fc17_33_fromXml)
HXLINE(  34)		::String _g = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::string(infoNode,HX_("face",9d,b4,b5,43));
HXLINE(  35)		int _g1 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::_hx_int(infoNode,HX_("size",c1,a0,53,4c));
HXLINE(  36)		bool _g2 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::boolSafe(infoNode,HX_("bold",85,81,1b,41),false);
HXLINE(  37)		bool _g3 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::boolSafe(infoNode,HX_("italic",f0,2e,64,06),false);
HXLINE(  38)		bool _g4 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::boolSafe(infoNode,HX_("smooth",2e,08,6b,07),false);
HXLINE(  39)		::String _g5 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::stringWarn(infoNode,HX_("charset",8c,a6,7a,cf),null());
HXLINE(  40)		bool _g6 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::boolWarn(infoNode,HX_("unicode",1d,91,68,b3),false);
HXLINE(  41)		int _g7 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(infoNode,HX_("stretchH",a3,06,83,92),100);
HXLINE(  42)		int _g8 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intWarn(infoNode,HX_("aa",e0,54,00,00),1);
HXLINE(  43)		::Array< ::String > values = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::stringWarn(infoNode,HX_("padding",d1,59,7d,d0),null()).split(HX_(",",2c,00,00,00));
HXDLIN(  43)		 ::Dynamic _g9 = ::Std_obj::parseInt(values->__get(0));
HXDLIN(  43)		 ::Dynamic _g10 = ::Std_obj::parseInt(values->__get(1));
HXDLIN(  43)		 ::Dynamic _g11 = ::Std_obj::parseInt(values->__get(2));
HXDLIN(  43)		 ::flixel::graphics::frames::bmfont::BMFontPadding _g12 =  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g9,_g10,_g11,::Std_obj::parseInt(values->__get(3)));
HXLINE(  44)		 ::flixel::graphics::frames::bmfont::BMFontSpacing _g13 = ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::fromString(::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::stringWarn(infoNode,HX_("spacing",83,33,bb,91),null()));
HXLINE(  45)		 ::Dynamic _g14 = ::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::intSafe(infoNode,HX_("outline",82,17,be,e1),0);
HXLINE(  33)		return  ::flixel::graphics::frames::bmfont::BMFontInfo_obj::__alloc( HX_CTX ,_g,_g1,_g2,_g3,_g5,_g6,_g7,_g4,_g8,_g12,_g13,_g14,::flixel::graphics::frames::bmfont::_BMFontXml::AttribAccess_Impl__obj::boolSafe(infoNode,HX_("fixedHeight",7b,04,7d,1e),false));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontInfo_obj,fromXml,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontInfo BMFontInfo_obj::fromText(::String infoText){
            		...
            		void _hx_run(::String key,::String value){
            			HX_GC_STACKFRAME(&_hx_pos_2c0e2637f231fc17_69_fromText)
HXLINE(  69)			::String _hx_switch_0 = key;
            			if (  (_hx_switch_0==HX_("aa",e0,54,00,00)) ){
HXLINE(  79)				aa[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  79)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("bold",85,81,1b,41)) ){
HXLINE(  73)				bold[0] = (value != HX_("0",30,00,00,00));
HXDLIN(  73)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("charset",8c,a6,7a,cf)) ){
HXLINE(  75)				charset[0] = value;
HXDLIN(  75)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("face",9d,b4,b5,43)) ){
HXLINE(  71)				face[0] = value;
HXDLIN(  71)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("fixedHeight",7b,04,7d,1e)) ){
HXLINE(  83)				fixedHeight[0] = (value != HX_("0",30,00,00,00));
HXDLIN(  83)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("italic",f0,2e,64,06)) ){
HXLINE(  74)				italic[0] = (value != HX_("0",30,00,00,00));
HXDLIN(  74)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("outline",82,17,be,e1)) ){
HXLINE(  82)				outline[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  82)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("padding",d1,59,7d,d0)) ){
HXLINE(  80)				::Array< ::Dynamic> padding1 = padding;
HXDLIN(  80)				::Array< ::String > values = value.split(HX_(",",2c,00,00,00));
HXDLIN(  80)				 ::Dynamic _g = ::Std_obj::parseInt(values->__get(0));
HXDLIN(  80)				 ::Dynamic _g1 = ::Std_obj::parseInt(values->__get(1));
HXDLIN(  80)				 ::Dynamic _g2 = ::Std_obj::parseInt(values->__get(2));
HXDLIN(  80)				padding1[0] =  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g,_g1,_g2,::Std_obj::parseInt(values->__get(3)));
HXDLIN(  80)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("size",c1,a0,53,4c)) ){
HXLINE(  72)				size[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  72)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("smooth",2e,08,6b,07)) ){
HXLINE(  78)				smooth[0] = (value != HX_("0",30,00,00,00));
HXDLIN(  78)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("spacing",83,33,bb,91)) ){
HXLINE(  81)				spacing[0] = ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::fromString(value);
HXDLIN(  81)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("stretchH",a3,06,83,92)) ){
HXLINE(  77)				stretchH[0] = ( (int)(::Std_obj::parseInt(value)) );
HXDLIN(  77)				goto _hx_goto_2;
            			}
            			if (  (_hx_switch_0==HX_("unicode",1d,91,68,b3)) ){
HXLINE(  76)				unicode[0] = (value != HX_("0",30,00,00,00));
HXDLIN(  76)				goto _hx_goto_2;
            	...
            	HX_GC_STACKFRAME(&_hx_pos_2c0e2637f231fc17_51_fromText)
HXLINE(  52)		::Array< ::String > face = ::Array_obj< ::String >::__new(1)->init(0,null());
HXLINE(  53)		::Array< int > size = ::Array_obj< int >::fromData( _hx_array_data_dccd3a45_5,1);
HXLINE(  54)		::Array< bool > bold = ::Array_obj< bool >::fromData( _hx_array_data_dccd3a45_6,1);
HXLINE(  55)		::Array< bool > italic = ::Array_obj< bool >::fromData( _hx_array_data_dccd3a45_7,1);
HXLINE(  56)		::Array< bool > smooth = ::Array_obj< bool >::fromData( _hx_array_data_dccd3a45_8,1);
HXLINE(  57)		::Array< ::String > charset = ::Array_obj< ::String >::__new(1)->init(0,null());
HXLINE(  58)		::Array< bool > unicode = ::Array_obj< bool >::fromData( _hx_array_data_dccd3a45_9,1);
HXLINE(  59)		::Array< int > stretchH = ::Array_obj< int >::fromData( _hx_array_data_dccd3a45_10,1);
HXLINE(  60)		::Array< int > aa = ::Array_obj< int >::fromData( _hx_array_data_dccd3a45_11,1);
HXLINE(  61)		::Array< ::Dynamic> padding = ::Array_obj< ::Dynamic>::__new(1)->init(0, ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,null(),null(),null(),null()));
HXLINE(  62)		::Array< ::Dynamic> spacing = ::Array_obj< ::Dynamic>::__new(1)->init(0, ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,null(),null()));
HXLINE(  63)		::Array< int > outline = ::Array_obj< int >::fromData( _hx_array_data_dccd3a45_12,1);
HXLINE(  64)		::Array< bool > fixedHeight = ::Array_obj< bool >::fromData( _hx_array_data_dccd3a45_13,1);
HXLINE(  66)		::flixel::graphics::frames::bmfont::BMFontUtil_obj::forEachAttribute(infoText, ::Dynamic(new _hx_Closure_0(stretchH,unicode,spacing,fixedHeight,face,smooth,italic,aa,padding,charset,size,outline,bold)));
HXLINE(  88)		return  ::flixel::graphics::frames::bmfont::BMFontInfo_obj::__alloc( HX_CTX ,face->__get(0),size->__get(0),bold->__get(0),italic->__get(0),charset->__get(0),unicode->__get(0),stretchH->__get(0),smooth->__get(0),aa->__get(0),padding->__get(0).StaticCast<  ::flixel::graphics::frames::bmfont::BMFontPadding >(),spacing->__get(0).StaticCast<  ::flixel::graphics::frames::bmfont::BMFontSpacing >(),outline->__get(0),fixedHeight->__get(0));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BMFontInfo_obj,fromText,return )
 ...
 ::flixel::graphics::frames::bmfont::BMFontInfo BMFontInfo_obj::fromBytes( ::haxe::io::BytesInput bytes){
            	HX_GC_STACKFRAME(&_hx_pos_2c0e2637f231fc17_107_fromBytes)
HXLINE( 108)		int blockSize = bytes->readInt32();
HXLINE( 109)		int size = bytes->readInt16();
HXLINE( 110)		int bitField = bytes->readByte();
HXLINE( 111)		int charsetByte = bytes->readByte();
HXLINE( 120)		::String _g;
HXDLIN( 120)		if ((charsetByte > 0)) {
HXLINE( 120)			_g = ::String::fromCharCode(charsetByte);
            		}
            		else {
HXLINE( 120)			_g = HX_("",00,00,00,00);
            		}
HXLINE( 121)		int _g1 = bytes->readUInt16();
HXLINE( 122)		int _g2 = bytes->readByte();
HXLINE( 123)		 ::haxe::io::BytesInput bytes1 =  ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,bytes->read(4),null(),null());
HXDLIN( 123)		int _g3 = bytes1->readByte();
HXDLIN( 123)		int _g4 = bytes1->readByte();
HXDLIN( 123)		int _g5 = bytes1->readByte();
HXDLIN( 123)		 ::flixel::graphics::frames::bmfont::BMFontPadding _g6 =  ::flixel::graphics::frames::bmfont::BMFontPadding_obj::__alloc( HX_CTX ,_g3,_g4,_g5,bytes1->readByte());
HXLINE( 124)		 ::haxe::io::BytesInput bytes2 =  ::haxe::io::BytesInput_obj::__alloc( HX_CTX ,bytes->read(2),null(),null());
HXDLIN( 124)		int _g7 = bytes2->readByte();
HXDLIN( 124)		 ::flixel::graphics::frames::bmfont::BMFontSpacing _g8 =  ::flixel::graphics::frames::bmfont::BMFontSpacing_obj::__alloc( HX_CTX ,_g7,bytes2->readByte());
HXLINE( 125)		 ::Dynamic _g9 = bytes->readByte();
HXLINE( 112)		 ::flixel::graphics::frames::bmfont::BMFontInfo fontInfo =  ::flixel::graphics::frames::bmfont::BMFontInfo_obj::__alloc( HX_CTX ,bytes->readString(((blockSize - 14) - 1),null()),size,((bitField & 16) != 0),((bitField & 32) != 0),_g,((bitField & 64) != 0),_g1,((bitField & 128) != 0),_g2,_g6,_g8,_g9,((bitField & 8) != 0));
HXLINE( 128)		bytes->readByte();
HXLINE( 129)		return fontInfo;
            	}
