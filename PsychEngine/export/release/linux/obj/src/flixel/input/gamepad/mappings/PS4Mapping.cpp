...
HXLINE(  51)					int id1 = rawID;
HXDLIN(  51)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  51)						return 36;
            					}
            					else {
HXLINE(  52)						int id2 = rawID;
HXDLIN(  52)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  52)							return 37;
            						}
            						else {
HXLINE(  53)							int id3 = rawID;
HXDLIN(  53)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  53)								return 35;
            							}
            							else {
HXLINE(  54)								int id4 = rawID;
HXDLIN(  54)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  54)									return 38;
            								}
            								else {
HXLINE(  55)									int id5 = rawID;
HXDLIN(  55)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  55)										return 40;
            									}
            									else {
HXLINE(  56)										int id6 = rawID;
HXDLIN(  56)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  56)											return 41;
            										}
            										else {
HXLINE(  57)											int id7 = rawID;
HXDLIN(  57)											if ((id7 == this->rightStick->rawRight)) {
HXLINE(  57)												return 39;
            											}
            											else {
HXLINE(  58)												return -1;
