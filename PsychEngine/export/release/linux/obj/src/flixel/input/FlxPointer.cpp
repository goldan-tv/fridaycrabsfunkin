...
bool FlxPointer_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::flixel::math::FlxBasePoint FlxPointer_obj::getWorldPosition( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point){
...
HX_DEFINE_DYNAMIC_FUNC2(FlxPointer_obj,getWorldPosition,return )
 ...
 ::flixel::math::FlxBasePoint FlxPointer_obj::getScreenPosition( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point){
...
HXLINE(  63)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
...
HX_DEFINE_DYNAMIC_FUNC2(FlxPointer_obj,getScreenPosition,return )
 ...
 ::flixel::math::FlxBasePoint FlxPointer_obj::getPositionInCameraView( ::flixel::FlxCamera Camera, ::flixel::math::FlxBasePoint point){
...
HXLINE(  88)		point->set_x((((( (Float)(this->_globalScreenX) ) - Camera->x) / Camera->zoom) + Camera->viewMarginX));
HXLINE(  89)		point->set_y((((( (Float)(this->_globalScreenY) ) - Camera->y) / Camera->zoom) + Camera->viewMarginY));
...
HX_DEFINE_DYNAMIC_FUNC2(FlxPointer_obj,getPositionInCameraView,return )
 ...
 ::flixel::math::FlxBasePoint FlxPointer_obj::getPosition( ::flixel::math::FlxBasePoint point){
            	HX_STACKFRAME(&_hx_pos_e74b11cf5585adaf_98_getPosition)
HXLINE(  99)		if (::hx::IsNull( point )) {
HXLINE( 100)			 ::flixel::math::FlxBasePoint point1 = ::flixel::math::FlxBasePoint_obj::pool->get().StaticCast<  ::flixel::math::FlxBasePoint >()->set(( (Float)(0) ),( (Float)(0) ));
HXDLIN( 100)			point1->_inPool = false;
HXDLIN( 100)			point = point1;
            		}
HXLINE( 101)		Float y = ( (Float)(this->y) );
HXDLIN( 101)		point->set_x(( (Float)(this->x) ));
HXDLIN( 101)		point->set_y(y);
HXDLIN( 101)		return point;
            	}
...
HXLINE( 132)			this->getWorldPosition(Camera,::flixel::input::FlxPointer_obj::_cachedPoint);
...
HXDLIN( 154)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 154)		_this->label = HX_("x",78,00,00,00);
HXDLIN( 154)		_this->value = value;
HXDLIN( 154)		 ::Dynamic value1 = this->y;
HXDLIN( 154)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
...
HXDLIN(  19)		_cachedPoint =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
            	}
}
