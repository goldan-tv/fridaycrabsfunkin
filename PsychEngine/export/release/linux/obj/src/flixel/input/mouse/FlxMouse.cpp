...
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_247_load,"flixel.input.mouse.FlxMouse","load",0xf3e8bd02,"flixel.input.mouse.FlxMouse.load","flixel/input/mouse/FlxMouse.hx",247,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_319_unload,"flixel.input.mouse.FlxMouse","unload",0x5a7132db,"flixel.input.mouse.FlxMouse.unload","flixel/input/mouse/FlxMouse.hx",319,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_405_destroy,"flixel.input.mouse.FlxMouse","destroy",0x77a13b9e,"flixel.input.mouse.FlxMouse.destroy","flixel/input/mouse/FlxMouse.hx",405,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_444_reset,"flixel.input.mouse.FlxMouse","reset",0xe595a773,"flixel.input.mouse.FlxMouse.reset","flixel/input/mouse/FlxMouse.hx",444,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_493_update,"flixel.input.mouse.FlxMouse","update",0x7bea17e5,"flixel.input.mouse.FlxMouse.update","flixel/input/mouse/FlxMouse.hx",493,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_529_onFocus,"flixel.input.mouse.FlxMouse","onFocus",0xede20cdd,"flixel.input.mouse.FlxMouse.onFocus","flixel/input/mouse/FlxMouse.hx",529,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_543_onFocusLost,"flixel.input.mouse.FlxMouse","onFocusLost",0xc7f71561,"flixel.input.mouse.FlxMouse.onFocusLost","flixel/input/mouse/FlxMouse.hx",543,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_560_onGameStart,"flixel.input.mouse.FlxMouse","onGameStart",0x61da7695,"flixel.input.mouse.FlxMouse.onGameStart","flixel/input/mouse/FlxMouse.hx",560,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_568_onMouseWheel,"flixel.input.mouse.FlxMouse","onMouseWheel",0xdc642911,"flixel.input.mouse.FlxMouse.onMouseWheel","flixel/input/mouse/FlxMouse.hx",568,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_581_onMouseLeave,"flixel.input.mouse.FlxMouse","onMouseLeave",0x84fd296d,"flixel.input.mouse.FlxMouse.onMouseLeave","flixel/input/mouse/FlxMouse.hx",581,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_588_get_justMoved,"flixel.input.mouse.FlxMouse","get_justMoved",0xd61e87e2,"flixel.input.mouse.FlxMouse.get_justMoved","flixel/input/mouse/FlxMouse.hx",588,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_591_get_deltaX,"flixel.input.mouse.FlxMouse","get_deltaX",0x58943105,"flixel.input.mouse.FlxMouse.get_deltaX","flixel/input/mouse/FlxMouse.hx",591,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_594_get_deltaY,"flixel.input.mouse.FlxMouse","get_deltaY",0x58943106,"flixel.input.mouse.FlxMouse.get_deltaY","flixel/input/mouse/FlxMouse.hx",594,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_597_get_deltaScreenX,"flixel.input.mouse.FlxMouse","get_deltaScreenX",0x17615bb9,"flixel.input.mouse.FlxMouse.get_deltaScreenX","flixel/input/mouse/FlxMouse.hx",597,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_600_get_deltaScreenY,"flixel.input.mouse.FlxMouse","get_deltaScreenY",0x17615bba,"flixel.input.mouse.FlxMouse.get_deltaScreenY","flixel/input/mouse/FlxMouse.hx",600,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_603_get_pressed,"flixel.input.mouse.FlxMouse","get_pressed",0x4652635d,"flixel.input.mouse.FlxMouse.get_pressed","flixel/input/mouse/FlxMouse.hx",603,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_606_get_justPressed,"flixel.input.mouse.FlxMouse","get_justPressed",0x70091811,"flixel.input.mouse.FlxMouse.get_justPressed","flixel/input/mouse/FlxMouse.hx",606,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_609_get_released,"flixel.input.mouse.FlxMouse","get_released",0x489a9ba2,"flixel.input.mouse.FlxMouse.get_released","flixel/input/mouse/FlxMouse.hx",609,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_612_get_justReleased,"flixel.input.mouse.FlxMouse","get_justReleased",0x9ec2046e,"flixel.input.mouse.FlxMouse.get_justReleased","flixel/input/mouse/FlxMouse.hx",612,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_615_get_justPressedTimeInTicks,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicks",0xbe077333,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicks","flixel/input/mouse/FlxMouse.hx",615,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_619_get_pressedRight,"flixel.input.mouse.FlxMouse","get_pressedRight",0x90e8c73f,"flixel.input.mouse.FlxMouse.get_pressedRight","flixel/input/mouse/FlxMouse.hx",619,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_622_get_justPressedRight,"flixel.input.mouse.FlxMouse","get_justPressedRight",0xa8a2860b,"flixel.input.mouse.FlxMouse.get_justPressedRight","flixel/input/mouse/FlxMouse.hx",622,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_625_get_releasedRight,"flixel.input.mouse.FlxMouse","get_releasedRight",0xdc7574da,"flixel.input.mouse.FlxMouse.get_releasedRight","flixel/input/mouse/FlxMouse.hx",625,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_628_get_justReleasedRight,"flixel.input.mouse.FlxMouse","get_justReleasedRight",0x8742a88e,"flixel.input.mouse.FlxMouse.get_justReleasedRight","flixel/input/mouse/FlxMouse.hx",628,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_631_get_justPressedTimeInTicksRight,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksRight",0xf3dc8fa9,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksRight","flixel/input/mouse/FlxMouse.hx",631,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_634_get_pressedMiddle,"flixel.input.mouse.FlxMouse","get_pressedMiddle",0x38fe0e92,"flixel.input.mouse.FlxMouse.get_pressedMiddle","flixel/input/mouse/FlxMouse.hx",634,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_637_get_justPressedMiddle,"flixel.input.mouse.FlxMouse","get_justPressedMiddle",0xe3cb4246,"flixel.input.mouse.FlxMouse.get_justPressedMiddle","flixel/input/mouse/FlxMouse.hx",637,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_640_get_releasedMiddle,"flixel.input.mouse.FlxMouse","get_releasedMiddle",0x08894897,"flixel.input.mouse.FlxMouse.get_releasedMiddle","flixel/input/mouse/FlxMouse.hx",640,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_643_get_justReleasedMiddle,"flixel.input.mouse.FlxMouse","get_justReleasedMiddle",0xd1495263,"flixel.input.mouse.FlxMouse.get_justReleasedMiddle","flixel/input/mouse/FlxMouse.hx",643,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_646_get_justPressedTimeInTicksMiddle,"flixel.input.mouse.FlxMouse","get_justPressedTimeInTicksMiddle",0x6b59a2e8,"flixel.input.mouse.FlxMouse.get_justPressedTimeInTicksMiddle","flixel/input/mouse/FlxMouse.hx",646,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_650_showSystemCursor,"flixel.input.mouse.FlxMouse","showSystemCursor",0xf4551c9e,"flixel.input.mouse.FlxMouse.showSystemCursor","flixel/input/mouse/FlxMouse.hx",650,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_661_hideSystemCursor,"flixel.input.mouse.FlxMouse","hideSystemCursor",0xb5438fe3,"flixel.input.mouse.FlxMouse.hideSystemCursor","flixel/input/mouse/FlxMouse.hx",661,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_678_set_useSystemCursor,"flixel.input.mouse.FlxMouse","set_useSystemCursor",0x074e74d3,"flixel.input.mouse.FlxMouse.set_useSystemCursor","flixel/input/mouse/FlxMouse.hx",678,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_692_showCursor,"flixel.input.mouse.FlxMouse","showCursor",0xa585e38f,"flixel.input.mouse.FlxMouse.showCursor","flixel/input/mouse/FlxMouse.hx",692,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_711_hideCursor,"flixel.input.mouse.FlxMouse","hideCursor",0xd396e514,"flixel.input.mouse.FlxMouse.hideCursor","flixel/input/mouse/FlxMouse.hx",711,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_717_set_visible,"flixel.input.mouse.FlxMouse","set_visible",0xb9fd1039,"flixel.input.mouse.FlxMouse.set_visible","flixel/input/mouse/FlxMouse.hx",717,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_728_record,"flixel.input.mouse.FlxMouse","record",0xf2d1086d,"flixel.input.mouse.FlxMouse.record","flixel/input/mouse/FlxMouse.hx",728,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_746_playback,"flixel.input.mouse.FlxMouse","playback",0xaadcd2f7,"flixel.input.mouse.FlxMouse.playback","flixel/input/mouse/FlxMouse.hx",746,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_764_get__cursor,"flixel.input.mouse.FlxMouse","get__cursor",0xb9cb3130,"flixel.input.mouse.FlxMouse.get__cursor","flixel/input/mouse/FlxMouse.hx",764,0xe4e80b89)
HX_LOCAL_STACK_FRAME(_hx_pos_dcc29ee8d0f87524_769_set__cursor,"flixel.input.mouse.FlxMouse","set__cursor",0xc438383c,"flixel.input.mouse.FlxMouse.set__cursor","flixel/input/mouse/FlxMouse.hx",769,0xe4e80b89)
namespace flixel{
namespace input{
namespace mouse{
...
HXLINE( 221)		this->_prevScreenY = 0;
HXLINE( 220)		this->_prevScreenX = 0;
HXLINE( 219)		this->_prevY = 0;
HXLINE( 218)		this->_prevX = 0;
HXLINE( 212)		this->_lastWheel = 0;
HXLINE( 211)		this->_lastY = 0;
HXLINE( 209)		this->_lastX = 0;
HXLINE( 204)		this->_visibleWhenFocusLost = true;
HXLINE( 203)		this->_wheelUsed = false;
...
HXLINE( 460)		this->cursorContainer = cursorContainer;
HXLINE( 461)		this->cursorContainer->mouseChildren = false;
HXLINE( 462)		this->cursorContainer->mouseEnabled = false;
HXLINE( 464)		this->_leftButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-1);
HXLINE( 466)		this->_stage = ::openfl::Lib_obj::get_current()->stage;
HXLINE( 467)		this->_stage->addEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null(),null(),null());
HXLINE( 468)		this->_stage->addEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null(),null(),null());
HXLINE( 471)		this->_middleButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-2);
HXLINE( 472)		this->_rightButton =  ::flixel::input::mouse::FlxMouseButton_obj::__alloc( HX_CTX ,-3);
HXLINE( 474)		this->_stage->addEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null(),null(),null());
HXLINE( 475)		this->_stage->addEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null(),null(),null());
HXLINE( 476)		this->_stage->addEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null(),null(),null());
HXLINE( 477)		this->_stage->addEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null(),null(),null());
HXLINE( 479)		this->_stage->addEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null(),null(),null());
HXLINE( 482)		this->_stage->addEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null(),null(),null());
HXLINE( 484)		::flixel::FlxG_obj::signals->postGameStart->add(this->onGameStart_dyn());
HXLINE( 485)		::openfl::ui::Mouse_obj::hide();
            	}
...
void FlxMouse_obj::load( ::Dynamic Graphic,::hx::Null< Float >  __o_Scale,::hx::Null< int >  __o_XOffset,::hx::Null< int >  __o_YOffset){
            	...
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_247_load)
HXLINE( 249)		if (::hx::IsNotNull( this->cursor )) {
HXLINE( 251)			::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->cursor);
            		}
HXLINE( 255)		if (::hx::IsNull( Graphic )) {
HXLINE( 257)			Graphic =  ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null());
            		}
HXLINE( 260)		if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::hx::Class >())) {
HXLINE( 262)			this->cursor = ( ( ::openfl::display::Bitmap)(::Type_obj::createInstance(Graphic,::cpp::VirtualArray_obj::__new(0))) );
            		}
            		else {
HXLINE( 264)			if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::openfl::display::BitmapData >())) {
HXLINE( 266)				this->cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,( ( ::openfl::display::BitmapData)(Graphic) ),null(),null());
            			}
            			else {
HXLINE( 268)				if (::Std_obj::isOfType(Graphic,::hx::ClassOf< ::String >())) {
HXLINE( 270)					::String id = ( (::String)(Graphic) );
HXDLIN( 270)					 ::openfl::display::BitmapData _hx_tmp;
HXDLIN( 270)					if (::openfl::utils::Assets_obj::exists(id,null())) {
HXLINE( 270)						_hx_tmp = ::openfl::utils::Assets_obj::getBitmapData(id,false);
            					}
            					else {
HXLINE( 270)						::flixel::FlxG_obj::log->advanced(((HX_("Could not find a BitmapData asset with ID '",5f,79,a9,21) + id) + HX_("'.",27,22,00,00)),::flixel::_hx_system::debug::log::LogStyle_obj::ERROR,true);
HXDLIN( 270)						_hx_tmp = null();
            					}
HXDLIN( 270)					this->cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX ,_hx_tmp,null(),null());
            				}
            				else {
HXLINE( 274)					this->cursor =  ::openfl::display::Bitmap_obj::__alloc( HX_CTX , ::flixel::input::mouse::_FlxMouse::GraphicCursor_obj::__alloc( HX_CTX ,0,0,null(),null()),null(),null());
            				}
            			}
            		}
HXLINE( 277)		this->cursor->set_x(( (Float)(XOffset) ));
HXLINE( 278)		this->cursor->set_y(( (Float)(YOffset) ));
HXLINE( 279)		this->cursor->set_scaleX(Scale);
HXLINE( 280)		this->cursor->set_scaleY(Scale);
HXLINE( 309)		this->cursorContainer->addChild(this->cursor);
            	}
...
void FlxMouse_obj::unload(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_319_unload)
HXDLIN( 319)		if (::hx::IsNotNull( this->cursor )) {
HXLINE( 321)			if (this->cursorContainer->get_visible()) {
HXLINE( 323)				this->load(null(),null(),null(),null());
            			}
            			else {
HXLINE( 327)				this->cursor = ( ( ::openfl::display::Bitmap)(::flixel::util::FlxDestroyUtil_obj::removeChild(this->cursorContainer,this->cursor)) );
            			}
            		}
            	}
...
void FlxMouse_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_405_destroy)
HXLINE( 406)		if (::hx::IsNotNull( this->_stage )) {
HXLINE( 408)			this->_stage->removeEventListener(HX_("mouseDown",27,b1,c2,ee),this->_leftButton->onDown_dyn(),null());
HXLINE( 409)			this->_stage->removeEventListener(HX_("mouseUp",e0,f3,72,c0),this->_leftButton->onUp_dyn(),null());
HXLINE( 412)			this->_stage->removeEventListener(HX_("middleMouseDown",12,2b,fe,01),this->_middleButton->onDown_dyn(),null());
HXLINE( 413)			this->_stage->removeEventListener(HX_("middleMouseUp",0b,8d,f5,3a),this->_middleButton->onUp_dyn(),null());
HXLINE( 414)			this->_stage->removeEventListener(HX_("rightMouseDown",ab,29,d7,cd),this->_rightButton->onDown_dyn(),null());
HXLINE( 415)			this->_stage->removeEventListener(HX_("rightMouseUp",64,83,21,ab),this->_rightButton->onUp_dyn(),null());
HXLINE( 417)			this->_stage->removeEventListener(HX_("mouseLeave",92,28,20,90),this->onMouseLeave_dyn(),null());
HXLINE( 420)			this->_stage->removeEventListener(HX_("mouseWheel",36,28,87,e7),this->onMouseWheel_dyn(),null());
            		}
HXLINE( 423)		this->cursorContainer = null();
HXLINE( 424)		this->cursor = null();
HXLINE( 430)		this->_leftButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_leftButton)) );
HXLINE( 432)		this->_middleButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_middleButton)) );
HXLINE( 433)		this->_rightButton = ( ( ::flixel::input::mouse::FlxMouseButton)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_rightButton)) );
HXLINE( 436)		this->_cursorBitmapData = ::flixel::util::FlxDestroyUtil_obj::dispose(this->_cursorBitmapData);
HXLINE( 437)		::flixel::FlxG_obj::signals->postGameStart->remove(this->onGameStart_dyn());
            	}
...
void FlxMouse_obj::reset(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_444_reset)
HXLINE( 445)		this->_leftButton->reset();
HXLINE( 448)		this->_middleButton->reset();
HXLINE( 449)		this->_rightButton->reset();
            	}
...
void FlxMouse_obj::update(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_493_update)
HXLINE( 494)		this->_prevX = this->x;
HXLINE( 495)		this->_prevY = this->y;
HXLINE( 496)		this->_prevScreenX = this->screenX;
HXLINE( 497)		this->_prevScreenY = this->screenY;
HXLINE( 500)		{
HXLINE( 500)			Float newX = ::flixel::FlxG_obj::game->get_mouseX();
HXDLIN( 500)			Float newY = ::flixel::FlxG_obj::game->get_mouseY();
HXDLIN( 500)			this->_globalScreenX = ::Std_obj::_hx_int((newX / ::flixel::FlxG_obj::scaleMode->scale->x));
HXDLIN( 500)			this->_globalScreenY = ::Std_obj::_hx_int((newY / ::flixel::FlxG_obj::scaleMode->scale->y));
HXDLIN( 500)			this->updatePositions();
            		}
HXLINE( 503)		if (this->visible) {
HXLINE( 505)			 ::openfl::display::Sprite _hx_tmp = this->cursorContainer;
HXDLIN( 505)			_hx_tmp->set_x(::flixel::FlxG_obj::game->get_mouseX());
HXLINE( 506)			 ::openfl::display::Sprite _hx_tmp1 = this->cursorContainer;
HXDLIN( 506)			_hx_tmp1->set_y(::flixel::FlxG_obj::game->get_mouseY());
            		}
HXLINE( 511)		this->_leftButton->update();
HXLINE( 513)		this->_middleButton->update();
HXLINE( 514)		this->_rightButton->update();
HXLINE( 518)		if (!(this->_wheelUsed)) {
HXLINE( 520)			this->wheel = 0;
            		}
HXLINE( 522)		this->_wheelUsed = false;
            	}
...
void FlxMouse_obj::onFocus(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_529_onFocus)
HXLINE( 530)		this->reset();
HXLINE( 533)		this->set_useSystemCursor(this->useSystemCursor);
HXLINE( 535)		this->set_visible(this->_visibleWhenFocusLost);
            	}
...
void FlxMouse_obj::onFocusLost(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_543_onFocusLost)
HXLINE( 545)		this->_visibleWhenFocusLost = this->visible;
HXLINE( 547)		if (this->visible) {
HXLINE( 549)			this->set_visible(false);
            		}
HXLINE( 552)		::openfl::ui::Mouse_obj::show();
            	}
...
void FlxMouse_obj::onGameStart(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_560_onGameStart)
HXDLIN( 560)		this->set_visible(this->visible);
            	}
...
void FlxMouse_obj::onMouseWheel( ::openfl::events::MouseEvent flashEvent){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_568_onMouseWheel)
HXDLIN( 568)		if (this->enabled) {
HXLINE( 570)			this->_wheelUsed = true;
HXLINE( 571)			this->wheel = flashEvent->delta;
            		}
            	}
...
void FlxMouse_obj::onMouseLeave( ::openfl::events::Event _){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_581_onMouseLeave)
HXLINE( 582)		this->_rightButton->onUp(null());
HXLINE( 583)		this->_middleButton->onUp(null());
            	}
...
bool FlxMouse_obj::get_justMoved(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_588_get_justMoved)
HXDLIN( 588)		if ((this->_prevX == this->x)) {
HXDLIN( 588)			return (this->_prevY != this->y);
            		}
            		else {
...
int FlxMouse_obj::get_deltaX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_591_get_deltaX)
HXDLIN( 591)		return (this->x - this->_prevX);
            	}
...
int FlxMouse_obj::get_deltaY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_594_get_deltaY)
HXDLIN( 594)		return (this->y - this->_prevY);
            	}
...
int FlxMouse_obj::get_deltaScreenX(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_597_get_deltaScreenX)
HXDLIN( 597)		return (this->screenX - this->_prevScreenX);
            	}
...
int FlxMouse_obj::get_deltaScreenY(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_600_get_deltaScreenY)
HXDLIN( 600)		return (this->screenY - this->_prevScreenY);
            	}
...
bool FlxMouse_obj::get_pressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_603_get_pressed)
HXDLIN( 603)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 603)		if ((_this->current != 1)) {
HXDLIN( 603)			return (_this->current == 2);
            		}
            		else {
...
bool FlxMouse_obj::get_justPressed(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_606_get_justPressed)
HXDLIN( 606)		return (this->_leftButton->current == 2);
            	}
...
bool FlxMouse_obj::get_released(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_609_get_released)
HXDLIN( 609)		 ::flixel::input::mouse::FlxMouseButton _this = this->_leftButton;
HXDLIN( 609)		if ((_this->current != 0)) {
HXDLIN( 609)			return (_this->current == -1);
            		}
            		else {
...
bool FlxMouse_obj::get_justReleased(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_612_get_justReleased)
HXDLIN( 612)		return (this->_leftButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicks(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_615_get_justPressedTimeInTicks)
HXDLIN( 615)		return this->_leftButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_619_get_pressedRight)
HXDLIN( 619)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 619)		if ((_this->current != 1)) {
HXDLIN( 619)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 619)			return true;
            		}
HXDLIN( 619)		return false;
            	}
...
bool FlxMouse_obj::get_justPressedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_622_get_justPressedRight)
HXDLIN( 622)		return (this->_rightButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_625_get_releasedRight)
HXDLIN( 625)		 ::flixel::input::mouse::FlxMouseButton _this = this->_rightButton;
HXDLIN( 625)		if ((_this->current != 0)) {
HXDLIN( 625)			return (_this->current == -1);
            		}
            		else {
HXDLIN( 625)			return true;
            		}
HXDLIN( 625)		return false;
            	}
...
bool FlxMouse_obj::get_justReleasedRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_628_get_justReleasedRight)
HXDLIN( 628)		return (this->_rightButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksRight(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_631_get_justPressedTimeInTicksRight)
HXDLIN( 631)		return this->_rightButton->justPressedTimeInTicks;
            	}
...
bool FlxMouse_obj::get_pressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_634_get_pressedMiddle)
HXDLIN( 634)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 634)		if ((_this->current != 1)) {
HXDLIN( 634)			return (_this->current == 2);
            		}
            		else {
HXDLIN( 634)			return true;
            		}
HXDLIN( 634)		return false;
            	}
...
bool FlxMouse_obj::get_justPressedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_637_get_justPressedMiddle)
HXDLIN( 637)		return (this->_middleButton->current == 2);
            	}
...
bool FlxMouse_obj::get_releasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_640_get_releasedMiddle)
HXDLIN( 640)		 ::flixel::input::mouse::FlxMouseButton _this = this->_middleButton;
HXDLIN( 640)		if ((_this->current != 0)) {
HXDLIN( 640)			return (_this->current == -1);
            		}
            		else {
...
bool FlxMouse_obj::get_justReleasedMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_643_get_justReleasedMiddle)
HXDLIN( 643)		return (this->_middleButton->current == -1);
            	}
...
int FlxMouse_obj::get_justPressedTimeInTicksMiddle(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_646_get_justPressedTimeInTicksMiddle)
HXDLIN( 646)		return this->_middleButton->justPressedTimeInTicks;
            	}
...
void FlxMouse_obj::showSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_650_showSystemCursor)
HXLINE( 654)		this->cursorContainer->set_visible(false);
...
void FlxMouse_obj::hideSystemCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_661_hideSystemCursor)
HXLINE( 668)		::openfl::ui::Mouse_obj::hide();
HXLINE( 670)		if (this->visible) {
HXLINE( 672)			this->cursorContainer->set_visible(true);
            		}
            	}
...
bool FlxMouse_obj::set_useSystemCursor(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_678_set_useSystemCursor)
HXLINE( 679)		if (value) {
HXLINE( 681)			this->showSystemCursor();
            		}
            		else {
HXLINE( 685)			this->hideSystemCursor();
            		}
HXLINE( 687)		return (this->useSystemCursor = value);
            	}
...
void FlxMouse_obj::showCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_692_showCursor)
HXDLIN( 692)		if (this->useSystemCursor) {
HXLINE( 694)			::openfl::ui::Mouse_obj::show();
            		}
            		else {
HXLINE( 698)			if (::hx::IsNull( this->cursor )) {
HXLINE( 699)				this->load(null(),null(),null(),null());
            			}
HXLINE( 704)			this->cursorContainer->set_visible(true);
...
void FlxMouse_obj::hideCursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_711_hideCursor)
HXLINE( 712)		this->cursorContainer->set_visible(false);
HXLINE( 713)		::openfl::ui::Mouse_obj::hide();
            	}
...
bool FlxMouse_obj::set_visible(bool value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_717_set_visible)
HXLINE( 718)		if (value) {
HXLINE( 719)			this->showCursor();
            		}
            		else {
HXLINE( 721)			this->hideCursor();
            		}
HXLINE( 723)		return (this->visible = value);
            	}
...
HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set_visible,return )
 ...
 ::flixel::_hx_system::replay::MouseRecord FlxMouse_obj::record(){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_728_record)
HXLINE( 729)		bool _hx_tmp;
HXDLIN( 729)		bool _hx_tmp1;
HXDLIN( 729)		bool _hx_tmp2;
HXDLIN( 729)		if ((this->_lastX == this->_globalScreenX)) {
HXLINE( 729)			_hx_tmp2 = (this->_lastY == this->_globalScreenY);
            		}
            		else {
HXLINE( 729)			_hx_tmp2 = false;
            		}
HXDLIN( 729)		if (_hx_tmp2) {
HXLINE( 729)			_hx_tmp1 = (this->_lastLeftButtonState == this->_leftButton->current);
            		}
            		else {
HXLINE( 729)			_hx_tmp1 = false;
            		}
HXDLIN( 729)		if (_hx_tmp1) {
HXLINE( 729)			_hx_tmp = (this->_lastWheel == this->wheel);
            		}
            		else {
...
HXLINE( 737)		this->_lastX = this->_globalScreenX;
HXLINE( 738)		this->_lastY = this->_globalScreenY;
HXLINE( 739)		this->_lastLeftButtonState = this->_leftButton->current;
HXLINE( 740)		this->_lastWheel = this->wheel;
HXLINE( 741)		return  ::flixel::_hx_system::replay::MouseRecord_obj::__alloc( HX_CTX ,this->_lastX,this->_lastY,this->_leftButton->current,this->_lastWheel);
            	}
...
void FlxMouse_obj::playback( ::flixel::_hx_system::replay::MouseRecord record){
            	HX_GC_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_746_playback)
HXLINE( 750)		bool _hx_tmp;
HXDLIN( 750)		bool _hx_tmp1;
HXDLIN( 750)		if ((this->_lastLeftButtonState != 1)) {
HXLINE( 750)			_hx_tmp1 = (this->_lastLeftButtonState == 2);
            		}
            		else {
HXLINE( 750)			_hx_tmp1 = true;
            		}
HXDLIN( 750)		if (_hx_tmp1) {
HXLINE( 751)			if ((record->button != 0)) {
HXLINE( 750)				_hx_tmp = (record->button == -1);
            			}
            			else {
...
HXLINE( 753)			 ::openfl::display::Stage _hx_tmp2 = this->_stage;
HXDLIN( 753)			_hx_tmp2->dispatchEvent( ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,HX_("mouseUp",e0,f3,72,c0),true,false,record->x,record->y,null(),null(),null(),null(),null(),null(),null(),null(),null()));
            		}
HXLINE( 755)		this->_lastLeftButtonState = (this->_leftButton->current = record->button);
HXLINE( 756)		this->wheel = record->wheel;
HXLINE( 757)		this->_globalScreenX = record->x;
HXLINE( 758)		this->_globalScreenY = record->y;
HXLINE( 759)		this->updatePositions();
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,playback,(void))

 ::openfl::display::Bitmap FlxMouse_obj::get__cursor(){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_764_get__cursor)
HXDLIN( 764)		return this->cursor;
            	}


HX_DEFINE_DYNAMIC_FUNC0(FlxMouse_obj,get__cursor,return )

 ::openfl::display::Bitmap FlxMouse_obj::set__cursor( ::openfl::display::Bitmap value){
            	HX_STACKFRAME(&_hx_pos_dcc29ee8d0f87524_769_set__cursor)
HXDLIN( 769)		return (this->cursor = value);
            	}


HX_DEFINE_DYNAMIC_FUNC1(FlxMouse_obj,set__cursor,return )
...
::hx::Val FlxMouse_obj::__Field(const ::String &inName,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_cursor") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( get__cursor() ); }
	...
	case 11:
		...
		if (HX_FIELD_EQ(inName,"get__cursor") ) { return ::hx::Val( get__cursor_dyn() ); }
		if (HX_FIELD_EQ(inName,"set__cursor") ) { return ::hx::Val( set__cursor_dyn() ); }
		break;
	case 12:
...
::hx::Val FlxMouse_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 7:
		...
		if (HX_FIELD_EQ(inName,"_cursor") ) { if (inCallProp == ::hx::paccAlways) return ::hx::Val( set__cursor(inValue.Cast<  ::openfl::display::Bitmap >()) ); }
		break;
	case 10:
...
static ::String FlxMouse_obj_sMemberFields[] = {
	...
	HX_("get__cursor",8c,00,5a,33),
	HX_("set__cursor",98,07,c7,3d),
	::String(null()) };
