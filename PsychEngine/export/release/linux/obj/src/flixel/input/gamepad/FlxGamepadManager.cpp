...
HXLINE( 410)						_hx_tmp2 = (name.indexOf(HX_("360",2d,e2,26,00),null()) != -1);
            					}
            					else {
HXLINE( 410)						_hx_tmp2 = false;
            					}
HXDLIN( 410)					if (!(_hx_tmp2)) {
HXLINE( 410)						_hx_tmp1 = (name.indexOf(HX_("xinput",92,10,f1,b8),null()) != -1);
            					}
            					else {
...
HXLINE( 418)										_hx_tmp3 = (name.indexOf(HX_("joycon l+r",e1,d0,50,00),null()) != -1);
            									}
            									else {
