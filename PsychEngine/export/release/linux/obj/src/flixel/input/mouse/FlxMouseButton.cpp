...
HXLINE(  37)			{
HXLINE(  37)				 ::flixel::math::FlxBasePoint this1 = this->justPressedPosition;
HXDLIN(  37)				Float y = ( (Float)(::flixel::FlxG_obj::mouse->screenY) );
HXDLIN(  37)				this1->set_x(( (Float)(::flixel::FlxG_obj::mouse->screenX) ));
...
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp2 = this->justPressedPosition;
HXDLIN(  43)				 ::flixel::math::FlxBasePoint _hx_tmp3 = ::flixel::FlxG_obj::mouse->getScreenPosition(null(),null());
...
HXDLIN(  50)		this->justPressedPosition = ( ( ::flixel::math::FlxBasePoint)(::flixel::util::FlxDestroyUtil_obj::put(this->justPressedPosition)) );
            	}
...
static ::hx::StorageInfo FlxMouseButton_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(FlxMouseButton_obj,justPressedPosition),HX_("justPressedPosition",9f,30,76,ae)},
