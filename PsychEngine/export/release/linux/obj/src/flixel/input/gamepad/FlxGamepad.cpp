...
HXLINE( 255)				 ::flixel::input::gamepad::FlxGamepadButton button1 = _g3->__get(_g2).StaticCast<  ::flixel::input::gamepad::FlxGamepadButton >();
HXDLIN( 255)				_g2 = (_g2 + 1);
HXLINE( 257)				if (::hx::IsNotNull( button1 )) {
HXLINE( 259)					button1->update();
            				}
            			}
            		}
            	}
...
HXLINE( 590)				_hx_tmp1 = (AxisIndex == rightStick->y);
            			}
            			else {
...
HXLINE( 784)			bool stick3;
HXDLIN( 784)			bool stick4;
HXDLIN( 784)			if (::hx::IsNotNull( rightStick )) {
HXLINE( 784)				stick4 = (axis == rightStick->x);
            			}
            			else {
HXLINE( 784)				stick4 = false;
            			}
HXDLIN( 784)			if (!(stick4)) {
HXLINE( 784)				stick3 = (axis == rightStick->y);
            			}
            			else {
HXLINE( 784)				stick3 = true;
            			}
HXDLIN( 784)			if (stick3) {
...
HXDLIN( 784)		 ::flixel::input::gamepad::FlxGamepadAnalogStick stick5 = stick;
HXLINE( 785)		bool _hx_tmp;
HXDLIN( 785)		if (::hx::IsPointerNotEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() )) {
HXLINE( 785)			_hx_tmp = ::hx::IsPointerEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::BOTH_dyn() );
            		}
            		else {
HXLINE( 785)			_hx_tmp = true;
            		}
HXDLIN( 785)		if (_hx_tmp) {
HXLINE( 787)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)1.0));
HXLINE( 788)			this->handleAxisMoveSub(stick5,axis,newValue,oldValue,((Float)-1.0));
HXLINE( 790)			bool _hx_tmp1 = ::hx::IsPointerEq( stick5->mode,::flixel::input::gamepad::FlxAnalogToDigitalMode_obj::ONLY_DIGITAL_dyn() );
            		}
            	}
...
HXLINE( 820)				_hx_tmp1 = (oldValueSign > threshold);
            			}
            			else {
HXLINE( 820)				_hx_tmp1 = false;
            			}
HXDLIN( 820)			if (_hx_tmp1) {
HXLINE( 822)				 ::flixel::input::gamepad::FlxGamepadButton btn1 = this->getButton(digitalButton);
HXLINE( 823)				if (::hx::IsNotNull( btn1 )) {
HXLINE( 824)					btn1->release();
            				}
            			}
            		}
            	}
