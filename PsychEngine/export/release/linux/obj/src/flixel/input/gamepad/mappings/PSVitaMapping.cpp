...
HXLINE(  31)					int id1 = rawID;
HXDLIN(  31)					if ((id1 == this->leftStick->rawDown)) {
HXLINE(  31)						return 34;
            					}
            					else {
HXLINE(  32)						int id2 = rawID;
HXDLIN(  32)						if ((id2 == this->leftStick->rawLeft)) {
HXLINE(  32)							return 37;
            						}
            						else {
HXLINE(  33)							int id3 = rawID;
HXDLIN(  33)							if ((id3 == this->leftStick->rawRight)) {
HXLINE(  33)								return 35;
            							}
            							else {
HXLINE(  34)								int id4 = rawID;
HXDLIN(  34)								if ((id4 == this->rightStick->rawUp)) {
HXLINE(  34)									return 38;
            								}
            								else {
HXLINE(  35)									int id5 = rawID;
HXDLIN(  35)									if ((id5 == this->rightStick->rawDown)) {
HXLINE(  35)										return 40;
            									}
            									else {
HXLINE(  36)										int id6 = rawID;
HXDLIN(  36)										if ((id6 == this->rightStick->rawLeft)) {
HXLINE(  36)											return 41;
            										}
            										else {
HXLINE(  37)											int id7 = rawID;
HXDLIN(  37)											if ((id7 == this->rightStick->rawRight)) {
HXLINE(  37)												return 39;
            											}
            											else {
HXLINE(  38)												return -1;
