...
HXDLIN( 651)					::Array< ::Dynamic> _g3 = ::flixel::FlxG_obj::touches->list;
HXDLIN( 651)					while((_g2 < _g3->length)){
HXLINE( 651)						 ::flixel::input::touch::FlxTouch touch = _g3->__get(_g2).StaticCast<  ::flixel::input::touch::FlxTouch >();
HXDLIN( 651)						_g2 = (_g2 + 1);
HXLINE( 653)						this->_point = touch->getPositionInCameraView(camera,this->_point);
HXLINE( 654)						 ::flixel::math::FlxBasePoint point2 = this->_point;
HXDLIN( 654)						bool contained3;
HXDLIN( 654)						bool contained4;
HXDLIN( 654)						bool contained5;
HXDLIN( 654)						if (((point2->x + ( (Float)(0) )) > camera->viewMarginX)) {
HXLINE( 654)							contained5 = (point2->x < (( (Float)(camera->width) ) - camera->viewMarginX));
            						}
            						else {
HXLINE( 654)							contained5 = false;
            						}
HXDLIN( 654)						if (contained5) {
HXLINE( 654)							contained4 = ((point2->y + ( (Float)(0) )) > camera->viewMarginY);
            						}
            						else {
HXLINE( 654)							contained4 = false;
            						}
HXDLIN( 654)						if (contained4) {
HXLINE( 654)							contained3 = (point2->y < (( (Float)(camera->height) ) - camera->viewMarginY));
            						}
            						else {
HXLINE( 654)							contained3 = false;
            						}
HXDLIN( 654)						{
HXLINE( 654)							 ::flixel::math::FlxBasePoint _this1 = point2;
HXDLIN( 654)							if (_this1->_weak) {
HXLINE( 654)								_this1->put();
            							}
            						}
HXDLIN( 654)						if (contained3) {
HXLINE( 656)							this->_point = touch->getWorldPosition(camera,this->_point);
HXLINE( 658)							 ::flixel::math::FlxBasePoint point3 = this->_point;
HXDLIN( 658)							bool _hx_tmp2;
HXDLIN( 658)							bool _hx_tmp3;
HXDLIN( 658)							if (event->pixelPerfect) {
HXLINE( 658)								_hx_tmp3 = ::hx::IsNotNull( event->sprite );
            							}
            							else {
HXLINE( 658)								_hx_tmp3 = false;
            							}
HXDLIN( 658)							if (_hx_tmp3) {
HXLINE( 658)								_hx_tmp2 = event->sprite->pixelsOverlapPoint(point3,1,camera);
            							}
            							else {
HXLINE( 658)								_hx_tmp2 = event->object->overlapsPoint(point3,true,camera);
            							}
