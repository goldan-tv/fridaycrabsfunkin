...
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_656_toUnderscoreCase,"flixel.util.FlxStringUtil","toUnderscoreCase",0x66d9bbe8,"flixel.util.FlxStringUtil.toUnderscoreCase","flixel/util/FlxStringUtil.hx",656,0x4e012e33)
HX_LOCAL_STACK_FRAME(_hx_pos_85c2c6c527e56776_666_toTitleCase,"flixel.util.FlxStringUtil","toTitleCase",0xe7be584a,"flixel.util.FlxStringUtil.toTitleCase","flixel/util/FlxStringUtil.hx",666,0x4e012e33)
...
HXLINE( 471)					{
HXLINE( 471)						int _g2 = 0;
HXDLIN( 471)						int _g3 = bdH;
HXDLIN( 471)						while((_g2 < _g3)){
HXLINE( 471)							_g2 = (_g2 + 1);
HXDLIN( 471)							int j = (_g2 - 1);
HXLINE( 473)							pCol = bd->getPixel(i,j);
HXLINE( 475)							{
HXLINE( 475)								int _g4 = 0;
HXDLIN( 475)								int _g5 = Scale;
HXDLIN( 475)								while((_g4 < _g5)){
HXLINE( 475)									_g4 = (_g4 + 1);
HXDLIN( 475)									int k = (_g4 - 1);
HXLINE( 477)									{
HXLINE( 477)										int _g6 = 0;
HXDLIN( 477)										int _g7 = Scale;
HXDLIN( 477)										while((_g6 < _g7)){
HXLINE( 477)											_g6 = (_g6 + 1);
HXDLIN( 477)											int m = (_g6 - 1);
...
HXLINE( 493)			int _g8 = 0;
HXDLIN( 493)			int _g9 = ColorMap->length;
HXDLIN( 493)			while((_g8 < _g9)){
HXLINE( 493)				_g8 = (_g8 + 1);
HXDLIN( 493)				int i1 = (_g8 - 1);
HXLINE( 495)				ColorMap[i1] = (ColorMap->__get(i1) & 16777215);
            			}
            		}
...
::String FlxStringUtil_obj::toUnderscoreCase(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_85c2c6c527e56776_656_toUnderscoreCase)
HXLINE( 657)		 ::EReg regex =  ::EReg_obj::__alloc( HX_CTX ,HX_("[^a-z0-9]+",5f,51,30,53),HX_("g",67,00,00,00));
HXLINE( 658)		return regex->replace(str.toLowerCase(),HX_("_",5f,00,00,00));
            	}
...
::String FlxStringUtil_obj::toTitleCase(::String str){
            	HX_GC_STACKFRAME(&_hx_pos_85c2c6c527e56776_666_toTitleCase)
HXLINE( 667)		::Array< ::String > exempt = ::Array_obj< ::String >::fromData( _hx_array_data_03bd21cb_47,16);
HXLINE( 668)		 ::EReg roman =  ::EReg_obj::__alloc( HX_CTX ,HX_("^(?=[MDCLXVI])M*(C[MD]|D?C*)(X[CL]|L?X*)(I[XV]|V?I*)$",19,35,5b,b5),HX_("i",69,00,00,00));
HXLINE( 669)		::Array< ::String > words = str.toLowerCase().split(HX_(" ",20,00,00,00));
HXLINE( 671)		{
HXLINE( 671)			int _g = 0;
HXDLIN( 671)			int _g1 = words->length;
HXDLIN( 671)			while((_g < _g1)){
HXLINE( 671)				_g = (_g + 1);
HXDLIN( 671)				int i = (_g - 1);
HXLINE( 673)				if (roman->match(words->__get(i))) {
HXLINE( 674)					words[i] = words->__get(i).toUpperCase();
            				}
            				else {
HXLINE( 675)					bool _hx_tmp;
HXDLIN( 675)					if ((i != 0)) {
HXLINE( 675)						_hx_tmp = (exempt->indexOf(words->__get(i),null()) == -1);
            					}
            					else {
HXLINE( 675)						_hx_tmp = true;
            					}
HXDLIN( 675)					if (_hx_tmp) {
HXLINE( 676)						::String _hx_tmp1 = words->__get(i).charAt(0).toUpperCase();
HXDLIN( 676)						words[i] = (_hx_tmp1 + words->__get(i).substr(1,null()));
            					}
            				}
            			}
            		}
HXLINE( 679)		return words->join(HX_(" ",20,00,00,00));
            	}
