...
HX_LOCAL_STACK_FRAME(_hx_pos_36b7e3e8752e2119_18_uEquals,"flixel.util.FlxUnicodeUtil","uEquals",0xbd6ee58d,"flixel.util.FlxUnicodeUtil.uEquals","flixel/util/FlxUnicodeUtil.hx",18,0x26f9f857)
HX_LOCAL_STACK_FRAME(_hx_pos_36b7e3e8752e2119_23_uSub,"flixel.util.FlxUnicodeUtil","uSub",0xecba3572,"flixel.util.FlxUnicodeUtil.uSub","flixel/util/FlxUnicodeUtil.hx",23,0x26f9f857)
HX_LOCAL_STACK_FRAME(_hx_pos_36b7e3e8752e2119_28_uCharCodeAt,"flixel.util.FlxUnicodeUtil","uCharCodeAt",0xeed99d44,"flixel.util.FlxUnicodeUtil.uCharCodeAt","flixel/util/FlxUnicodeUtil.hx",28,0x26f9f857)
namespace flixel{
namespace util{
...
bool FlxUnicodeUtil_obj::uEquals(::String a,::String b){
            	HX_STACKFRAME(&_hx_pos_36b7e3e8752e2119_18_uEquals)
HXDLIN(  18)		return (a == b);
            	}
...
::String FlxUnicodeUtil_obj::uSub(::String s,int pos,int len){
            	HX_STACKFRAME(&_hx_pos_36b7e3e8752e2119_23_uSub)
HXDLIN(  23)		return ::_UnicodeString::UnicodeString_Impl__obj::substr(s,pos,len);
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(FlxUnicodeUtil_obj,uSub,return )
 ...
 ::Dynamic FlxUnicodeUtil_obj::uCharCodeAt(::String s,int index){
            	HX_STACKFRAME(&_hx_pos_36b7e3e8752e2119_28_uCharCodeAt)
HXDLIN(  28)		return ::_UnicodeString::UnicodeString_Impl__obj::charCodeAt(s,index);
            	}
