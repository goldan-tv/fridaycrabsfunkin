...
HXLINE( 186)				_hx_tmp2 = this->active;
            			}
            			else {
HXLINE( 186)				_hx_tmp2 = false;
            			}
HXDLIN( 186)			if (_hx_tmp2) {
HXLINE( 186)				_hx_tmp1 = !(this->finished);
            			}
            			else {
...
HXLINE( 188)			 ::flixel::util::FlxTimer _hx_tmp3 = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN( 188)			_hx_tmp3->_timeCounter = (_hx_tmp3->_timeCounter - this->time);
HXLINE( 189)			this->_loopsCounter++;
HXLINE( 191)			bool _hx_tmp4;
HXDLIN( 191)			if ((this->loops > 0)) {
HXLINE( 191)				_hx_tmp4 = (this->_loopsCounter >= this->loops);
            			}
            			else {
