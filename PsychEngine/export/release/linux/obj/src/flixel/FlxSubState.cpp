...
HX_DEFINE_STACK_FRAME(_hx_pos_4f421a3440b44d31_15_new,"flixel.FlxSubState","new",0xef991343,"flixel.FlxSubState.new","flixel/FlxSubState.hx",15,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_62_draw,"flixel.FlxSubState","draw",0xafc56fc1,"flixel.FlxSubState.draw","flixel/FlxSubState.hx",62,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_81_destroy,"flixel.FlxSubState","destroy",0xc08a1d5d,"flixel.FlxSubState.destroy","flixel/FlxSubState.hx",81,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_94_close,"flixel.FlxSubState","close",0x85a9195b,"flixel.FlxSubState.close","flixel/FlxSubState.hx",94,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_101_get_bgColor,"flixel.FlxSubState","get_bgColor",0x02e53f58,"flixel.FlxSubState.get_bgColor","flixel/FlxSubState.hx",101,0xd8a3e54e)
HX_LOCAL_STACK_FRAME(_hx_pos_4f421a3440b44d31_106_set_bgColor,"flixel.FlxSubState","set_bgColor",0x0d524664,"flixel.FlxSubState.set_bgColor","flixel/FlxSubState.hx",106,0xd8a3e54e)
namespace flixel{
...
HXLINE(  57)			this->_bgSprite =  ::flixel::_hx_system::FlxBGSprite_obj::__alloc( HX_CTX );
            		}
HXLINE(  58)		this->set_bgColor(BGColor);
            	}
...
void FlxSubState_obj::draw(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_62_draw)
HXLINE(  64)		if (::flixel::FlxG_obj::renderBlit) {
HXLINE(  66)			int _g = 0;
HXDLIN(  66)			::Array< ::Dynamic> _g1 = this->get_cameras();
HXDLIN(  66)			while((_g < _g1->length)){
HXLINE(  66)				 ::flixel::FlxCamera camera = _g1->__get(_g).StaticCast<  ::flixel::FlxCamera >();
HXDLIN(  66)				_g = (_g + 1);
HXLINE(  68)				camera->fill(this->_bgColor,null(),null(),null());
            			}
            		}
            		else {
HXLINE(  73)			this->_bgSprite->draw();
            		}
...
void FlxSubState_obj::destroy(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_81_destroy)
HXLINE(  82)		this->super::destroy();
HXLINE(  83)		this->closeCallback = null();
HXLINE(  84)		this->openCallback = null();
HXLINE(  85)		this->_parentState = null();
HXLINE(  86)		this->_bgSprite = ( ( ::flixel::_hx_system::FlxBGSprite)(::flixel::util::FlxDestroyUtil_obj::destroy(this->_bgSprite)) );
            	}


void FlxSubState_obj::close(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_94_close)
HXDLIN(  94)		bool _hx_tmp;
HXDLIN(  94)		if (::hx::IsNotNull( this->_parentState )) {
HXDLIN(  94)			_hx_tmp = ::hx::IsInstanceEq( this->_parentState->subState,::hx::ObjectPtr<OBJ_>(this) );
            		}
            		else {
HXDLIN(  94)			_hx_tmp = false;
            		}
HXDLIN(  94)		if (_hx_tmp) {
HXLINE(  95)			this->_parentState->closeSubState();
            		}
            	}
...
int FlxSubState_obj::get_bgColor(){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_101_get_bgColor)
HXDLIN( 101)		return this->_bgColor;
            	}


int FlxSubState_obj::set_bgColor(int Value){
            	HX_STACKFRAME(&_hx_pos_4f421a3440b44d31_106_set_bgColor)
HXLINE( 107)		bool _hx_tmp;
HXDLIN( 107)		if (::flixel::FlxG_obj::renderTile) {
HXLINE( 107)			_hx_tmp = ::hx::IsNotNull( this->_bgSprite );
            		}
            		else {
HXLINE( 107)			_hx_tmp = false;
            		}
HXDLIN( 107)		if (_hx_tmp) {
HXLINE( 108)			this->_bgSprite->get_pixels()->setPixel32(0,0,Value);
            		}
HXLINE( 110)		return (this->_bgColor = Value);
            	}
