...
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_103_addFunction,"flixel.system.frontEnds.WatchFrontEnd","addFunction",0xff88c312,"flixel.system.frontEnds.WatchFrontEnd.addFunction","flixel/system/frontEnds/WatchFrontEnd.hx",103,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_110_removeFunction,"flixel.system.frontEnds.WatchFrontEnd","removeFunction",0x9c838063,"flixel.system.frontEnds.WatchFrontEnd.removeFunction","flixel/system/frontEnds/WatchFrontEnd.hx",110,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_121_addMouse,"flixel.system.frontEnds.WatchFrontEnd","addMouse",0x3add9deb,"flixel.system.frontEnds.WatchFrontEnd.addMouse","flixel/system/frontEnds/WatchFrontEnd.hx",121,0xd7ade198)
HX_LOCAL_STACK_FRAME(_hx_pos_25766fbc3da200fe_131_removeMouse,"flixel.system.frontEnds.WatchFrontEnd","removeMouse",0xc472d3fa,"flixel.system.frontEnds.WatchFrontEnd.removeMouse","flixel/system/frontEnds/WatchFrontEnd.hx",131,0xd7ade198)
namespace flixel{
...
void WatchFrontEnd_obj::addFunction(::String displayName, ::Dynamic func){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_103_addFunction)
            	}
...
void WatchFrontEnd_obj::removeFunction(::String displayName){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_110_removeFunction)
            	}
...
void WatchFrontEnd_obj::addMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_121_addMouse)
            	}
...
void WatchFrontEnd_obj::removeMouse(){
            	HX_STACKFRAME(&_hx_pos_25766fbc3da200fe_131_removeMouse)
            	}
