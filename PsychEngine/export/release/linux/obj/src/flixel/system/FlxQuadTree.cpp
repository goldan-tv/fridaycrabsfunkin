...
HXLINE( 429)							_hx_tmp1 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != 0);
            						}
            						else {
...
HXLINE( 433)							Float _hx_tmp2 = ::flixel::_hx_system::FlxQuadTree_obj::_object->x;
HXDLIN( 433)							::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge = (_hx_tmp2 + ::flixel::_hx_system::FlxQuadTree_obj::_object->get_width());
HXLINE( 434)							Float _hx_tmp3 = ::flixel::_hx_system::FlxQuadTree_obj::_object->y;
HXDLIN( 434)							::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge = (_hx_tmp3 + ::flixel::_hx_system::FlxQuadTree_obj::_object->get_height());
...
HXLINE( 444)				_hx_tmp4 = (::flixel::_hx_system::FlxQuadTree_obj::_object->allowCollisions != 0);
            			}
            			else {
...
HXLINE( 448)				Float _hx_tmp5 = ::flixel::_hx_system::FlxQuadTree_obj::_object->x;
HXDLIN( 448)				::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge = (_hx_tmp5 + ::flixel::_hx_system::FlxQuadTree_obj::_object->get_width());
HXLINE( 449)				Float _hx_tmp6 = ::flixel::_hx_system::FlxQuadTree_obj::_object->y;
HXDLIN( 449)				::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge = (_hx_tmp6 + ::flixel::_hx_system::FlxQuadTree_obj::_object->get_height());
...
HXLINE( 470)		bool _hx_tmp3;
HXDLIN( 470)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge > this->_leftEdge)) {
HXLINE( 470)			_hx_tmp3 = (::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge < this->_midpointX);
            		}
            		else {
HXLINE( 470)			_hx_tmp3 = false;
            		}
...
HXLINE( 472)				_hx_tmp4 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_midpointY);
            			}
            			else {
...
HXLINE( 481)			bool _hx_tmp5;
HXDLIN( 481)			if ((::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge > this->_midpointY)) {
HXLINE( 481)				_hx_tmp5 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_bottomEdge);
            			}
            			else {
...
HXLINE( 491)			_hx_tmp6 = (::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge < this->_rightEdge);
            		}
            		else {
...
HXLINE( 493)				_hx_tmp7 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_midpointY);
            			}
            			else {
...
HXLINE( 502)				_hx_tmp8 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge < this->_bottomEdge);
            			}
            			else {
...
HXDLIN( 514)		bool _hx_tmp11;
HXDLIN( 514)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_leftEdge)) {
HXLINE( 514)			_hx_tmp11 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_midpointX);
            		}
            		else {
HXLINE( 514)			_hx_tmp11 = false;
            		}
HXDLIN( 514)		if (_hx_tmp11) {
HXLINE( 514)			_hx_tmp10 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_topEdge);
            		}
            		else {
HXLINE( 514)			_hx_tmp10 = false;
            		}
HXDLIN( 514)		if (_hx_tmp10) {
HXLINE( 514)			_hx_tmp9 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_midpointY);
            		}
            		else {
...
HXLINE( 522)		bool _hx_tmp12;
HXDLIN( 522)		bool _hx_tmp13;
HXDLIN( 522)		bool _hx_tmp14;
HXDLIN( 522)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_midpointX)) {
HXLINE( 522)			_hx_tmp14 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_rightEdge);
            		}
            		else {
HXLINE( 522)			_hx_tmp14 = false;
            		}
HXDLIN( 522)		if (_hx_tmp14) {
HXLINE( 522)			_hx_tmp13 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_topEdge);
            		}
            		else {
HXLINE( 522)			_hx_tmp13 = false;
            		}
HXDLIN( 522)		if (_hx_tmp13) {
HXLINE( 522)			_hx_tmp12 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_midpointY);
            		}
            		else {
HXLINE( 522)			_hx_tmp12 = false;
            		}
...
HXLINE( 530)		bool _hx_tmp15;
HXDLIN( 530)		bool _hx_tmp16;
HXDLIN( 530)		bool _hx_tmp17;
HXDLIN( 530)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_midpointX)) {
HXLINE( 530)			_hx_tmp17 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_rightEdge);
            		}
            		else {
HXLINE( 530)			_hx_tmp17 = false;
            		}
HXDLIN( 530)		if (_hx_tmp17) {
HXLINE( 530)			_hx_tmp16 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_midpointY);
            		}
            		else {
HXLINE( 530)			_hx_tmp16 = false;
            		}
HXDLIN( 530)		if (_hx_tmp16) {
HXLINE( 530)			_hx_tmp15 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_bottomEdge);
            		}
            		else {
HXLINE( 530)			_hx_tmp15 = false;
            		}
...
HXLINE( 538)		bool _hx_tmp18;
HXDLIN( 538)		bool _hx_tmp19;
HXDLIN( 538)		bool _hx_tmp20;
HXDLIN( 538)		if ((::flixel::_hx_system::FlxQuadTree_obj::_objectRightEdge > this->_leftEdge)) {
HXLINE( 538)			_hx_tmp20 = (::flixel::_hx_system::FlxQuadTree_obj::_objectLeftEdge < this->_midpointX);
            		}
            		else {
HXLINE( 538)			_hx_tmp20 = false;
            		}
HXDLIN( 538)		if (_hx_tmp20) {
HXLINE( 538)			_hx_tmp19 = (::flixel::_hx_system::FlxQuadTree_obj::_objectBottomEdge > this->_midpointY);
            		}
            		else {
HXLINE( 538)			_hx_tmp19 = false;
            		}
HXDLIN( 538)		if (_hx_tmp19) {
HXLINE( 538)			_hx_tmp18 = (::flixel::_hx_system::FlxQuadTree_obj::_objectTopEdge < this->_bottomEdge);
            		}
            		else {
HXLINE( 538)			_hx_tmp18 = false;
            		}
HXDLIN( 538)		if (_hx_tmp18) {
...
HXLINE( 628)		bool _hx_tmp5;
HXDLIN( 628)		if (::hx::IsNotNull( this->_northWestTree )) {
HXLINE( 628)			_hx_tmp5 = this->_northWestTree->execute();
            		}
            		else {
HXLINE( 628)			_hx_tmp5 = false;
            		}
HXDLIN( 628)		if (_hx_tmp5) {
HXLINE( 630)			overlapProcessed = true;
            		}
HXLINE( 632)		bool _hx_tmp6;
HXDLIN( 632)		if (::hx::IsNotNull( this->_northEastTree )) {
HXLINE( 632)			_hx_tmp6 = this->_northEastTree->execute();
            		}
            		else {
...
HXLINE( 636)		bool _hx_tmp7;
HXDLIN( 636)		if (::hx::IsNotNull( this->_southEastTree )) {
HXLINE( 636)			_hx_tmp7 = this->_southEastTree->execute();
            		}
            		else {
HXLINE( 636)			_hx_tmp7 = false;
            		}
HXDLIN( 636)		if (_hx_tmp7) {
HXLINE( 638)			overlapProcessed = true;
            		}
HXLINE( 640)		bool _hx_tmp8;
HXDLIN( 640)		if (::hx::IsNotNull( this->_southWestTree )) {
HXLINE( 640)			_hx_tmp8 = this->_southWestTree->execute();
            		}
            		else {
...
HXLINE( 669)			bool _hx_tmp6;
HXDLIN( 669)			bool _hx_tmp7;
HXDLIN( 669)			if (::hx::IsInstanceNotEq( ::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject )) {
HXLINE( 669)				_hx_tmp7 = !(checkObject->exists);
            			}
            			else {
HXLINE( 669)				_hx_tmp7 = true;
            			}
HXDLIN( 669)			if (!(_hx_tmp7)) {
HXLINE( 669)				_hx_tmp6 = (checkObject->allowCollisions <= 0);
            			}
            			else {
HXLINE( 669)				_hx_tmp6 = true;
            			}
HXDLIN( 669)			if (_hx_tmp6) {
HXLINE( 671)				::flixel::_hx_system::FlxQuadTree_obj::_iterator = ::flixel::_hx_system::FlxQuadTree_obj::_iterator->next;
HXLINE( 672)				continue;
            			}
HXLINE( 676)			Float _hx_tmp8;
HXDLIN( 676)			if ((checkObject->x < checkObject->last->x)) {
HXLINE( 676)				_hx_tmp8 = checkObject->x;
            			}
            			else {
HXLINE( 676)				_hx_tmp8 = checkObject->last->x;
            			}
HXDLIN( 676)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullX = _hx_tmp8;
HXLINE( 677)			Float _hx_tmp9;
HXDLIN( 677)			if ((checkObject->y < checkObject->last->y)) {
HXLINE( 677)				_hx_tmp9 = checkObject->y;
            			}
            			else {
HXLINE( 677)				_hx_tmp9 = checkObject->last->y;
            			}
HXDLIN( 677)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY = _hx_tmp9;
HXLINE( 678)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth = (checkObject->x - checkObject->last->x);
HXLINE( 679)			Float _hx_tmp10 = checkObject->get_width();
HXDLIN( 679)			Float _hx_tmp11;
HXDLIN( 679)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth > 0)) {
HXLINE( 679)				_hx_tmp11 = ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth;
            			}
            			else {
HXLINE( 679)				_hx_tmp11 = -(::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth);
            			}
HXDLIN( 679)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth = (_hx_tmp10 + _hx_tmp11);
HXLINE( 680)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight = (checkObject->y - checkObject->last->y);
HXLINE( 681)			Float _hx_tmp12 = checkObject->get_height();
HXDLIN( 681)			Float _hx_tmp13;
HXDLIN( 681)			if ((::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight > 0)) {
HXLINE( 681)				_hx_tmp13 = ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight;
            			}
            			else {
HXLINE( 681)				_hx_tmp13 = -(::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight);
            			}
HXDLIN( 681)			::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight = (_hx_tmp12 + _hx_tmp13);
HXLINE( 684)			bool _hx_tmp14;
HXDLIN( 684)			bool _hx_tmp15;
...
HXLINE( 684)				_hx_tmp16 = (::flixel::_hx_system::FlxQuadTree_obj::_objectHullX < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullX + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullWidth));
            			}
            			else {
HXLINE( 684)				_hx_tmp16 = false;
            			}
HXDLIN( 684)			if (_hx_tmp16) {
HXLINE( 684)				_hx_tmp15 = ((::flixel::_hx_system::FlxQuadTree_obj::_objectHullY + ::flixel::_hx_system::FlxQuadTree_obj::_objectHullHeight) > ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY);
            			}
            			else {
HXLINE( 684)				_hx_tmp15 = false;
            			}
HXDLIN( 684)			if (_hx_tmp15) {
HXLINE( 684)				_hx_tmp14 = (::flixel::_hx_system::FlxQuadTree_obj::_objectHullY < (::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullY + ::flixel::_hx_system::FlxQuadTree_obj::_checkObjectHullHeight));
            			}
            			else {
HXLINE( 684)				_hx_tmp14 = false;
            			}
HXDLIN( 684)			if (_hx_tmp14) {
HXLINE( 690)				bool _hx_tmp17;
HXDLIN( 690)				if (::hx::IsNotNull( ::flixel::_hx_system::FlxQuadTree_obj::_processingCallback )) {
HXLINE( 690)					_hx_tmp17 = ( (bool)(::flixel::_hx_system::FlxQuadTree_obj::_processingCallback(::flixel::_hx_system::FlxQuadTree_obj::_object,checkObject)) );
            				}
            				else {
HXLINE( 690)					_hx_tmp17 = true;
            				}
HXDLIN( 690)				if (_hx_tmp17) {
