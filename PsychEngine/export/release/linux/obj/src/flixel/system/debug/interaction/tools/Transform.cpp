...
HXLINE(  68)		this->_mouseCursor =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
...
HXLINE(  63)		this->_actionScaleDirection =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXLINE(  60)		this->_actionStartPoint =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
HXLINE(  58)		this->_actionTargetStartScale =  ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) ));
...
HXDLIN(  87)			_hx_tmp->push( ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp1 = this->_markers;
HXDLIN(  87)			_hx_tmp1->push( ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp2 = this->_markers;
HXDLIN(  87)			_hx_tmp2->push( ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
HXDLIN(  87)			::Array< ::Dynamic> _hx_tmp3 = this->_markers;
HXDLIN(  87)			_hx_tmp3->push( ::flixel::math::FlxBasePoint_obj::__alloc( HX_CTX ,( (Float)(0) ),( (Float)(0) )));
            		}
...
HXLINE( 104)			{
HXLINE( 104)				 ::flixel::math::FlxRect _this2 = this->_targetArea;
HXDLIN( 104)				_this2->x = (this->_target->x - ::flixel::FlxG_obj::camera->scroll->x);
HXDLIN( 104)				_this2->y = (this->_target->y - ::flixel::FlxG_obj::camera->scroll->y);
            			}
HXLINE( 105)			{
HXLINE( 105)				 ::flixel::math::FlxRect _this3 = this->_targetArea;
HXDLIN( 105)				Float Width = this->_target->get_width();
HXDLIN( 105)				Float Height = this->_target->get_height();
HXDLIN( 105)				_this3->width = Width;
HXDLIN( 105)				_this3->height = Height;
            			}
            		}
            	}
...
HXLINE( 120)		{
HXLINE( 120)			 ::flixel::math::FlxBasePoint this1 = this->_actionStartPoint;
HXDLIN( 120)			Float y = (this->_brain->flixelPointer->y - ::flixel::FlxG_obj::camera->scroll->y);
HXDLIN( 120)			this1->set_x((this->_brain->flixelPointer->x - ::flixel::FlxG_obj::camera->scroll->x));
HXDLIN( 120)			this1->set_y(y);
            		}
HXLINE( 121)		this->_actionTargetStartAngle = ::flixel::math::FlxAngle_obj::angleBetweenPoint(this->_target,this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >(),true);
HXLINE( 122)		{
HXLINE( 122)			 ::flixel::math::FlxBasePoint this2 = this->_actionTargetStartScale;
HXDLIN( 122)			Float y1 = this->_target->scale->y;
HXDLIN( 122)			this2->set_x(this->_target->scale->x);
HXDLIN( 122)			this2->set_y(y1);
            		}
            	}
...
HXLINE( 158)				if ((::flixel::math::_FlxPoint::FlxPoint_Impl__obj::distanceTo(this->_mouseCursor,this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()) <= ((Float)5.0))) {
...
HXDLIN( 215)			{
HXLINE( 215)				 ::flixel::math::FlxBasePoint this1 = _this->origin;
HXDLIN( 215)				Float y = (( (Float)(_this->frameHeight) ) * ((Float)0.5));
HXDLIN( 215)				this1->set_x((( (Float)(_this->frameWidth) ) * ((Float)0.5)));
HXDLIN( 215)				this1->set_y(y);
            			}
            		}
...
HXLINE( 244)		{
HXLINE( 244)			 ::flixel::math::FlxBasePoint this1 = this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 244)			this1->set_x(topLeftX);
HXDLIN( 244)			this1->set_y(topLeftY);
            		}
HXLINE( 245)		{
HXLINE( 245)			 ::flixel::math::FlxBasePoint this2 = this->_markers->__get(1).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 245)			this2->set_x((topLeftX + width));
HXDLIN( 245)			this2->set_y(topLeftY);
            		}
HXLINE( 246)		{
HXLINE( 246)			 ::flixel::math::FlxBasePoint this3 = this->_markers->__get(2).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 246)			this3->set_x((topLeftX + width));
HXDLIN( 246)			this3->set_y((topLeftY + height));
            		}
HXLINE( 247)		{
HXLINE( 247)			 ::flixel::math::FlxBasePoint this4 = this->_markers->__get(3).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 247)			this4->set_x(topLeftX);
HXDLIN( 247)			this4->set_y((topLeftY + height));
            		}
...
HXLINE( 256)		Float originX = (this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x + (outlineWidth / ( (Float)(2) )));
HXLINE( 257)		Float originY = (this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y + (outlineHeight / ( (Float)(2) )));
...
HXLINE( 261)				 ::flixel::math::FlxBasePoint marker = _g1->__get(_g).StaticCast<  ::flixel::math::FlxBasePoint >();
HXDLIN( 261)				_g = (_g + 1);
...
HXLINE( 266)				{
HXLINE( 266)					marker->set_x((rotatedX + originX));
HXDLIN( 266)					marker->set_y((rotatedY + originY));
            				}
            			}
            		}
            	}
...
HXLINE( 295)		gfx->moveTo(this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x,this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
HXLINE( 296)		{
HXLINE( 296)			int _g = 0;
...
HXLINE( 297)				gfx->lineTo(this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x,this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
            			}
            		}
HXLINE( 299)		gfx->lineTo(this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->x,this->_markers->__get(0).StaticCast<  ::flixel::math::FlxBasePoint >()->y);
            	}
...
HXLINE( 307)				if ((i == 0)) {
HXLINE( 309)					gfx->drawCircle(this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x,this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y,((Float)2.7));
            				}
            				else {
HXLINE( 312)					gfx->drawRect((this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->x - ((Float)1.5)),(this->_markers->__get(i).StaticCast<  ::flixel::math::FlxBasePoint >()->y - ((Float)1.5)),((Float)3.0),((Float)3.0));
            				}
            			}
            		}
...
::hx::Val Transform_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	...
	case 11:
		...
		break;
	case 12:
		if (HX_FIELD_EQ(inName,"_mouseCursor") ) { _mouseCursor=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
		break;
	case 13:
	...
	case 16:
		...
		break;
	case 17:
		if (HX_FIELD_EQ(inName,"_actionStartPoint") ) { _actionStartPoint=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
		break;
	case 21:
		if (HX_FIELD_EQ(inName,"_actionScaleDirection") ) { _actionScaleDirection=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
		break;
	case 23:
		if (HX_FIELD_EQ(inName,"_actionTargetStartScale") ) { _actionTargetStartScale=inValue.Cast<  ::flixel::math::FlxBasePoint >(); return inValue; }
...
static ::hx::StorageInfo Transform_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(Transform_obj,_actionTargetStartScale),HX_("_actionTargetStartScale",ee,30,88,d1)},
	{::hx::fsFloat,(int)offsetof(Transform_obj,_actionTargetStartAngle),HX_("_actionTargetStartAngle",37,a6,9b,7b)},
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(Transform_obj,_actionStartPoint),HX_("_actionStartPoint",43,ba,70,3c)},
	...
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(Transform_obj,_actionScaleDirection),HX_("_actionScaleDirection",8a,fe,8a,8a)},
	...
	{::hx::fsObject /*  ::flixel::math::FlxBasePoint */ ,(int)offsetof(Transform_obj,_mouseCursor),HX_("_mouseCursor",dc,70,7a,9a)},
	{ ::hx::fsUnknown, 0, null()}
};
