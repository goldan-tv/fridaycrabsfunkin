...
HX_DEFINE_STACK_FRAME(_hx_pos_32211c0ca20fb474_60_new,"flixel.system.VirtualInputData","new",0x4566b028,"flixel.system.VirtualInputData.new","lime/_internal/macros/AssetsMacro.hx",60,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_32211c0ca20fb474_146_boot,"flixel.system.VirtualInputData","boot",0x6c8c736a,"flixel.system.VirtualInputData.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)
namespace flixel{
...
void VirtualInputData_obj::__construct( ::Dynamic __o_length){
            	...
            	HX_STACKFRAME(&_hx_pos_32211c0ca20fb474_60_new)
HXLINE(  61)		super::__construct(null());
HXLINE(  63)		 ::haxe::io::Bytes bytes = ::haxe::Resource_obj::getBytes(HX_("__ASSET__:file_flixel_system_VirtualInputData",cf,a9,c1,46));
HXLINE(  64)		this->_hx___fromBytes(bytes);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_32211c0ca20fb474_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:file_flixel_system_VirtualInputData",cf,a9,c1,46);
            	}
}
