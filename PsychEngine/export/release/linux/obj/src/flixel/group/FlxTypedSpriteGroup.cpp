...
HXDLIN( 300)			{
HXLINE( 300)				 ::flixel::math::FlxBasePoint _this = p;
...
HXDLIN( 304)				 ::flixel::math::FlxRect _this1 = ::flixel::math::FlxRect_obj::_pool->get().StaticCast<  ::flixel::math::FlxRect >();
HXDLIN( 304)				_this1->x = X;
HXDLIN( 304)				_this1->y = Y;
HXDLIN( 304)				_this1->width = Width;
HXDLIN( 304)				_this1->height = Height;
HXDLIN( 304)				 ::flixel::math::FlxRect rect = _this1;
...
HXDLIN(1060)		{
HXDLIN(1060)			 ::flixel::math::FlxBasePoint _this = Offset;
HXDLIN(1060)			if (_this->_weak) {
HXDLIN(1060)				_this->put();
            			}
            		}
            	}
...
HXDLIN(1063)		{
HXDLIN(1063)			 ::flixel::math::FlxBasePoint _this = Origin;
HXDLIN(1063)			if (_this->_weak) {
HXDLIN(1063)				_this->put();
            			}
            		}
            	}
...
HXDLIN(1066)		{
HXDLIN(1066)			 ::flixel::math::FlxBasePoint _this = Scale;
HXDLIN(1066)			if (_this->_weak) {
HXDLIN(1066)				_this->put();
            			}
            		}
            	}
...
HXDLIN(1069)		{
HXDLIN(1069)			 ::flixel::math::FlxBasePoint _this = ScrollFactor;
HXDLIN(1069)			if (_this->_weak) {
HXDLIN(1069)				_this->put();
            			}
            		}
            	}
