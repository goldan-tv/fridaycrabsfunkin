...
HXDLIN( 138)		 ::flixel::util::LabelValuePair _this = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 138)		_this->label = HX_("active",c6,41,46,16);
HXDLIN( 138)		_this->value = value;
HXLINE( 139)		 ::Dynamic value1 = this->visible;
HXDLIN( 139)		 ::flixel::util::LabelValuePair _this1 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 139)		_this1->label = HX_("visible",72,78,24,a3);
HXDLIN( 139)		_this1->value = value1;
HXLINE( 140)		 ::Dynamic value2 = this->alive;
HXDLIN( 140)		 ::flixel::util::LabelValuePair _this2 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
HXDLIN( 140)		_this2->label = HX_("alive",cd,63,91,21);
HXDLIN( 140)		_this2->value = value2;
HXLINE( 141)		 ::Dynamic value3 = this->exists;
HXDLIN( 141)		 ::flixel::util::LabelValuePair _this3 = ::flixel::util::LabelValuePair_obj::_pool->get().StaticCast<  ::flixel::util::LabelValuePair >();
