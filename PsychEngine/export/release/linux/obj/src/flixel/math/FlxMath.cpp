...
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_436_distanceToTouch,"flixel.math.FlxMath","distanceToTouch",0xd2645107,"flixel.math.FlxMath.distanceToTouch","flixel/math/FlxMath.hx",436,0x837802f8)
HX_LOCAL_STACK_FRAME(_hx_pos_5d39d2fff62ba7b8_452_isDistanceToTouchWithin,"flixel.math.FlxMath","isDistanceToTouchWithin",0x33e8e188,"flixel.math.FlxMath.isDistanceToTouchWithin","flixel/math/FlxMath.hx",452,0x837802f8)
...
int FlxMath_obj::distanceToTouch( ::flixel::FlxSprite Sprite, ::flixel::input::touch::FlxTouch Touch){
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_436_distanceToTouch)
HXLINE( 437)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 438)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
HXLINE( 439)		return ::Std_obj::_hx_int(::Math_obj::sqrt(((dx * dx) + (dy * dy))));
            	}
...
bool FlxMath_obj::isDistanceToTouchWithin( ::flixel::FlxSprite Sprite, ::flixel::input::touch::FlxTouch Touch,Float Distance,::hx::Null< bool >  __o_IncludeEqual){
            		bool IncludeEqual = __o_IncludeEqual.Default(false);
            	HX_STACKFRAME(&_hx_pos_5d39d2fff62ba7b8_452_isDistanceToTouchWithin)
HXLINE( 453)		Float dx = ((Sprite->x + Sprite->origin->x) - ( (Float)(Touch->screenX) ));
HXLINE( 454)		Float dy = ((Sprite->y + Sprite->origin->y) - ( (Float)(Touch->screenY) ));
HXLINE( 456)		if (IncludeEqual) {
HXLINE( 457)			return (((dx * dx) + (dy * dy)) <= (Distance * Distance));
            		}
            		else {
HXLINE( 459)			return (((dx * dx) + (dy * dy)) < (Distance * Distance));
            		}
