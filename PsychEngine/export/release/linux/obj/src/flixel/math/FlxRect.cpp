...
HXLINE( 309)		{
HXLINE( 309)			 ::flixel::math::FlxBasePoint _this = Point1;
HXDLIN( 309)			if (_this->_weak) {
HXLINE( 309)				_this->put();
            			}
            		}
HXLINE( 310)		{
HXLINE( 310)			 ::flixel::math::FlxBasePoint _this1 = Point2;
HXDLIN( 310)			if (_this1->_weak) {
HXLINE( 310)				_this1->put();
            			}
            		}
...
HXLINE( 328)		{
HXLINE( 328)			 ::flixel::math::FlxBasePoint _this = Point;
HXDLIN( 328)			if (_this->_weak) {
HXLINE( 328)				_this->put();
            			}
            		}
...
HXLINE( 360)			{
HXLINE( 360)				 ::flixel::math::FlxBasePoint _this1 = origin;
HXDLIN( 360)				if (_this1->_weak) {
HXLINE( 360)					_this1->put();
            				}
            			}
...
HXLINE( 400)		{
HXLINE( 400)			 ::flixel::math::FlxBasePoint _this2 = origin;
HXDLIN( 400)			if (_this2->_weak) {
HXLINE( 400)				_this2->put();
            			}
            		}
...
HXDLIN( 432)			 ::flixel::math::FlxRect rect1 = _this;
HXDLIN( 432)			rect1->_inPool = false;
HXDLIN( 432)			result = rect1;
            		}
HXLINE( 434)		Float x0;
