...
HXLINE( 891)			{
HXLINE( 891)				 ::flixel::math::FlxBasePoint _this2 = position;
HXDLIN( 891)				if (_this2->_weak) {
HXLINE( 891)					_this2->put();
            				}
            			}
HXLINE( 893)			 ::flixel::math::FlxRect _this3 = this->_bounds;
HXDLIN( 893)			bool result;
HXDLIN( 893)			bool result1;
HXDLIN( 893)			bool result2;
HXDLIN( 893)			if (((bounds->x + bounds->width) > _this3->x)) {
HXLINE( 893)				result2 = (bounds->x < (_this3->x + _this3->width));
            			}
            			else {
HXLINE( 893)				result2 = false;
            			}
HXDLIN( 893)			if (result2) {
HXLINE( 893)				result1 = ((bounds->y + bounds->height) > _this3->y);
            			}
            			else {
HXLINE( 893)				result1 = false;
            			}
HXDLIN( 893)			if (result1) {
HXLINE( 893)				result = (bounds->y < (_this3->y + _this3->height));
            			}
            			else {
...
HXLINE( 931)			{
HXLINE( 931)				 ::flixel::math::FlxRect _this4 = this->_bounds;
HXDLIN( 931)				_this4->x = ( (Float)(0) );
HXDLIN( 931)				_this4->y = ( (Float)(0) );
HXDLIN( 931)				_this4->width = ( (Float)(this->width) );
HXDLIN( 931)				_this4->height = ( (Float)(this->height) );
            			}
...
HXDLIN(1204)				{
HXLINE(1204)					 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1204)					if (_this->_weak) {
HXLINE(1204)						_this->put();
            					}
            				}
            			}
HXLINE(1205)			{
...
HXDLIN(1277)			{
HXLINE(1277)				 ::flixel::math::FlxBasePoint _this1 = p;
HXDLIN(1277)				if (_this1->_weak) {
HXLINE(1277)					_this1->put();
            				}
            			}
            		}
            		else {
...
HXLINE(1530)		{
HXLINE(1530)			 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1530)			if (_this->_weak) {
HXLINE(1530)				_this->put();
            			}
            		}
            	}
...
HXLINE(1912)		{
HXLINE(1912)			 ::flixel::math::FlxBasePoint _this = point;
HXDLIN(1912)			if (_this->_weak) {
HXLINE(1912)				_this->put();
            			}
            		}
