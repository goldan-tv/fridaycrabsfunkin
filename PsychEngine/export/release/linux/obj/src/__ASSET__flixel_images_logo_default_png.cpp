...
HX_DEFINE_STACK_FRAME(_hx_pos_17702da0942c0225_292_new,"__ASSET__flixel_images_logo_default_png","new",0xe2ac399d,"__ASSET__flixel_images_logo_default_png.new","lime/_internal/macros/AssetsMacro.hx",292,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_17702da0942c0225_146_boot,"__ASSET__flixel_images_logo_default_png","boot",0x6c1f3055,"__ASSET__flixel_images_logo_default_png.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)
...
void __ASSET__flixel_images_logo_default_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_17702da0942c0225_292_new)
HXLINE( 293)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 295)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(HX_("__ASSET__:image___ASSET__flixel_images_logo_default_png",5d,c4,77,3f)),null());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_17702da0942c0225_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_logo_default_png",5d,c4,77,3f);
            	}
}
