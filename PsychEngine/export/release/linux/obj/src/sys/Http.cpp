...
HX_DEFINE_STACK_FRAME(_hx_pos_3a950627f01e45ad_50_new,"sys.Http","new",0xa5e0041b,"sys.Http.new","/usr/share/haxe/std/sys/Http.hx",50,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_62_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/usr/share/haxe/std/sys/Http.hx",62,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_58_request,"sys.Http","request",0xbb950c8a,"sys.Http.request","/usr/share/haxe/std/sys/Http.hx",58,0xa5ac03f9)
static const bool _hx_array_data_00b75aa9_3[] = {
	0,
};
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_92_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/usr/share/haxe/std/sys/Http.hx",92,0xa5ac03f9)
...
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_211_customRequest,"sys.Http","customRequest",0xecf59319,"sys.Http.customRequest","/usr/share/haxe/std/sys/Http.hx",211,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_274_writeBody,"sys.Http","writeBody",0xc731a11c,"sys.Http.writeBody","/usr/share/haxe/std/sys/Http.hx",274,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_299_readHttpResponse,"sys.Http","readHttpResponse",0xd67be204,"sys.Http.readHttpResponse","/usr/share/haxe/std/sys/Http.hx",299,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_461_readChunk,"sys.Http","readChunk",0x940c4532,"sys.Http.readChunk","/usr/share/haxe/std/sys/Http.hx",461,0xa5ac03f9)
HX_LOCAL_STACK_FRAME(_hx_pos_3a950627f01e45ad_48_boot,"sys.Http","boot",0x763c9417,"sys.Http.boot","/usr/share/haxe/std/sys/Http.hx",48,0xa5ac03f9)
namespace sys{

void Http_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_3a950627f01e45ad_50_new)
...
void Http_obj::request( ::Dynamic post){
            		...
            		void _hx_run(::String e){
            			HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_62_request)
...
HXLINE(  67)			_gthis->onError(e);
            	...
            	HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_58_request)
...
void Http_obj::customRequest(bool post, ::haxe::io::Output api, ::sys::net::Socket sock,::String method){
            	HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_92_customRequest)
...
HXDLIN( 211)				if (!(multipart)) {
            					...
            					bool _hx_run( ::Dynamic h){
            						HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_211_customRequest)
...
void Http_obj::writeBody( ::haxe::io::BytesOutput body, ::haxe::io::Input fileInput,int fileSize,::String boundary, ::sys::net::Socket sock){
            	HX_STACKFRAME(&_hx_pos_3a950627f01e45ad_274_writeBody)
...
void Http_obj::readHttpResponse( ::haxe::io::Output api, ::sys::net::Socket sock){
            	HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_299_readHttpResponse)
...
bool Http_obj::readChunk( ::EReg chunk_re, ::haxe::io::Output api, ::haxe::io::Bytes buf,int len){
            	HX_GC_STACKFRAME(&_hx_pos_3a950627f01e45ad_461_readChunk)
...
{
{
            	HX_STACKFRAME(&_hx_pos_3a950627f01e45ad_48_boot)
