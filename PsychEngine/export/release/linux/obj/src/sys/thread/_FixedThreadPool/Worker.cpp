...
HX_DEFINE_STACK_FRAME(_hx_pos_955244c4b36edaac_99_new,"sys.thread._FixedThreadPool.Worker","new",0x5ad56180,"sys.thread._FixedThreadPool.Worker.new","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",99,0x95d7b7cc)
HX_LOCAL_STACK_FRAME(_hx_pos_955244c4b36edaac_105_loop,"sys.thread._FixedThreadPool.Worker","loop",0x1e951144,"sys.thread._FixedThreadPool.Worker.loop","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",105,0x95d7b7cc)
namespace sys{
namespace thread{
namespace _FixedThreadPool{

void Worker_obj::__construct( ::sys::thread::Deque queue){
            	HX_STACKFRAME(&_hx_pos_955244c4b36edaac_99_new)
...
void Worker_obj::loop(){
            	HX_STACKFRAME(&_hx_pos_955244c4b36edaac_105_loop)
HXDLIN( 105)		try {
