...
HX_DEFINE_STACK_FRAME(_hx_pos_522fc25da62d22ac_278_new,"sys.thread._EventLoop.RegularEvent","new",0x9d3b475c,"sys.thread._EventLoop.RegularEvent.new","/usr/share/haxe/std/sys/thread/EventLoop.hx",278,0x36352808)
namespace sys{
namespace thread{
namespace _EventLoop{

void RegularEvent_obj::__construct( ::Dynamic run,Float nextRunTime,Float interval){
            	HX_STACKFRAME(&_hx_pos_522fc25da62d22ac_278_new)
