...
HX_DEFINE_STACK_FRAME(_hx_pos_3bf7fafa310bed20_30_new,"sys.thread.Mutex","new",0x0051f1ae,"sys.thread.Mutex.new","/usr/share/haxe/std/cpp/_std/sys/thread/Mutex.hx",30,0x718d4e5e)
HX_LOCAL_STACK_FRAME(_hx_pos_3bf7fafa310bed20_34_acquire,"sys.thread.Mutex","acquire",0xae482c24,"sys.thread.Mutex.acquire","/usr/share/haxe/std/cpp/_std/sys/thread/Mutex.hx",34,0x718d4e5e)
HX_LOCAL_STACK_FRAME(_hx_pos_3bf7fafa310bed20_42_release,"sys.thread.Mutex","release",0x52516615,"sys.thread.Mutex.release","/usr/share/haxe/std/cpp/_std/sys/thread/Mutex.hx",42,0x718d4e5e)
namespace sys{
namespace thread{

void Mutex_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_3bf7fafa310bed20_30_new)
...
void Mutex_obj::acquire(){
            	HX_STACKFRAME(&_hx_pos_3bf7fafa310bed20_34_acquire)
...
void Mutex_obj::release(){
            	HX_STACKFRAME(&_hx_pos_3bf7fafa310bed20_42_release)
