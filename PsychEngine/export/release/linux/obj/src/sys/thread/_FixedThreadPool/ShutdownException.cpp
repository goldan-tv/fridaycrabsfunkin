...
HX_DEFINE_STACK_FRAME(_hx_pos_10fa30c54811ae33_93_new,"sys.thread._FixedThreadPool.ShutdownException","new",0x9e4c333b,"sys.thread._FixedThreadPool.ShutdownException.new","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",93,0x95d7b7cc)
namespace sys{
namespace thread{
namespace _FixedThreadPool{

void ShutdownException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_10fa30c54811ae33_93_new)
HXDLIN(  93)		{
