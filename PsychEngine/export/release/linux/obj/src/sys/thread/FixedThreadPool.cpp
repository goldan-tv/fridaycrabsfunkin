...
HX_DEFINE_STACK_FRAME(_hx_pos_8593639eca603478_36_new,"sys.thread.FixedThreadPool","new",0xb5d48549,"sys.thread.FixedThreadPool.new","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",36,0x95d7b7cc)
HX_LOCAL_STACK_FRAME(_hx_pos_8593639eca603478_65_run,"sys.thread.FixedThreadPool","run",0xb5d79c34,"sys.thread.FixedThreadPool.run","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",65,0x95d7b7cc)
HX_LOCAL_STACK_FRAME(_hx_pos_8593639eca603478_80_shutdown,"sys.thread.FixedThreadPool","shutdown",0x2ba5db0d,"sys.thread.FixedThreadPool.shutdown","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",80,0x95d7b7cc)
HX_LOCAL_STACK_FRAME(_hx_pos_8593639eca603478_89_shutdownTask,"sys.thread.FixedThreadPool","shutdownTask",0xd734d0f2,"sys.thread.FixedThreadPool.shutdownTask","/usr/share/haxe/std/sys/thread/FixedThreadPool.hx",89,0x95d7b7cc)
namespace sys{
namespace thread{

void FixedThreadPool_obj::__construct(int threadsCount){
            	HX_GC_STACKFRAME(&_hx_pos_8593639eca603478_36_new)
...
void FixedThreadPool_obj::run( ::Dynamic task){
            	HX_GC_STACKFRAME(&_hx_pos_8593639eca603478_65_run)
...
void FixedThreadPool_obj::shutdown(){
            	HX_STACKFRAME(&_hx_pos_8593639eca603478_80_shutdown)
...
void FixedThreadPool_obj::shutdownTask(){
            	HX_GC_STACKFRAME(&_hx_pos_8593639eca603478_89_shutdownTask)
