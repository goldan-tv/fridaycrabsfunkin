...
HX_DEFINE_STACK_FRAME(_hx_pos_5c54776fdcfe1024_5_new,"sys.thread.ThreadPoolException","new",0x173dc298,"sys.thread.ThreadPoolException.new","/usr/share/haxe/std/sys/thread/ThreadPoolException.hx",5,0x920b7fdd)
namespace sys{
namespace thread{

void ThreadPoolException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic native){
            	HX_STACKFRAME(&_hx_pos_5c54776fdcfe1024_5_new)
HXDLIN(   5)		{
