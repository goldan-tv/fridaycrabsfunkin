...
HX_LOCAL_STACK_FRAME(_hx_pos_c7a66aa1623b080e_36_close,"sys.io._Process.Stdin","close",0xbd3fe37b,"sys.io._Process.Stdin.close","/usr/share/haxe/std/cpp/_std/sys/io/Process.hx",36,0x2d961692)
HX_LOCAL_STACK_FRAME(_hx_pos_c7a66aa1623b080e_41_writeByte,"sys.io._Process.Stdin","writeByte",0xfb987cca,"sys.io._Process.Stdin.writeByte","/usr/share/haxe/std/cpp/_std/sys/io/Process.hx",41,0x2d961692)
HX_LOCAL_STACK_FRAME(_hx_pos_c7a66aa1623b080e_47_writeBytes,"sys.io._Process.Stdin","writeBytes",0x29d4b469,"sys.io._Process.Stdin.writeBytes","/usr/share/haxe/std/cpp/_std/sys/io/Process.hx",47,0x2d961692)
namespace sys{
namespace io{
namespace _Process{
...
void Stdin_obj::close(){
            	HX_STACKFRAME(&_hx_pos_c7a66aa1623b080e_36_close)
...
void Stdin_obj::writeByte(int c){
            	HX_STACKFRAME(&_hx_pos_c7a66aa1623b080e_41_writeByte)
...
int Stdin_obj::writeBytes( ::haxe::io::Bytes buf,int pos,int len){
            	HX_GC_STACKFRAME(&_hx_pos_c7a66aa1623b080e_47_writeBytes)
HXDLIN(  47)		try {
