...
HX_DEFINE_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_25_new,"openfl.text._internal.TextLayout","new",0xa41075de,"openfl.text._internal.TextLayout.new","openfl/text/_internal/TextLayout.hx",25,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_90___create,"openfl.text._internal.TextLayout","__create",0xba8383de,"openfl.text._internal.TextLayout.__create","openfl/text/_internal/TextLayout.hx",90,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_102___position,"openfl.text._internal.TextLayout","__position",0xa4593a0b,"openfl.text._internal.TextLayout.__position","openfl/text/_internal/TextLayout.hx",102,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_192_get_positions,"openfl.text._internal.TextLayout","get_positions",0x810b767f,"openfl.text._internal.TextLayout.get_positions","openfl/text/_internal/TextLayout.hx",192,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_204_get_direction,"openfl.text._internal.TextLayout","get_direction",0xc0f9e514,"openfl.text._internal.TextLayout.get_direction","openfl/text/_internal/TextLayout.hx",204,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_208_set_direction,"openfl.text._internal.TextLayout","set_direction",0x05ffc720,"openfl.text._internal.TextLayout.set_direction","openfl/text/_internal/TextLayout.hx",208,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_218_set_font,"openfl.text._internal.TextLayout","set_font",0x081d248e,"openfl.text._internal.TextLayout.set_font","openfl/text/_internal/TextLayout.hx",218,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_229_get_glyphs,"openfl.text._internal.TextLayout","get_glyphs",0xd5068f52,"openfl.text._internal.TextLayout.get_glyphs","openfl/text/_internal/TextLayout.hx",229,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_242_get_language,"openfl.text._internal.TextLayout","get_language",0xd7d8ef23,"openfl.text._internal.TextLayout.get_language","openfl/text/_internal/TextLayout.hx",242,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_246_set_language,"openfl.text._internal.TextLayout","set_language",0xecd21297,"openfl.text._internal.TextLayout.set_language","openfl/text/_internal/TextLayout.hx",246,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_257_get_script,"openfl.text._internal.TextLayout","get_script",0x6e0de416,"openfl.text._internal.TextLayout.get_script","openfl/text/_internal/TextLayout.hx",257,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_261_set_script,"openfl.text._internal.TextLayout","set_script",0x718b828a,"openfl.text._internal.TextLayout.set_script","openfl/text/_internal/TextLayout.hx",261,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_271_set_size,"openfl.text._internal.TextLayout","set_size",0x10b06780,"openfl.text._internal.TextLayout.set_size","openfl/text/_internal/TextLayout.hx",271,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_280_set_text,"openfl.text._internal.TextLayout","set_text",0x1156936c,"openfl.text._internal.TextLayout.set_text","openfl/text/_internal/TextLayout.hx",280,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_25_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",25,0xf9c6f251)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_44_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",44,0xf9c6f251)
...
HX_LOCAL_STACK_FRAME(_hx_pos_ccdf12459bd3b0e0_47_boot,"openfl.text._internal.TextLayout","boot",0xe26facf4,"openfl.text._internal.TextLayout.boot","openfl/text/_internal/TextLayout.hx",47,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextLayout_obj::__construct(::String __o_text, ::lime::text::Font font,::hx::Null< int >  __o_size,::hx::Null< int >  __o_direction,::String __o_script,::String __o_language){
            	...
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_25_new)
HXLINE(  57)		this->letterSpacing = ((Float)0);
HXLINE(  76)		this->set_text(text);
HXLINE(  77)		this->set_font(font);
HXLINE(  78)		this->set_size(size);
HXLINE(  79)		this->_hx___direction = direction;
HXLINE(  80)		this->_hx___script = script;
HXLINE(  81)		this->_hx___language = language;
HXLINE(  83)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE(  84)		this->_hx___dirty = true;
HXLINE(  86)		this->_hx___create(this->_hx___direction,this->_hx___script,this->_hx___language);
            	}
...
void TextLayout_obj::_hx___create(int direction,::String script,::String language){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_90___create)
HXLINE(  91)		if ((language.length != 4)) {
HXLINE(  91)			return;
            		}
HXLINE(  94)		this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
HXLINE(  95)		{
HXLINE(  95)			 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN(  95)			int value;
HXDLIN(  95)			switch((int)(direction)){
            				case (int)4: {
HXLINE(  95)					value = 4;
            				}
            				break;
...
HXDLIN(  95)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            		}
HXLINE(  96)		{
HXLINE(  96)			int value1 = (int)1517910393;
HXDLIN(  96)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this->_hx___hbBuffer),value1);
            		}
HXLINE(  97)		{
HXLINE(  97)			 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN(  97)			 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(language);
HXDLIN(  97)			::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this2),::hx::DynamicPtr(value2));
            		}
            	}
...
void TextLayout_obj::_hx___position(){
            	HX_GC_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_102___position)
HXLINE( 103)		this->positions = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 106)		bool _hx_tmp;
HXDLIN( 106)		bool _hx_tmp1;
HXDLIN( 106)		bool _hx_tmp2;
HXDLIN( 106)		if (::hx::IsNotNull( this->text )) {
HXLINE( 106)			_hx_tmp2 = (this->text != HX_("",00,00,00,00));
            		}
            		else {
HXLINE( 106)			_hx_tmp2 = false;
            		}
HXDLIN( 106)		if (_hx_tmp2) {
HXLINE( 106)			_hx_tmp1 = ::hx::IsNotNull( this->font );
            		}
            		else {
HXLINE( 106)			_hx_tmp1 = false;
            		}
HXDLIN( 106)		if (_hx_tmp1) {
HXLINE( 106)			_hx_tmp = ::hx::IsNotNull( this->font->src );
            		}
            		else {
HXLINE( 106)			_hx_tmp = false;
            		}
HXDLIN( 106)		if (_hx_tmp) {
HXLINE( 108)			if (::hx::IsNull( this->_hx___buffer )) {
HXLINE( 110)				this->_hx___buffer = ::haxe::io::Bytes_obj::alloc((this->text.length * 5));
            			}
HXLINE( 114)			if (::hx::IsInstanceNotEq( this->_hx___font,this->font )) {
HXLINE( 116)				this->_hx___font = this->font;
HXLINE( 118)				this->font->_hx___setSize(this->size);
HXLINE( 119)				this->_hx___hbFont = ::lime::text::harfbuzz::_HBFTFont::HBFTFont_Impl__obj::_new(this->font);
HXLINE( 121)				if (this->autoHint) {
HXLINE( 126)					::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_ft_font_set_load_flags(::hx::DynamicPtr(this->_hx___hbFont),0);
            				}
            			}
            			else {
HXLINE( 131)				this->font->_hx___setSize(this->size);
            			}
HXLINE( 134)			if (::hx::IsNull( this->_hx___hbBuffer )) {
HXLINE( 136)				this->_hx___hbBuffer = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::_new();
            			}
            			else {
HXLINE( 140)				::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::reset(this->_hx___hbBuffer);
            			}
HXLINE( 143)			{
HXLINE( 143)				 ::Dynamic this1 = this->_hx___hbBuffer;
HXDLIN( 143)				int value;
HXDLIN( 143)				switch((int)(this->get_direction())){
            					case (int)4: {
HXLINE( 143)						value = 4;
            					}
            					break;
...
HXDLIN( 143)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_direction(::hx::DynamicPtr(this1),value);
            			}
HXLINE( 144)			{
HXLINE( 144)				 ::Dynamic this2 = this->_hx___hbBuffer;
HXDLIN( 144)				::String this3 = this->get_script();
HXDLIN( 144)				int value1 = (int)1517910393;
HXDLIN( 144)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_script(::hx::DynamicPtr(this2),value1);
            			}
HXLINE( 145)			{
HXLINE( 145)				 ::Dynamic this4 = this->_hx___hbBuffer;
HXDLIN( 145)				 ::Dynamic value2 = ::lime::text::harfbuzz::_HBLanguage::HBLanguage_Impl__obj::_new(this->get_language());
HXDLIN( 145)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_language(::hx::DynamicPtr(this4),::hx::DynamicPtr(value2));
            			}
HXLINE( 146)			{
HXLINE( 146)				int value3 = 2;
HXDLIN( 146)				::lime::_internal::backend::native::NativeCFFI_obj::lime_hb_buffer_set_cluster_level(::hx::DynamicPtr(this->_hx___hbBuffer),value3);
            			}
HXLINE( 154)			 ::Dynamic _hx_tmp3 = this->_hx___hbBuffer;
HXDLIN( 154)			Float _hx_tmp4 = (uintptr_t)this->text.wc_str();
HXDLIN( 154)			::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::addUTF16(_hx_tmp3,_hx_tmp4,this->text.length,0,-1);
HXLINE( 157)			::lime::text::harfbuzz::HB_obj::shape(this->_hx___hbFont,this->_hx___hbBuffer,null());
HXLINE( 159)			::Array< ::Dynamic> _info = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphInfo(this->_hx___hbBuffer);
HXLINE( 160)			::Array< ::Dynamic> _positions = ::lime::text::harfbuzz::_HBBuffer::HBBuffer_Impl__obj::getGlyphPositions(this->_hx___hbBuffer);
HXLINE( 162)			bool _hx_tmp5;
HXDLIN( 162)			if (::hx::IsNotNull( _info )) {
HXLINE( 162)				_hx_tmp5 = ::hx::IsNotNull( _positions );
            			}
            			else {
HXLINE( 162)				_hx_tmp5 = false;
            			}
HXDLIN( 162)			if (_hx_tmp5) {
HXLINE( 164)				 ::lime::text::harfbuzz::HBGlyphInfo info;
HXDLIN( 164)				 ::lime::text::harfbuzz::HBGlyphPosition position;
HXLINE( 165)				int lastCluster = -1;
HXLINE( 167)				int length = ::Std_obj::_hx_int(::Math_obj::min(( (Float)(_info->length) ),( (Float)(_positions->length) )));
HXLINE( 169)				{
HXLINE( 169)					int _g = 0;
HXDLIN( 169)					int _g1 = length;
...
HXLINE( 174)						{
HXLINE( 174)							int _g2 = (lastCluster + 1);
HXDLIN( 174)							int _g3 = info->cluster;
HXDLIN( 174)							while((_g2 < _g3)){
HXLINE( 174)								_g2 = (_g2 + 1);
HXDLIN( 174)								int j = (_g2 - 1);
HXLINE( 178)								::Array< ::Dynamic> _hx_tmp6 = this->get_positions();
HXDLIN( 178)								 ::lime::math::Vector2 _hx_tmp7 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0);
HXDLIN( 178)								_hx_tmp6->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,0,_hx_tmp7, ::lime::math::Vector2_obj::__alloc( HX_CTX ,0,0)));
            							}
            						}
HXLINE( 181)						::Array< ::Dynamic> _hx_tmp8 = this->get_positions();
HXDLIN( 181)						int info1 = info->codepoint;
HXDLIN( 181)						 ::lime::math::Vector2 _hx_tmp9 =  ::lime::math::Vector2_obj::__alloc( HX_CTX ,((( (Float)(position->xAdvance) ) / ( (Float)(64) )) + this->letterSpacing),(( (Float)(position->yAdvance) ) / ( (Float)(64) )));
HXDLIN( 181)						_hx_tmp8->push( ::openfl::text::_internal::GlyphPosition_obj::__alloc( HX_CTX ,info1,_hx_tmp9, ::lime::math::Vector2_obj::__alloc( HX_CTX ,(( (Float)(position->xOffset) ) / ( (Float)(64) )),(( (Float)(position->yOffset) ) / ( (Float)(64) )))));
...
::Array< ::Dynamic> TextLayout_obj::get_positions(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_192_get_positions)
HXLINE( 193)		if (this->_hx___dirty) {
HXLINE( 195)			this->_hx___dirty = false;
HXLINE( 196)			this->_hx___position();
            		}
HXLINE( 199)		return this->positions;
            	}
...
int TextLayout_obj::get_direction(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_204_get_direction)
HXDLIN( 204)		return this->_hx___direction;
            	}
...
int TextLayout_obj::set_direction(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_208_set_direction)
HXLINE( 209)		if ((value == this->_hx___direction)) {
HXLINE( 209)			return value;
            		}
HXLINE( 211)		this->_hx___direction = value;
...
HX_DEFINE_DYNAMIC_FUNC1(TextLayout_obj,set_direction,return )
 ...
 ::lime::text::Font TextLayout_obj::set_font( ::lime::text::Font value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_218_set_font)
HXLINE( 219)		if (::hx::IsInstanceEq( value,this->font )) {
HXLINE( 219)			return value;
            		}
HXLINE( 221)		this->font = value;
HXLINE( 222)		this->_hx___dirty = true;
...
::Array< int > TextLayout_obj::get_glyphs(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_229_get_glyphs)
HXLINE( 230)		::Array< int > glyphs = ::Array_obj< int >::__new(0);
HXLINE( 232)		{
HXLINE( 232)			int _g = 0;
HXDLIN( 232)			::Array< ::Dynamic> _g1 = this->get_positions();
HXDLIN( 232)			while((_g < _g1->length)){
HXLINE( 232)				 ::openfl::text::_internal::GlyphPosition position = _g1->__get(_g).StaticCast<  ::openfl::text::_internal::GlyphPosition >();
HXDLIN( 232)				_g = (_g + 1);
HXLINE( 234)				glyphs->push(position->glyph);
            			}
            		}
HXLINE( 237)		return glyphs;
            	}
...
::String TextLayout_obj::get_language(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_242_get_language)
HXDLIN( 242)		return this->_hx___language;
            	}
...
::String TextLayout_obj::set_language(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_246_set_language)
HXLINE( 247)		if ((value == this->_hx___language)) {
HXLINE( 247)			return value;
            		}
HXLINE( 249)		this->_hx___language = value;
HXLINE( 250)		this->_hx___dirty = true;
...
::String TextLayout_obj::get_script(){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_257_get_script)
HXDLIN( 257)		return this->_hx___script;
            	}
...
::String TextLayout_obj::set_script(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_261_set_script)
HXLINE( 262)		if ((value == this->_hx___script)) {
HXLINE( 262)			return value;
            		}
HXLINE( 264)		this->_hx___script = value;
...
int TextLayout_obj::set_size(int value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_271_set_size)
HXLINE( 272)		if ((value == this->size)) {
HXLINE( 272)			return value;
            		}
HXLINE( 274)		this->size = value;
HXLINE( 275)		this->_hx___dirty = true;
...
::String TextLayout_obj::set_text(::String value){
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_280_set_text)
HXLINE( 281)		if ((value == this->text)) {
HXLINE( 281)			return value;
            		}
HXLINE( 283)		this->text = value;
HXLINE( 284)		this->_hx___dirty = true;
...
{
{
            	HX_STACKFRAME(&_hx_pos_ccdf12459bd3b0e0_25_boot)
