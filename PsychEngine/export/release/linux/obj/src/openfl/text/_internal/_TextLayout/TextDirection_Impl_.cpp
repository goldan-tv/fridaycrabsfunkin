...
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_305_reverse,"openfl.text._internal._TextLayout.TextDirection_Impl_","reverse",0x2436bfd9,"openfl.text._internal._TextLayout.TextDirection_Impl_.reverse","openfl/text/_internal/TextLayout.hx",305,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_310_toString,"openfl.text._internal._TextLayout.TextDirection_Impl_","toString",0x426a2a15,"openfl.text._internal._TextLayout.TextDirection_Impl_.toString","openfl/text/_internal/TextLayout.hx",310,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_323_toHBDirection,"openfl.text._internal._TextLayout.TextDirection_Impl_","toHBDirection",0x47c8a441,"openfl.text._internal._TextLayout.TextDirection_Impl_.toHBDirection","openfl/text/_internal/TextLayout.hx",323,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_336_get_backward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_backward",0x1e6151d5,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_backward","openfl/text/_internal/TextLayout.hx",336,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_341_get_forward,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_forward",0xaa0ef013,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_forward","openfl/text/_internal/TextLayout.hx",341,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_346_get_horizontal,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_horizontal",0xc88b5356,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_horizontal","openfl/text/_internal/TextLayout.hx",346,0xf9c6f251)
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_351_get_vertical,"openfl.text._internal._TextLayout.TextDirection_Impl_","get_vertical",0x615e3268,"openfl.text._internal._TextLayout.TextDirection_Impl_.get_vertical","openfl/text/_internal/TextLayout.hx",351,0xf9c6f251)
...
HX_LOCAL_STACK_FRAME(_hx_pos_fecd85f16d8632f8_297_boot,"openfl.text._internal._TextLayout.TextDirection_Impl_","boot",0x0be1b51b,"openfl.text._internal._TextLayout.TextDirection_Impl_.boot","openfl/text/_internal/TextLayout.hx",297,0xf9c6f251)
namespace openfl{
namespace text{
namespace _internal{
...
void TextDirection_Impl__obj::reverse(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_305_reverse)
HXDLIN( 305)		this1 = (this1 ^ 1);
            	}
...
::String TextDirection_Impl__obj::toString(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_310_toString)
HXDLIN( 310)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 312)				return HX_("leftToRight",1a,97,7b,b5);
            			}
            			break;
            			case (int)5: {
HXLINE( 313)				return HX_("rightToLeft",1e,40,ee,e6);
            			}
            			break;
            			case (int)6: {
HXLINE( 314)				return HX_("topToBottom",7b,ce,19,75);
            			}
            			break;
            			case (int)7: {
HXLINE( 315)				return HX_("bottomToTop",ef,ac,aa,79);
            			}
            			break;
            			default:{
HXLINE( 316)				return HX_("",00,00,00,00);
            			}
            		}
...
int TextDirection_Impl__obj::toHBDirection(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_323_toHBDirection)
HXDLIN( 323)		switch((int)(this1)){
            			case (int)4: {
HXLINE( 325)				return 4;
            			}
            			break;
...
bool TextDirection_Impl__obj::get_backward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_336_get_backward)
HXDLIN( 336)		return ((this1 & -3) == 5);
            	}
...
bool TextDirection_Impl__obj::get_forward(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_341_get_forward)
HXDLIN( 341)		return ((this1 & -3) == 4);
            	}
...
bool TextDirection_Impl__obj::get_horizontal(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_346_get_horizontal)
HXDLIN( 346)		return ((this1 & -2) == 4);
            	}
...
bool TextDirection_Impl__obj::get_vertical(int this1){
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_351_get_vertical)
HXDLIN( 351)		return ((this1 & -2) == 6);
            	}
...
HXDLIN( 293)		INVALID = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_294_boot)
HXDLIN( 294)		LEFT_TO_RIGHT = 4;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_295_boot)
HXDLIN( 295)		RIGHT_TO_LEFT = 5;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_296_boot)
HXDLIN( 296)		TOP_TO_BOTTOM = 6;
            	}
{
            	HX_STACKFRAME(&_hx_pos_fecd85f16d8632f8_297_boot)
HXDLIN( 297)		BOTTOM_TO_TOP = 7;
            	}
}
