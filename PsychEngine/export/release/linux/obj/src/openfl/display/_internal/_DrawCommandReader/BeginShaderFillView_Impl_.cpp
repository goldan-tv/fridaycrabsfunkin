...
HX_LOCAL_STACK_FRAME(_hx_pos_3514654c679e6cb8_458__new,"openfl.display._internal._DrawCommandReader.BeginShaderFillView_Impl_","_new",0x40adeac0,"openfl.display._internal._DrawCommandReader.BeginShaderFillView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",458,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_3514654c679e6cb8_467_get_shaderBuffer,"openfl.display._internal._DrawCommandReader.BeginShaderFillView_Impl_","get_shaderBuffer",0x6e852e6d,"openfl.display._internal._DrawCommandReader.BeginShaderFillView_Impl_.get_shaderBuffer","openfl/display/_internal/DrawCommandReader.hx",467,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool BeginShaderFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader BeginShaderFillView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_3514654c679e6cb8_458__new)
HXDLIN( 458)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginShaderFillView_Impl__obj,_new,return )
 ...
 ::openfl::display::_internal::ShaderBuffer BeginShaderFillView_Impl__obj::get_shaderBuffer( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_3514654c679e6cb8_467_get_shaderBuffer)
HXDLIN( 467)		return ( ( ::openfl::display::_internal::ShaderBuffer)(this1->buffer->o->__get(this1->oPos)) );
            	}
