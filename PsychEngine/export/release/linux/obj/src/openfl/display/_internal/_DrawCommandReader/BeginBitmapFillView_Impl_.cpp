...
HX_LOCAL_STACK_FRAME(_hx_pos_73397f6f71169552_336__new,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_","_new",0xaa7e8036,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",336,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_73397f6f71169552_345_get_bitmap,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_","get_bitmap",0x1aba384d,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_.get_bitmap","openfl/display/_internal/DrawCommandReader.hx",345,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_73397f6f71169552_352_get_matrix,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_","get_matrix",0xe5765e9f,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_.get_matrix","openfl/display/_internal/DrawCommandReader.hx",352,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_73397f6f71169552_359_get_repeat,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_","get_repeat",0x302abfb9,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_.get_repeat","openfl/display/_internal/DrawCommandReader.hx",359,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_73397f6f71169552_366_get_smooth,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_","get_smooth",0x3119308c,"openfl.display._internal._DrawCommandReader.BeginBitmapFillView_Impl_.get_smooth","openfl/display/_internal/DrawCommandReader.hx",366,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool BeginBitmapFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader BeginBitmapFillView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_73397f6f71169552_336__new)
HXDLIN( 336)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginBitmapFillView_Impl__obj,_new,return )
 ...
 ::openfl::display::BitmapData BeginBitmapFillView_Impl__obj::get_bitmap( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_73397f6f71169552_345_get_bitmap)
HXDLIN( 345)		return ( ( ::openfl::display::BitmapData)(this1->buffer->o->__get(this1->oPos)) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(BeginBitmapFillView_Impl__obj,get_bitmap,return )
 ...
 ::openfl::geom::Matrix BeginBitmapFillView_Impl__obj::get_matrix( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_73397f6f71169552_352_get_matrix)
HXDLIN( 352)		return ( ( ::openfl::geom::Matrix)(this1->buffer->o->__get((this1->oPos + 1))) );
            	}
...
bool BeginBitmapFillView_Impl__obj::get_repeat( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_73397f6f71169552_359_get_repeat)
HXDLIN( 359)		return this1->buffer->b->__get(this1->bPos);
            	}
...
bool BeginBitmapFillView_Impl__obj::get_smooth( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_73397f6f71169552_366_get_smooth)
HXDLIN( 366)		return this1->buffer->b->__get((this1->bPos + 1));
            	}
