...
HX_LOCAL_STACK_FRAME(_hx_pos_67c8a03ed406a336_991__new,"openfl.display._internal._DrawCommandReader.OverrideBlendModeView_Impl_","_new",0xb61c87c9,"openfl.display._internal._DrawCommandReader.OverrideBlendModeView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",991,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_67c8a03ed406a336_1000_get_blendMode,"openfl.display._internal._DrawCommandReader.OverrideBlendModeView_Impl_","get_blendMode",0x56a0b8c3,"openfl.display._internal._DrawCommandReader.OverrideBlendModeView_Impl_.get_blendMode","openfl/display/_internal/DrawCommandReader.hx",1000,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool OverrideBlendModeView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader OverrideBlendModeView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_67c8a03ed406a336_991__new)
HXDLIN( 991)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(OverrideBlendModeView_Impl__obj,_new,return )
 ...
 ::Dynamic OverrideBlendModeView_Impl__obj::get_blendMode( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_67c8a03ed406a336_1000_get_blendMode)
HXDLIN(1000)		return this1->buffer->o->__get(this1->oPos);
            	}
