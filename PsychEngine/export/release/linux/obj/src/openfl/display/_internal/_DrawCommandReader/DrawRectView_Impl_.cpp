...
HX_LOCAL_STACK_FRAME(_hx_pos_9f1d40122943ef17_653__new,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_","_new",0xf7c4b27b,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",653,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_9f1d40122943ef17_662_get_x,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_","get_x",0x69a47ef5,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_.get_x","openfl/display/_internal/DrawCommandReader.hx",662,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_9f1d40122943ef17_669_get_y,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_","get_y",0x69a47ef6,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_.get_y","openfl/display/_internal/DrawCommandReader.hx",669,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_9f1d40122943ef17_676_get_width,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_","get_width",0x4c34b703,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_.get_width","openfl/display/_internal/DrawCommandReader.hx",676,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_9f1d40122943ef17_683_get_height,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_","get_height",0x183ae44a,"openfl.display._internal._DrawCommandReader.DrawRectView_Impl_.get_height","openfl/display/_internal/DrawCommandReader.hx",683,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool DrawRectView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader DrawRectView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_9f1d40122943ef17_653__new)
HXDLIN( 653)		return d;
            	}
...
Float DrawRectView_Impl__obj::get_x( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_9f1d40122943ef17_662_get_x)
HXDLIN( 662)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawRectView_Impl__obj::get_y( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_9f1d40122943ef17_669_get_y)
HXDLIN( 669)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
...
Float DrawRectView_Impl__obj::get_width( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_9f1d40122943ef17_676_get_width)
HXDLIN( 676)		return this1->buffer->f->__get((this1->fPos + 2));
            	}
...
Float DrawRectView_Impl__obj::get_height( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_9f1d40122943ef17_683_get_height)
HXDLIN( 683)		return this1->buffer->f->__get((this1->fPos + 3));
            	}
