...
HX_LOCAL_STACK_FRAME(_hx_pos_4fa3d6a6f5023b94_1021__new,"openfl.display._internal._DrawCommandReader.WindingEvenOddView_Impl_","_new",0x65b01728,"openfl.display._internal._DrawCommandReader.WindingEvenOddView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",1021,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool WindingEvenOddView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader WindingEvenOddView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_4fa3d6a6f5023b94_1021__new)
HXDLIN(1021)		return d;
            	}
