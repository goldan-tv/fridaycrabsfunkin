...
HXLINE( 400)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 400)				_g4 = (_g4 + 1);
HXLINE( 402)				parameter1->_hx___disableGL(this->_hx___context);
            			}
            		}
HXLINE( 405)		{
...
HXLINE( 405)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 405)				_g6 = (_g6 + 1);
HXLINE( 407)				parameter2->_hx___disableGL(this->_hx___context);
            			}
            		}
...
HXLINE( 544)						 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 544)						_g4 = (_g4 + 1);
HXLINE( 546)						if (parameter1->_hx___isUniform) {
HXLINE( 548)							parameter1->index = gl->getUniformLocation(this->glProgram,parameter1->name);
            						}
            						else {
HXLINE( 552)							parameter1->index = gl->getAttribLocation(this->glProgram,parameter1->name);
            						}
            					}
            				}
HXLINE( 556)				{
...
HXLINE( 556)						 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 556)						_g6 = (_g6 + 1);
HXLINE( 558)						if (parameter2->_hx___isUniform) {
HXLINE( 560)							parameter2->index = gl->getUniformLocation(this->glProgram,parameter2->name);
            						}
            						else {
HXLINE( 564)							parameter2->index = gl->getAttribLocation(this->glProgram,parameter2->name);
            						}
            					}
            				}
            			}
...
HXLINE( 682)						 ::openfl::display::ShaderParameter_Int parameter1 =  ::openfl::display::ShaderParameter_Int_obj::__alloc( HX_CTX );
HXLINE( 683)						parameter1->set_name(name);
HXLINE( 684)						parameter1->type = parameterType;
HXLINE( 685)						parameter1->_hx___arrayLength = arrayLength;
HXLINE( 686)						parameter1->_hx___isInt = true;
HXLINE( 687)						parameter1->_hx___isUniform = isUniform;
HXLINE( 688)						parameter1->__length = length;
HXLINE( 689)						this->_hx___paramInt->push(parameter1);
HXLINE( 690)						::Reflect_obj::setField(this->_hx___data,name,parameter1);
HXLINE( 691)						if (this->_hx___isGenerated) {
HXLINE( 691)							::Reflect_obj::setField(::hx::ObjectPtr<OBJ_>(this),name,parameter1);
            						}
HXLINE( 681)						goto _hx_goto_29;
            					}
            					/* default */{
HXLINE( 694)						 ::openfl::display::ShaderParameter_Float parameter2 =  ::openfl::display::ShaderParameter_Float_obj::__alloc( HX_CTX );
HXLINE( 695)						parameter2->set_name(name);
HXLINE( 696)						parameter2->type = parameterType;
HXLINE( 697)						parameter2->_hx___arrayLength = arrayLength;
...
HXDLIN( 699)									_this->buffer = ::haxe::io::Bytes_obj::alloc(_this->byteLength);
HXDLIN( 699)									_this->copyFromArray(array,null());
HXDLIN( 699)									this1 = _this;
            								}
            								else {
HXLINE( 699)									if (::hx::IsNotNull( vector )) {
HXLINE( 699)										 ::lime::utils::ArrayBufferView _this1 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 699)										::cpp::VirtualArray array1 = ( (::cpp::VirtualArray)(vector->__Field(HX_("__array",79,c6,ed,8f),::hx::paccDynamic)) );
HXDLIN( 699)										_this1->byteOffset = 0;
HXDLIN( 699)										_this1->length = array1->get_length();
HXDLIN( 699)										_this1->byteLength = (_this1->length * _this1->bytesPerElement);
HXDLIN( 699)										_this1->buffer = ::haxe::io::Bytes_obj::alloc(_this1->byteLength);
HXDLIN( 699)										_this1->copyFromArray(array1,null());
HXDLIN( 699)										this1 = _this1;
            									}
            									else {
HXLINE( 699)										if (::hx::IsNotNull( view )) {
HXLINE( 699)											 ::lime::utils::ArrayBufferView _this2 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
...
HXDLIN( 699)											int elementSize = _this2->bytesPerElement;
HXDLIN( 699)											if ((view->type == _this2->type)) {
HXLINE( 699)												int srcLength1 = srcData->length;
HXDLIN( 699)												int cloneLength = (srcLength1 - srcByteOffset);
HXDLIN( 699)												_this2->buffer = ::haxe::io::Bytes_obj::alloc(cloneLength);
HXDLIN( 699)												_this2->buffer->blit(0,srcData,srcByteOffset,cloneLength);
            											}
            											else {
HXLINE( 699)												HX_STACK_DO_THROW(HX_("unimplemented",09,2f,74,b4));
            											}
HXDLIN( 699)											_this2->byteLength = (_this2->bytesPerElement * srcLength);
HXDLIN( 699)											_this2->byteOffset = 0;
HXDLIN( 699)											_this2->length = srcLength;
HXDLIN( 699)											this1 = _this2;
            										}
            										else {
HXLINE( 699)											if (::hx::IsNotNull( buffer )) {
HXLINE( 699)												 ::lime::utils::ArrayBufferView _this3 =  ::lime::utils::ArrayBufferView_obj::__alloc( HX_CTX ,0,8);
HXDLIN( 699)												int in_byteOffset = 0;
HXDLIN( 699)												if ((in_byteOffset < 0)) {
HXLINE( 699)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 699)												if ((::hx::Mod(in_byteOffset,_this3->bytesPerElement) != 0)) {
HXLINE( 699)													HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            												}
HXDLIN( 699)												int bufferByteLength = buffer->length;
HXDLIN( 699)												int elementSize1 = _this3->bytesPerElement;
...
HXDLIN( 699)													if ((::hx::Mod(bufferByteLength,_this3->bytesPerElement) != 0)) {
HXLINE( 699)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
...
HXLINE( 699)													newByteLength = (( (int)(len) ) * _this3->bytesPerElement);
HXDLIN( 699)													int newRange = (in_byteOffset + newByteLength);
HXDLIN( 699)													if ((newRange > bufferByteLength)) {
HXLINE( 699)														HX_STACK_DO_THROW(::lime::utils::TAError_obj::RangeError_dyn());
            													}
            												}
HXDLIN( 699)												_this3->buffer = buffer;
HXDLIN( 699)												_this3->byteOffset = in_byteOffset;
HXDLIN( 699)												_this3->byteLength = newByteLength;
HXDLIN( 699)												_this3->length = ::Std_obj::_hx_int((( (Float)(newByteLength) ) / ( (Float)(_this3->bytesPerElement) )));
HXDLIN( 699)												this1 = _this3;
            											}
            											else {
HXLINE( 699)												HX_STACK_DO_THROW(HX_("Invalid constructor arguments for Float32Array",8e,c1,f4,d4));
            											}
            										}
            									}
            								}
            							}
HXDLIN( 699)							parameter2->_hx___uniformMatrix = this1;
            						}
HXLINE( 701)						parameter2->_hx___isFloat = true;
HXLINE( 702)						parameter2->_hx___isUniform = isUniform;
HXLINE( 703)						parameter2->__length = length;
HXLINE( 704)						this->_hx___paramFloat->push(parameter2);
...
HXLINE( 721)						::Reflect_obj::setField(this->_hx___data,name,parameter2);
HXLINE( 722)						if (this->_hx___isGenerated) {
HXLINE( 722)							::Reflect_obj::setField(::hx::ObjectPtr<OBJ_>(this),name,parameter2);
            						}
            					}
            					_hx_goto_29:;
            				}
...
HXLINE( 762)				 ::openfl::display::ShaderParameter_Float parameter1 = _g5->__get(_g4).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXDLIN( 762)				_g4 = (_g4 + 1);
HXLINE( 764)				parameter1->_hx___updateGL(this->_hx___context,null());
            			}
            		}
HXLINE( 767)		{
...
HXLINE( 767)				 ::openfl::display::ShaderParameter_Int parameter2 = _g7->__get(_g6).StaticCast<  ::openfl::display::ShaderParameter_Int >();
HXDLIN( 767)				_g6 = (_g6 + 1);
HXLINE( 769)				parameter2->_hx___updateGL(this->_hx___context,null());
            			}
            		}
            	}
...
HXDLIN( 827)				int i1 = (_g2 - 1);
HXLINE( 829)				hasOverride = false;
HXLINE( 831)				if ((i1 < boolCount)) {
...
HXDLIN( 835)						int _g5 = shaderBuffer->overrideBoolCount;
HXDLIN( 835)						while((_g4 < _g5)){
HXLINE( 835)							_g4 = (_g4 + 1);
HXDLIN( 835)							int j = (_g4 - 1);
...
HXLINE( 851)						boolRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            					}
HXLINE( 854)					boolIndex = (boolIndex + 1);
            				}
            				else {
HXLINE( 856)					if ((i1 < (boolCount + floatCount))) {
HXLINE( 858)						floatRef = shaderBuffer->paramRefs_Float->__get(floatIndex).StaticCast<  ::openfl::display::ShaderParameter_Float >();
HXLINE( 860)						{
HXLINE( 860)							int _g6 = 0;
HXDLIN( 860)							int _g7 = shaderBuffer->overrideFloatCount;
HXDLIN( 860)							while((_g6 < _g7)){
HXLINE( 860)								_g6 = (_g6 + 1);
HXDLIN( 860)								int j1 = (_g6 - 1);
HXLINE( 862)								if ((floatRef->name == shaderBuffer->overrideFloatNames->__get(j1))) {
HXLINE( 864)									overrideFloatValue = shaderBuffer->overrideFloatValues->__get(j1).StaticCast< ::Array< Float > >();
...
HXLINE( 876)							floatRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
...
HXLINE( 885)						{
HXLINE( 885)							int _g8 = 0;
HXDLIN( 885)							int _g9 = shaderBuffer->overrideIntCount;
HXDLIN( 885)							while((_g8 < _g9)){
HXLINE( 885)								_g8 = (_g8 + 1);
HXDLIN( 885)								int j2 = (_g8 - 1);
HXLINE( 887)								if ((intRef->name == shaderBuffer->overrideIntNames->__get(j2))) {
HXLINE( 889)									overrideIntValue = ::cpp::VirtualArray( shaderBuffer->overrideIntValues->__get(j2));
...
HXLINE( 901)							intRef->_hx___updateGLFromBuffer(this->_hx___context,paramData,shaderBuffer->paramPositions->__get(i1),shaderBuffer->paramLengths->__get(i1),bufferOffset);
            						}
