...
HX_LOCAL_STACK_FRAME(_hx_pos_c809d3cd762f2eb4_372__new,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_","_new",0x0da27465,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",372,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_c809d3cd762f2eb4_381_get_color,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_","get_color",0xc5578036,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_.get_color","openfl/display/_internal/DrawCommandReader.hx",381,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_c809d3cd762f2eb4_388_get_alpha,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_","get_alpha",0x9c91b631,"openfl.display._internal._DrawCommandReader.BeginFillView_Impl_.get_alpha","openfl/display/_internal/DrawCommandReader.hx",388,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool BeginFillView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader BeginFillView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_c809d3cd762f2eb4_372__new)
HXDLIN( 372)		return d;
            	}
...
int BeginFillView_Impl__obj::get_color( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c809d3cd762f2eb4_381_get_color)
HXDLIN( 381)		return this1->buffer->i->__get(this1->iPos);
            	}
...
Float BeginFillView_Impl__obj::get_alpha( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c809d3cd762f2eb4_388_get_alpha)
HXDLIN( 388)		return this1->buffer->f->__get(this1->fPos);
            	}
