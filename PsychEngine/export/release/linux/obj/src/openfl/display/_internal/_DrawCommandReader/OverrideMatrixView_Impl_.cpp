...
HX_LOCAL_STACK_FRAME(_hx_pos_7bef863587a79a9e_1006__new,"openfl.display._internal._DrawCommandReader.OverrideMatrixView_Impl_","_new",0x552dc676,"openfl.display._internal._DrawCommandReader.OverrideMatrixView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",1006,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_7bef863587a79a9e_1015_get_matrix,"openfl.display._internal._DrawCommandReader.OverrideMatrixView_Impl_","get_matrix",0x813bd4df,"openfl.display._internal._DrawCommandReader.OverrideMatrixView_Impl_.get_matrix","openfl/display/_internal/DrawCommandReader.hx",1015,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool OverrideMatrixView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader OverrideMatrixView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_7bef863587a79a9e_1006__new)
HXDLIN(1006)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(OverrideMatrixView_Impl__obj,_new,return )
 ...
 ::openfl::geom::Matrix OverrideMatrixView_Impl__obj::get_matrix( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_7bef863587a79a9e_1015_get_matrix)
HXDLIN(1015)		return ( ( ::openfl::geom::Matrix)(this1->buffer->o->__get(this1->oPos)) );
            	}
