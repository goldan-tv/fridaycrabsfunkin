...
HX_LOCAL_STACK_FRAME(_hx_pos_30f77dce503ebbb9_969__new,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_","_new",0xc54d1f17,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",969,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_30f77dce503ebbb9_978_get_x,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_","get_x",0x737b1ad9,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_.get_x","openfl/display/_internal/DrawCommandReader.hx",978,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_30f77dce503ebbb9_985_get_y,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_","get_y",0x737b1ada,"openfl.display._internal._DrawCommandReader.MoveToView_Impl_.get_y","openfl/display/_internal/DrawCommandReader.hx",985,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool MoveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader MoveToView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_30f77dce503ebbb9_969__new)
HXDLIN( 969)		return d;
            	}
...
Float MoveToView_Impl__obj::get_x( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_30f77dce503ebbb9_978_get_x)
HXDLIN( 978)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float MoveToView_Impl__obj::get_y( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_30f77dce503ebbb9_985_get_y)
HXDLIN( 985)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
