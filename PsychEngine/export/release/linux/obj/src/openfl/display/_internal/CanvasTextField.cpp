...
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_32_render,"openfl.display._internal.CanvasTextField","render",0x61465dcb,"openfl.display._internal.CanvasTextField.render","openfl/display/_internal/CanvasTextField.hx",32,0x76b44b48)
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_389_renderDrawable,"openfl.display._internal.CanvasTextField","renderDrawable",0x53844889,"openfl.display._internal.CanvasTextField.renderDrawable","openfl/display/_internal/CanvasTextField.hx",389,0x76b44b48)
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_450_renderDrawableMask,"openfl.display._internal.CanvasTextField","renderDrawableMask",0x545d2e15,"openfl.display._internal.CanvasTextField.renderDrawableMask","openfl/display/_internal/CanvasTextField.hx",450,0x76b44b48)
HX_LOCAL_STACK_FRAME(_hx_pos_3208549e91c46d80_24_boot,"openfl.display._internal.CanvasTextField","boot",0x30db7f67,"openfl.display._internal.CanvasTextField.boot","openfl/display/_internal/CanvasTextField.hx",24,0x76b44b48)
namespace openfl{
namespace display{
namespace _internal{
...
void CanvasTextField_obj::render( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer, ::openfl::geom::Matrix transform){
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_32_render)
            	}
...
void CanvasTextField_obj::renderDrawable( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_389_renderDrawable)
            	}
...
void CanvasTextField_obj::renderDrawableMask( ::openfl::text::TextField textField, ::openfl::display::CanvasRenderer renderer){
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_450_renderDrawableMask)
HXDLIN( 450)		::openfl::display::_internal::CanvasDisplayObject_obj::renderDrawableMask(textField,renderer);
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_3208549e91c46d80_24_boot)
