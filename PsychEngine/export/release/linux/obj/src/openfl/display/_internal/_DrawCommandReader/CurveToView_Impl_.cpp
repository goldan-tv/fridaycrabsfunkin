...
HX_LOCAL_STACK_FRAME(_hx_pos_b7964c5d852eee6f_523__new,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_","_new",0x1ca8bfa7,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",523,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_b7964c5d852eee6f_532_get_controlX,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_","get_controlX",0xf91c9aaa,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_.get_controlX","openfl/display/_internal/DrawCommandReader.hx",532,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_b7964c5d852eee6f_539_get_controlY,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_","get_controlY",0xf91c9aab,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_.get_controlY","openfl/display/_internal/DrawCommandReader.hx",539,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_b7964c5d852eee6f_546_get_anchorX,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_","get_anchorX",0x81c716d4,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_.get_anchorX","openfl/display/_internal/DrawCommandReader.hx",546,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_b7964c5d852eee6f_553_get_anchorY,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_","get_anchorY",0x81c716d5,"openfl.display._internal._DrawCommandReader.CurveToView_Impl_.get_anchorY","openfl/display/_internal/DrawCommandReader.hx",553,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool CurveToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader CurveToView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_b7964c5d852eee6f_523__new)
HXDLIN( 523)		return d;
            	}
...
Float CurveToView_Impl__obj::get_controlX( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_b7964c5d852eee6f_532_get_controlX)
HXDLIN( 532)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float CurveToView_Impl__obj::get_controlY( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_b7964c5d852eee6f_539_get_controlY)
HXDLIN( 539)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
...
Float CurveToView_Impl__obj::get_anchorX( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_b7964c5d852eee6f_546_get_anchorX)
HXDLIN( 546)		return this1->buffer->f->__get((this1->fPos + 2));
            	}
...
Float CurveToView_Impl__obj::get_anchorY( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_b7964c5d852eee6f_553_get_anchorY)
HXDLIN( 553)		return this1->buffer->f->__get((this1->fPos + 3));
            	}
