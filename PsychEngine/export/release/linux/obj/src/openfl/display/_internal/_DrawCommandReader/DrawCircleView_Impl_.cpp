...
HX_LOCAL_STACK_FRAME(_hx_pos_c4c10c39864eebc6_559__new,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_","_new",0x6f17464f,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",559,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_c4c10c39864eebc6_568_get_x,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_","get_x",0x5a9344a1,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_.get_x","openfl/display/_internal/DrawCommandReader.hx",568,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_c4c10c39864eebc6_575_get_y,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_","get_y",0x5a9344a2,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_.get_y","openfl/display/_internal/DrawCommandReader.hx",575,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_c4c10c39864eebc6_582_get_radius,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_","get_radius",0xcaaed789,"openfl.display._internal._DrawCommandReader.DrawCircleView_Impl_.get_radius","openfl/display/_internal/DrawCommandReader.hx",582,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool DrawCircleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader DrawCircleView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_c4c10c39864eebc6_559__new)
HXDLIN( 559)		return d;
            	}
...
Float DrawCircleView_Impl__obj::get_x( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c4c10c39864eebc6_568_get_x)
HXDLIN( 568)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawCircleView_Impl__obj::get_y( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c4c10c39864eebc6_575_get_y)
HXDLIN( 575)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
...
Float DrawCircleView_Impl__obj::get_radius( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_c4c10c39864eebc6_582_get_radius)
HXDLIN( 582)		return this1->buffer->f->__get((this1->fPos + 2));
            	}
