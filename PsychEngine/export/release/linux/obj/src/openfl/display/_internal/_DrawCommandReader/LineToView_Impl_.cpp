...
HX_LOCAL_STACK_FRAME(_hx_pos_29dccb6eed6a8294_947__new,"openfl.display._internal._DrawCommandReader.LineToView_Impl_","_new",0x04dd3ad4,"openfl.display._internal._DrawCommandReader.LineToView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",947,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_29dccb6eed6a8294_956_get_x,"openfl.display._internal._DrawCommandReader.LineToView_Impl_","get_x",0xd203447c,"openfl.display._internal._DrawCommandReader.LineToView_Impl_.get_x","openfl/display/_internal/DrawCommandReader.hx",956,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_29dccb6eed6a8294_963_get_y,"openfl.display._internal._DrawCommandReader.LineToView_Impl_","get_y",0xd203447d,"openfl.display._internal._DrawCommandReader.LineToView_Impl_.get_y","openfl/display/_internal/DrawCommandReader.hx",963,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool LineToView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader LineToView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_29dccb6eed6a8294_947__new)
HXDLIN( 947)		return d;
            	}
...
Float LineToView_Impl__obj::get_x( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29dccb6eed6a8294_956_get_x)
HXDLIN( 956)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float LineToView_Impl__obj::get_y( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_29dccb6eed6a8294_963_get_y)
HXDLIN( 963)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
