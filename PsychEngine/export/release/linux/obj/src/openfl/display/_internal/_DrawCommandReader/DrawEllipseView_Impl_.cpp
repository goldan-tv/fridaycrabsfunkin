...
HX_LOCAL_STACK_FRAME(_hx_pos_6b599a959306dce8_588__new,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_","_new",0xe028eff7,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",588,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_6b599a959306dce8_597_get_x,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_","get_x",0xd8f60df9,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_.get_x","openfl/display/_internal/DrawCommandReader.hx",597,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_6b599a959306dce8_604_get_y,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_","get_y",0xd8f60dfa,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_.get_y","openfl/display/_internal/DrawCommandReader.hx",604,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_6b599a959306dce8_611_get_width,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_","get_width",0xd2941807,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_.get_width","openfl/display/_internal/DrawCommandReader.hx",611,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_6b599a959306dce8_618_get_height,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_","get_height",0x255066c6,"openfl.display._internal._DrawCommandReader.DrawEllipseView_Impl_.get_height","openfl/display/_internal/DrawCommandReader.hx",618,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool DrawEllipseView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader DrawEllipseView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_6b599a959306dce8_588__new)
HXDLIN( 588)		return d;
            	}
...
Float DrawEllipseView_Impl__obj::get_x( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6b599a959306dce8_597_get_x)
HXDLIN( 597)		return this1->buffer->f->__get(this1->fPos);
            	}
...
Float DrawEllipseView_Impl__obj::get_y( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6b599a959306dce8_604_get_y)
HXDLIN( 604)		return this1->buffer->f->__get((this1->fPos + 1));
            	}
...
Float DrawEllipseView_Impl__obj::get_width( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6b599a959306dce8_611_get_width)
HXDLIN( 611)		return this1->buffer->f->__get((this1->fPos + 2));
            	}
...
Float DrawEllipseView_Impl__obj::get_height( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_6b599a959306dce8_618_get_height)
HXDLIN( 618)		return this1->buffer->f->__get((this1->fPos + 3));
            	}
