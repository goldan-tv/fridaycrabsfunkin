...
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_819__new,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","_new",0x481bcd44,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",819,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_828_get_type,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_type",0x0bdd93a6,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_type","openfl/display/_internal/DrawCommandReader.hx",828,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_835_get_colors,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_colors",0x5c76799c,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_colors","openfl/display/_internal/DrawCommandReader.hx",835,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_842_get_alphas,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_alphas",0xd82b7f41,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_alphas","openfl/display/_internal/DrawCommandReader.hx",842,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_849_get_ratios,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_ratios",0x5179e8f4,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_ratios","openfl/display/_internal/DrawCommandReader.hx",849,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_856_get_matrix,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_matrix",0x51b7ea2d,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_matrix","openfl/display/_internal/DrawCommandReader.hx",856,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_863_get_spreadMethod,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_spreadMethod",0xf82572a0,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_spreadMethod","openfl/display/_internal/DrawCommandReader.hx",863,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_870_get_interpolationMethod,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_interpolationMethod",0x92b9d7b9,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_interpolationMethod","openfl/display/_internal/DrawCommandReader.hx",870,0x29f77eb3)
HX_LOCAL_STACK_FRAME(_hx_pos_af20266d2b2be92c_877_get_focalPointRatio,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_","get_focalPointRatio",0xcb72dff4,"openfl.display._internal._DrawCommandReader.LineGradientStyleView_Impl_.get_focalPointRatio","openfl/display/_internal/DrawCommandReader.hx",877,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool LineGradientStyleView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader LineGradientStyleView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_819__new)
HXDLIN( 819)		return d;
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineGradientStyleView_Impl__obj,_new,return )
 ...
 ::Dynamic LineGradientStyleView_Impl__obj::get_type( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_828_get_type)
HXDLIN( 828)		return this1->buffer->o->__get(this1->oPos);
            	}
...
::Array< int > LineGradientStyleView_Impl__obj::get_colors( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_835_get_colors)
HXDLIN( 835)		return this1->buffer->ii->__get(this1->iiPos).StaticCast< ::Array< int > >();
            	}
...
::Array< Float > LineGradientStyleView_Impl__obj::get_alphas( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_842_get_alphas)
HXDLIN( 842)		return this1->buffer->ff->__get(this1->ffPos).StaticCast< ::Array< Float > >();
            	}
...
::Array< int > LineGradientStyleView_Impl__obj::get_ratios( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_849_get_ratios)
HXDLIN( 849)		return this1->buffer->ii->__get((this1->iiPos + 1)).StaticCast< ::Array< int > >();
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineGradientStyleView_Impl__obj,get_ratios,return )
 ...
 ::openfl::geom::Matrix LineGradientStyleView_Impl__obj::get_matrix( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_856_get_matrix)
HXDLIN( 856)		return ( ( ::openfl::geom::Matrix)(this1->buffer->o->__get((this1->oPos + 1))) );
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineGradientStyleView_Impl__obj,get_matrix,return )
 ...
 ::Dynamic LineGradientStyleView_Impl__obj::get_spreadMethod( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_863_get_spreadMethod)
HXDLIN( 863)		return this1->buffer->o->__get((this1->oPos + 2));
            	}
...
STATIC_HX_DEFINE_DYNAMIC_FUNC1(LineGradientStyleView_Impl__obj,get_spreadMethod,return )
 ...
 ::Dynamic LineGradientStyleView_Impl__obj::get_interpolationMethod( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_870_get_interpolationMethod)
HXDLIN( 870)		return this1->buffer->o->__get((this1->oPos + 3));
            	}
...
Float LineGradientStyleView_Impl__obj::get_focalPointRatio( ::openfl::display::_internal::DrawCommandReader this1){
            	HX_STACKFRAME(&_hx_pos_af20266d2b2be92c_877_get_focalPointRatio)
HXDLIN( 877)		return this1->buffer->f->__get(this1->fPos);
            	}
