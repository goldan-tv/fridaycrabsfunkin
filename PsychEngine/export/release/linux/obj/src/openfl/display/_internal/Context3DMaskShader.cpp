...
HX_DEFINE_STACK_FRAME(_hx_pos_73aafbfe61e7642d_48_new,"openfl.display._internal.Context3DMaskShader","new",0x66ce53a7,"openfl.display._internal.Context3DMaskShader.new","openfl/display/_internal/Context3DMaskShader.hx",48,0x590f976c)
HX_LOCAL_STACK_FRAME(_hx_pos_73aafbfe61e7642d_13_boot,"openfl.display._internal.Context3DMaskShader","boot",0x85d3df0b,"openfl.display._internal.Context3DMaskShader.boot","openfl/display/_internal/Context3DMaskShader.hx",13,0x590f976c)
namespace openfl{
namespace display{
namespace _internal{

void Context3DMaskShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_73aafbfe61e7642d_48_new)
...
HXLINE(  11)		this->_hx___isGenerated = true;
HXDLIN(  11)		this->_hx___initGL();
            	}
...
{
{
            	HX_GC_STACKFRAME(&_hx_pos_73aafbfe61e7642d_13_boot)
HXDLIN(  13)		opaqueBitmapData =  ::openfl::display::BitmapData_obj::__alloc( HX_CTX ,1,1,false,0);
            	}
}
