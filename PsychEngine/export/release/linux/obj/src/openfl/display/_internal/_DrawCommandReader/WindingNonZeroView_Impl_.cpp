...
HX_LOCAL_STACK_FRAME(_hx_pos_72329a7b963b298a_1029__new,"openfl.display._internal._DrawCommandReader.WindingNonZeroView_Impl_","_new",0xf242e308,"openfl.display._internal._DrawCommandReader.WindingNonZeroView_Impl_._new","openfl/display/_internal/DrawCommandReader.hx",1029,0x29f77eb3)
namespace openfl{
namespace display{
namespace _internal{
...
bool WindingNonZeroView_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::display::_internal::DrawCommandReader WindingNonZeroView_Impl__obj::_new( ::openfl::display::_internal::DrawCommandReader d){
            	HX_STACKFRAME(&_hx_pos_72329a7b963b298a_1029__new)
HXDLIN(1029)		return d;
            	}
