...
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_330___dispatchResponseStatus,"openfl.net.URLLoader","__dispatchResponseStatus",0x127175c8,"openfl.net.URLLoader.__dispatchResponseStatus","openfl/net/URLLoader.hx",330,0x11daec0d)
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_349___dispatchStatus,"openfl.net.URLLoader","__dispatchStatus",0xadb63f67,"openfl.net.URLLoader.__dispatchStatus","openfl/net/URLLoader.hx",349,0x11daec0d)
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_356___prepareRequest,"openfl.net.URLLoader","__prepareRequest",0x68321263,"openfl.net.URLLoader.__prepareRequest","openfl/net/URLLoader.hx",356,0x11daec0d)
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_410_httpRequest_onError,"openfl.net.URLLoader","httpRequest_onError",0x8f111376,"openfl.net.URLLoader.httpRequest_onError","openfl/net/URLLoader.hx",410,0x11daec0d)
HX_LOCAL_STACK_FRAME(_hx_pos_4a9fdaaca9dd41d2_445_httpRequest_onProgress,"openfl.net.URLLoader","httpRequest_onProgress",0xf5cd30bf,"openfl.net.URLLoader.httpRequest_onProgress","openfl/net/URLLoader.hx",445,0x11daec0d)
namespace openfl{
namespace net{
...
HXLINE( 300)				_gthis->_hx___dispatchResponseStatus();
...
HXLINE( 318)				_gthis->_hx___dispatchResponseStatus();
HXLINE( 319)				_gthis->_hx___dispatchStatus();
HXLINE( 320)				_gthis->data = data;
HXLINE( 322)				 ::openfl::events::Event event =  ::openfl::events::Event_obj::__alloc( HX_CTX ,HX_("complete",b9,00,c8,7f),null(),null());
HXLINE( 323)				_gthis->dispatchEvent(event);
            			}
            			HX_END_LOCAL_FUNC1((void))

HXLINE( 310)			 ::lime::net::_HTTPRequest_String httpRequest1 =  ::lime::net::_HTTPRequest_String_obj::__alloc( HX_CTX ,null());
HXLINE( 311)			this->_hx___prepareRequest(httpRequest1,request);
HXLINE( 313)			httpRequest1->load(null())->onProgress(this->httpRequest_onProgress_dyn())->onError(this->httpRequest_onError_dyn())->onComplete( ::Dynamic(new _hx_Closure_1(_gthis)));
            		}
            	}
...
void URLLoader_obj::_hx___dispatchResponseStatus(){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_330___dispatchResponseStatus)
HXLINE( 331)		 ::openfl::events::HTTPStatusEvent responseStatusEvent =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,HX_("httpResponseStatus",3b,ae,f6,61),false,false,this->_hx___httpRequest->__Field(HX_("responseStatus",93,60,a4,78),::hx::paccDynamic),null());
HXLINE( 332)		responseStatusEvent->responseURL = ( (::String)(this->_hx___httpRequest->__Field(HX_("uri",6c,2b,59,00),::hx::paccDynamic)) );
HXLINE( 334)		::Array< ::Dynamic> headers = ::Array_obj< ::Dynamic>::__new();
...
HXLINE( 344)		responseStatusEvent->responseHeaders = headers;
HXLINE( 345)		this->dispatchEvent(responseStatusEvent);
            	}
...
void URLLoader_obj::_hx___dispatchStatus(){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_349___dispatchStatus)
HXLINE( 350)		 ::openfl::events::HTTPStatusEvent statusEvent =  ::openfl::events::HTTPStatusEvent_obj::__alloc( HX_CTX ,HX_("httpStatus",da,4c,74,0a),false,false,this->_hx___httpRequest->__Field(HX_("responseStatus",93,60,a4,78),::hx::paccDynamic),null());
HXLINE( 351)		this->dispatchEvent(statusEvent);
            	}
...
void URLLoader_obj::_hx___prepareRequest(::Dynamic httpRequest, ::openfl::net::URLRequest request){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_356___prepareRequest)
HXLINE( 358)		this->_hx___httpRequest = httpRequest;
HXLINE( 359)		this->_hx___httpRequest->__SetField(HX_("uri",6c,2b,59,00),request->url,::hx::paccDynamic);
HXLINE( 360)		this->_hx___httpRequest->__SetField(HX_("method",e1,f6,5a,09),request->method,::hx::paccDynamic);
HXLINE( 362)		if (::hx::IsNotNull( request->data )) {
HXLINE( 364)			if (::hx::IsPointerEq( ::Type_obj::_hx_typeof(request->data),::ValueType_obj::TObject_dyn() )) {
HXLINE( 366)				::Array< ::String > fields = ::Reflect_obj::fields(request->data);
HXLINE( 368)				{
HXLINE( 368)					int _g = 0;
HXDLIN( 368)					while((_g < fields->length)){
HXLINE( 368)						::String field = fields->__get(_g);
HXDLIN( 368)						_g = (_g + 1);
HXLINE( 370)						{
HXLINE( 370)							::Dynamic this1 =  ::Dynamic(this->_hx___httpRequest->__Field(HX_("formData",8e,d5,80,56),::hx::paccDynamic));
HXDLIN( 370)							( ( ::haxe::ds::StringMap)(this1) )->set(field,::Reflect_obj::field(request->data,field));
            						}
            					}
            				}
            			}
            			else {
HXLINE( 373)				if (::Std_obj::isOfType(request->data,::hx::ClassOf< ::haxe::io::Bytes >())) {
HXLINE( 375)					this->_hx___httpRequest->__SetField(HX_("data",2a,56,63,42),request->data,::hx::paccDynamic);
            				}
            				else {
HXLINE( 379)					::String _hx_tmp = ::Std_obj::string(request->data);
HXDLIN( 379)					this->_hx___httpRequest->__SetField(HX_("data",2a,56,63,42),::haxe::io::Bytes_obj::ofString(_hx_tmp,null()),::hx::paccDynamic);
            				}
            			}
            		}
HXLINE( 383)		this->_hx___httpRequest->__SetField(HX_("contentType",93,3c,7b,2a),request->contentType,::hx::paccDynamic);
HXLINE( 385)		if (::hx::IsNotNull( request->requestHeaders )) {
HXLINE( 387)			int _g1 = 0;
HXDLIN( 387)			::Array< ::Dynamic> _g2 = request->requestHeaders;
HXDLIN( 387)			while((_g1 < _g2->length)){
HXLINE( 387)				 ::openfl::net::URLRequestHeader header = _g2->__get(_g1).StaticCast<  ::openfl::net::URLRequestHeader >();
HXDLIN( 387)				_g1 = (_g1 + 1);
HXLINE( 389)				::Array< ::Dynamic> _hx_tmp1 = ( (::Array< ::Dynamic>)(this->_hx___httpRequest->__Field(HX_("headers",46,52,08,63),::hx::paccDynamic)) );
HXDLIN( 389)				_hx_tmp1->push( ::lime::net::HTTPRequestHeader_obj::__alloc( HX_CTX ,header->name,header->value));
            			}
            		}
HXLINE( 393)		this->_hx___httpRequest->__SetField(HX_("followRedirects",26,5a,40,75),request->followRedirects,::hx::paccDynamic);
HXLINE( 394)		this->_hx___httpRequest->__SetField(HX_("timeout",a1,1a,f7,d8),::Std_obj::_hx_int(request->idleTimeout),::hx::paccDynamic);
HXLINE( 396)		this->_hx___httpRequest->__SetField(HX_("manageCookies",6a,1f,8f,bc),request->manageCookies,::hx::paccDynamic);
HXLINE( 400)		::String userAgent = request->userAgent;
HXLINE( 401)		if (::hx::IsNull( userAgent )) {
HXLINE( 401)			userAgent = HX_("Mozilla/5.0 (Windows; U; en) AppleWebKit/420+ (KHTML, like Gecko) OpenFL/1.0",2f,7c,ab,e1);
            		}
HXLINE( 403)		this->_hx___httpRequest->__SetField(HX_("userAgent",7a,f0,12,c8),request->userAgent,::hx::paccDynamic);
HXLINE( 404)		this->_hx___httpRequest->__SetField(HX_("enableResponseHeaders",82,32,47,05),true,::hx::paccDynamic);
            	}
...
void URLLoader_obj::httpRequest_onError( ::Dynamic error){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_410_httpRequest_onError)
HXLINE( 411)		this->_hx___dispatchResponseStatus();
HXLINE( 412)		this->_hx___dispatchStatus();
HXLINE( 416)		if (::Std_obj::isOfType(this->_hx___httpRequest,::hx::ClassOf< ::lime::net::_HTTPRequest_Bytes >())) {
HXLINE( 418)			 ::lime::net::_HTTPRequest_Bytes bytesRequest = ( ( ::lime::net::_HTTPRequest_Bytes)(this->_hx___httpRequest) );
HXLINE( 419)			this->data = bytesRequest->responseData;
            		}
            		else {
HXLINE( 421)			if (::Std_obj::isOfType(this->_hx___httpRequest,::hx::ClassOf< ::lime::net::_HTTPRequest_String >())) {
HXLINE( 423)				 ::lime::net::_HTTPRequest_String stringRequest = ( ( ::lime::net::_HTTPRequest_String)(this->_hx___httpRequest) );
HXLINE( 424)				this->data = stringRequest->responseData;
            			}
            		}
HXLINE( 429)		if (::hx::IsEq( error,403 )) {
HXLINE( 431)			 ::openfl::events::SecurityErrorEvent event =  ::openfl::events::SecurityErrorEvent_obj::__alloc( HX_CTX ,HX_("securityError",e8,28,7c,a2),null(),null(),null(),null());
HXLINE( 432)			event->text = ::Std_obj::string(error);
HXLINE( 433)			this->dispatchEvent(event);
            		}
            		else {
HXLINE( 438)			 ::openfl::events::IOErrorEvent event1 =  ::openfl::events::IOErrorEvent_obj::__alloc( HX_CTX ,HX_("ioError",02,fe,41,76),null(),null(),null(),null());
HXLINE( 439)			event1->text = ::Std_obj::string(error);
HXLINE( 440)			this->dispatchEvent(event1);
            		}
            	}
...
void URLLoader_obj::httpRequest_onProgress(int bytesLoaded,int bytesTotal){
            	HX_GC_STACKFRAME(&_hx_pos_4a9fdaaca9dd41d2_445_httpRequest_onProgress)
HXLINE( 446)		 ::openfl::events::ProgressEvent event =  ::openfl::events::ProgressEvent_obj::__alloc( HX_CTX ,HX_("progress",ad,f7,2a,86),null(),null(),null(),null());
HXLINE( 447)		event->bytesLoaded = ( (Float)(bytesLoaded) );
HXLINE( 448)		event->bytesTotal = ( (Float)(bytesTotal) );
