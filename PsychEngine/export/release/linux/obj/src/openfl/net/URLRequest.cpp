...
HX_DEFINE_STACK_FRAME(_hx_pos_d7a2132659cec934_347_new,"openfl.net.URLRequest","new",0xe13767c1,"openfl.net.URLRequest.new","openfl/net/URLRequest.hx",347,0xe997cd0d)
namespace openfl{
namespace net{

void URLRequest_obj::__construct(::String url){
            	HX_STACKFRAME(&_hx_pos_d7a2132659cec934_347_new)
HXLINE( 348)		if (::hx::IsNotNull( url )) {
HXLINE( 350)			this->url = url;
            		}
HXLINE( 353)		this->contentType = null();
HXLINE( 354)		this->followRedirects = ::openfl::net::URLRequestDefaults_obj::followRedirects;
HXLINE( 356)		if ((::openfl::net::URLRequestDefaults_obj::idleTimeout > 0)) {
HXLINE( 358)			this->idleTimeout = ::openfl::net::URLRequestDefaults_obj::idleTimeout;
            		}
            		else {
HXLINE( 365)			this->idleTimeout = ( (Float)(30000) );
            		}
HXLINE( 369)		this->manageCookies = ::openfl::net::URLRequestDefaults_obj::manageCookies;
HXLINE( 370)		this->method = HX_("GET",76,1c,36,00);
HXLINE( 371)		this->requestHeaders = ::Array_obj< ::Dynamic>::__new(0);
HXLINE( 372)		this->userAgent = ::openfl::net::URLRequestDefaults_obj::userAgent;
            	}
