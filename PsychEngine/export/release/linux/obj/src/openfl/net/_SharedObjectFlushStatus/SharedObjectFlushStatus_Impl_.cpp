...
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_26_fromString,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","fromString",0x2501bd23,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.fromString","openfl/net/SharedObjectFlushStatus.hx",26,0x3756667d)
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_36_toString,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","toString",0x6f407df4,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.toString","openfl/net/SharedObjectFlushStatus.hx",36,0x3756667d)
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_16_boot,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","boot",0x7caaed7a,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.boot","openfl/net/SharedObjectFlushStatus.hx",16,0x3756667d)
HX_LOCAL_STACK_FRAME(_hx_pos_af97a71a2edef249_22_boot,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_","boot",0x7caaed7a,"openfl.net._SharedObjectFlushStatus.SharedObjectFlushStatus_Impl_.boot","openfl/net/SharedObjectFlushStatus.hx",22,0x3756667d)
namespace openfl{
namespace net{
...
bool SharedObjectFlushStatus_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Dynamic SharedObjectFlushStatus_Impl__obj::fromString(::String value){
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_26_fromString)
...
::String SharedObjectFlushStatus_Impl__obj::toString( ::Dynamic this1){
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_36_toString)
HXDLIN(  36)		 ::Dynamic _hx_switch_0 = this1;
            		if (  (_hx_switch_0==0) ){
HXLINE(  38)			return HX_("flushed",23,f4,4c,6a);
HXDLIN(  38)			goto _hx_goto_2;
            		}
            		if (  (_hx_switch_0==1) ){
HXLINE(  39)			return HX_("pending",57,98,ec,2b);
...
{
{
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_16_boot)
HXDLIN(  16)		FLUSHED = 0;
            	}
{
            	HX_STACKFRAME(&_hx_pos_af97a71a2edef249_22_boot)
HXDLIN(  22)		PENDING = 1;
            	}
}
