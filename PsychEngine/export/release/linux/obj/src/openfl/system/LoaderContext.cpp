...
HX_DEFINE_STACK_FRAME(_hx_pos_b514a9552a6ee0e8_421_new,"openfl.system.LoaderContext","new",0xca9b9c4d,"openfl.system.LoaderContext.new","openfl/system/LoaderContext.hx",421,0x3ddfdde3)
namespace openfl{
...
void LoaderContext_obj::__construct(::hx::Null< bool >  __o_checkPolicyFile, ::openfl::_hx_system::ApplicationDomain applicationDomain, ::openfl::_hx_system::SecurityDomain securityDomain){
            	...
            	HX_STACKFRAME(&_hx_pos_b514a9552a6ee0e8_421_new)
HXLINE( 422)		this->checkPolicyFile = checkPolicyFile;
HXLINE( 423)		this->securityDomain = securityDomain;
HXLINE( 424)		this->applicationDomain = applicationDomain;
HXLINE( 426)		this->allowCodeImport = true;
HXLINE( 427)		this->allowLoadBytesCodeExecution = true;
            	}
