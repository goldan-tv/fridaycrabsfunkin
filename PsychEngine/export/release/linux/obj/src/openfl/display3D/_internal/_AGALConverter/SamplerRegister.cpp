...
HX_DEFINE_STACK_FRAME(_hx_pos_a874bbe07b70b430_863_new,"openfl.display3D._internal._AGALConverter.SamplerRegister","new",0xc3c1dbca,"openfl.display3D._internal._AGALConverter.SamplerRegister.new","openfl/display3D/_internal/AGALConverter.hx",863,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_882_toGLSL,"openfl.display3D._internal._AGALConverter.SamplerRegister","toGLSL",0x9ac3cbcf,"openfl.display3D._internal._AGALConverter.SamplerRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",882,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_888_toSamplerState,"openfl.display3D._internal._AGALConverter.SamplerRegister","toSamplerState",0xa31d9ada,"openfl.display3D._internal._AGALConverter.SamplerRegister.toSamplerState","openfl/display3D/_internal/AGALConverter.hx",888,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_866_parse,"openfl.display3D._internal._AGALConverter.SamplerRegister","parse",0xc0ecca1d,"openfl.display3D._internal._AGALConverter.SamplerRegister.parse","openfl/display3D/_internal/AGALConverter.hx",866,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_a874bbe07b70b430_850_boot,"openfl.display3D._internal._AGALConverter.SamplerRegister","boot",0x7df77588,"openfl.display3D._internal._AGALConverter.SamplerRegister.boot","openfl/display3D/_internal/AGALConverter.hx",850,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void SamplerRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_863_new)
            	}
...
::String SamplerRegister_obj::toGLSL(){
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_882_toGLSL)
HXLINE( 883)		::String str = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXDLIN( 883)		::String str1 = (str + this->n);
HXLINE( 884)		return str1;
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toGLSL,return )
 ...
 ::openfl::display::_internal::SamplerState SamplerRegister_obj::toSamplerState(){
            	HX_GC_STACKFRAME(&_hx_pos_a874bbe07b70b430_888_toSamplerState)
HXLINE( 889)		 ::Dynamic wrap;
HXLINE( 890)		 ::Dynamic filter;
HXLINE( 891)		 ::Dynamic mipfilter;
HXLINE( 896)		switch((int)(this->f)){
            			case (int)0: {
HXLINE( 899)				filter = 5;
            			}
            			break;
...
HXLINE( 901)				filter = 4;
            			...
            			break;
            			default:{
HXLINE( 903)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 907)		switch((int)(this->m)){
            			case (int)0: {
HXLINE( 911)				mipfilter = 2;
            			}
            			break;
            			case (int)1: {
HXLINE( 914)				mipfilter = 1;
            			}
            			break;
            			case (int)2: {
HXLINE( 917)				mipfilter = 0;
            			}
            			break;
            			default:{
HXLINE( 919)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 925)		switch((int)(this->w)){
            			case (int)0: {
HXLINE( 928)				wrap = 0;
            			}
            			break;
...
HXLINE( 930)				wrap = 2;
            			...
            			break;
            			default:{
HXLINE( 932)				HX_STACK_DO_THROW( ::openfl::errors::IllegalOperationError_obj::__alloc( HX_CTX ,null()));
            			}
            		}
HXLINE( 935)		bool ignoreSampler = ((this->s & 4) == 4);
HXLINE( 936)		bool centroid = ((this->s & 1) == 1);
HXLINE( 937)		bool textureAlpha = (this->t == 2);
HXLINE( 940)		Float lodBias = (( (Float)(((this->b << 24) >> 24)) ) / ((Float)8.0));
HXLINE( 942)		return  ::openfl::display::_internal::SamplerState_obj::__alloc( HX_CTX ,wrap,filter,mipfilter,lodBias,ignoreSampler,centroid,textureAlpha);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(SamplerRegister_obj,toSamplerState,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::SamplerRegister SamplerRegister_obj::parse(::cpp::Int64 v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType){
            	HX_GC_STACKFRAME(&_hx_pos_a874bbe07b70b430_866_parse)
HXLINE( 867)		 ::openfl::display3D::_internal::_AGALConverter::SamplerRegister sr =  ::openfl::display3D::_internal::_AGALConverter::SamplerRegister_obj::__alloc( HX_CTX );
HXLINE( 868)		sr->programType = programType;
HXLINE( 869)		sr->f = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,60),( (::cpp::Int64)(15) )));
HXLINE( 870)		sr->m = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,56),( (::cpp::Int64)(15) )));
HXLINE( 871)		sr->w = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,52),( (::cpp::Int64)(15) )));
HXLINE( 872)		sr->s = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,48),( (::cpp::Int64)(15) )));
HXLINE( 873)		sr->d = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,44),( (::cpp::Int64)(15) )));
HXLINE( 874)		sr->t = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,40),( (::cpp::Int64)(15) )));
HXLINE( 875)		sr->type = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,32),( (::cpp::Int64)(15) )));
HXLINE( 876)		sr->b = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,16),( (::cpp::Int64)(255) )));
HXLINE( 877)		sr->n = _hx_int64_low(_hx_int64_and(v,( (::cpp::Int64)(65535) )));
HXLINE( 878)		return sr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_a874bbe07b70b430_850_boot)
HXDLIN( 850)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
