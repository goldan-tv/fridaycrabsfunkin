...
HX_DEFINE_STACK_FRAME(_hx_pos_6326831c4b7b616c_963_new,"openfl.display3D._internal._AGALConverter.SourceRegister","new",0xa0d15d23,"openfl.display3D._internal._AGALConverter.SourceRegister.new","openfl/display3D/_internal/AGALConverter.hx",963,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_981_toGLSL,"openfl.display3D._internal._AGALConverter.SourceRegister","toGLSL",0x906ee816,"openfl.display3D._internal._AGALConverter.SourceRegister.toGLSL","openfl/display3D/_internal/AGALConverter.hx",981,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_966_parse,"openfl.display3D._internal._AGALConverter.SourceRegister","parse",0xa1e213b6,"openfl.display3D._internal._AGALConverter.SourceRegister.parse","openfl/display3D/_internal/AGALConverter.hx",966,0x4de1651d)
HX_LOCAL_STACK_FRAME(_hx_pos_6326831c4b7b616c_951_boot,"openfl.display3D._internal._AGALConverter.SourceRegister","boot",0x0e79220f,"openfl.display3D._internal._AGALConverter.SourceRegister.boot","openfl/display3D/_internal/AGALConverter.hx",951,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
...
void SourceRegister_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_963_new)
            	}
...
::String SourceRegister_obj::toGLSL(::hx::Null< bool >  __o_emitSwizzle,::hx::Null< int >  __o_offset){
            	...
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_981_toGLSL)
HXLINE( 982)		if ((this->type == 3)) {
HXLINE( 984)			if (::hx::IsPointerEq( this->programType,::openfl::display3D::_internal::_AGALConverter::ProgramType_obj::VERTEX_dyn() )) {
HXLINE( 984)				return HX_("gl_Position",63,0d,2a,e5);
            			}
            			else {
HXLINE( 984)				return HX_("gl_FragColor",d7,68,e4,21);
            			}
            		}
HXLINE( 987)		bool fullxyzw;
HXDLIN( 987)		if ((this->s == 228)) {
HXLINE( 987)			fullxyzw = (this->sourceMask == 15);
            		}
            		else {
HXLINE( 987)			fullxyzw = false;
            		}
HXLINE( 988)		::String swizzle = HX_("",00,00,00,00);
HXLINE( 990)		bool _hx_tmp;
HXDLIN( 990)		if ((this->type != 5)) {
HXLINE( 990)			_hx_tmp = !(fullxyzw);
            		}
            		else {
HXLINE( 990)			_hx_tmp = false;
            		}
HXDLIN( 990)		if (_hx_tmp) {
HXLINE( 995)			if (((this->sourceMask & 1) != 0)) {
HXLINE( 997)				switch((int)((this->s & 3))){
            					case (int)0: {
HXLINE(1000)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
            					case (int)1: {
HXLINE(1002)						swizzle = (swizzle + HX_("y",79,00,00,00));
            					}
            					break;
            					case (int)2: {
HXLINE(1004)						swizzle = (swizzle + HX_("z",7a,00,00,00));
            					}
            					break;
            					case (int)3: {
HXLINE(1006)						swizzle = (swizzle + HX_("w",77,00,00,00));
            					}
            					break;
            				}
            			}
HXLINE( 995)			if (((this->sourceMask & 2) != 0)) {
HXLINE( 997)				switch((int)(((this->s >> 2) & 3))){
            					case (int)0: {
HXLINE(1000)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE( 995)			if (((this->sourceMask & 4) != 0)) {
HXLINE( 997)				switch((int)(((this->s >> 4) & 3))){
            					case (int)0: {
HXLINE(1000)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE( 995)			if (((this->sourceMask & 8) != 0)) {
HXLINE( 997)				switch((int)(((this->s >> 6) & 3))){
            					case (int)0: {
HXLINE(1000)						swizzle = (swizzle + HX_("x",78,00,00,00));
            					}
            					break;
...
HXLINE(1012)		::String str = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->type,this->programType);
HXLINE(1014)		if ((this->d == 0)) {
HXLINE(1017)			str = (str + (this->n + offset));
            		}
            		else {
HXLINE(1022)			str = (str + this->o);
HXLINE(1023)			::String indexComponent = HX_("",00,00,00,00);
HXLINE(1024)			switch((int)(this->q)){
            				case (int)0: {
HXLINE(1027)					indexComponent = HX_("x",78,00,00,00);
            				}
            				break;
            				case (int)1: {
HXLINE(1029)					indexComponent = HX_("y",79,00,00,00);
            				}
            				break;
            				case (int)2: {
HXLINE(1031)					indexComponent = HX_("z",7a,00,00,00);
            				}
            				break;
            				case (int)3: {
HXLINE(1033)					indexComponent = HX_("w",77,00,00,00);
            				}
            				break;
            			}
HXLINE(1035)			::String indexRegister = ::openfl::display3D::_internal::AGALConverter_obj::prefixFromType(this->itype,this->programType);
HXDLIN(1035)			::String indexRegister1 = (((indexRegister + this->n) + HX_(".",2e,00,00,00)) + indexComponent);
HXLINE(1036)			str = (str + ((((HX_("[ int(",3e,aa,07,15) + indexRegister1) + HX_(") +",74,38,1f,00)) + offset) + HX_("]",5d,00,00,00)));
            		}
HXLINE(1039)		bool _hx_tmp1;
HXDLIN(1039)		if (emitSwizzle) {
HXLINE(1039)			_hx_tmp1 = (swizzle != HX_("",00,00,00,00));
            		}
            		else {
HXLINE(1039)			_hx_tmp1 = false;
            		}
HXDLIN(1039)		if (_hx_tmp1) {
HXLINE(1041)			str = (str + (HX_(".",2e,00,00,00) + swizzle));
            		}
HXLINE(1044)		return str;
            	}
...
HX_DEFINE_DYNAMIC_FUNC2(SourceRegister_obj,toGLSL,return )
 ...
 ::openfl::display3D::_internal::_AGALConverter::SourceRegister SourceRegister_obj::parse(::cpp::Int64 v, ::openfl::display3D::_internal::_AGALConverter::ProgramType programType,int sourceMask){
            	HX_GC_STACKFRAME(&_hx_pos_6326831c4b7b616c_966_parse)
HXLINE( 967)		 ::openfl::display3D::_internal::_AGALConverter::SourceRegister sr =  ::openfl::display3D::_internal::_AGALConverter::SourceRegister_obj::__alloc( HX_CTX );
HXLINE( 968)		sr->programType = programType;
HXLINE( 969)		sr->d = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,63),( (::cpp::Int64)(1) )));
HXLINE( 970)		sr->q = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,48),( (::cpp::Int64)(3) )));
HXLINE( 971)		sr->itype = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,40),( (::cpp::Int64)(15) )));
HXLINE( 972)		sr->type = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,32),( (::cpp::Int64)(15) )));
HXLINE( 973)		sr->s = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,24),( (::cpp::Int64)(255) )));
HXLINE( 974)		sr->o = _hx_int64_low(_hx_int64_and(_hx_int64_shr(v,16),( (::cpp::Int64)(255) )));
HXLINE( 975)		sr->n = _hx_int64_low(_hx_int64_and(v,( (::cpp::Int64)(65535) )));
HXLINE( 976)		sr->sourceMask = sourceMask;
HXLINE( 977)		return sr;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_6326831c4b7b616c_951_boot)
HXDLIN( 951)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
