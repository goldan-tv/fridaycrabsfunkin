...
HX_DEFINE_STACK_FRAME(_hx_pos_b60bca42a6d00202_819_new,"openfl.display3D._internal._AGALConverter.RegisterMapEntry","new",0x7bd740be,"openfl.display3D._internal._AGALConverter.RegisterMapEntry.new","openfl/display3D/_internal/AGALConverter.hx",819,0x4de1651d)
namespace openfl{
namespace display3D{
namespace _internal{
