...
HX_DEFINE_STACK_FRAME(_hx_pos_eed9e911a94343be_489_new,"openfl.events._EventDispatcher.DispatchIterator","new",0x76c2678f,"openfl.events._EventDispatcher.DispatchIterator.new","openfl/events/EventDispatcher.hx",489,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_496_copy,"openfl.events._EventDispatcher.DispatchIterator","copy",0x6c1a6da6,"openfl.events._EventDispatcher.DispatchIterator.copy","openfl/events/EventDispatcher.hx",496,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_505_hasNext,"openfl.events._EventDispatcher.DispatchIterator","hasNext",0xef22001c,"openfl.events._EventDispatcher.DispatchIterator.hasNext","openfl/events/EventDispatcher.hx",505,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_510_next,"openfl.events._EventDispatcher.DispatchIterator","next",0x735836e4,"openfl.events._EventDispatcher.DispatchIterator.next","openfl/events/EventDispatcher.hx",510,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_515_remove,"openfl.events._EventDispatcher.DispatchIterator","remove",0xb5236c75,"openfl.events._EventDispatcher.DispatchIterator.remove","openfl/events/EventDispatcher.hx",515,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_539_reset,"openfl.events._EventDispatcher.DispatchIterator","reset",0xc76e4abe,"openfl.events._EventDispatcher.DispatchIterator.reset","openfl/events/EventDispatcher.hx",539,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_548_start,"openfl.events._EventDispatcher.DispatchIterator","start",0x64b17551,"openfl.events._EventDispatcher.DispatchIterator.start","openfl/events/EventDispatcher.hx",548,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_553_stop,"openfl.events._EventDispatcher.DispatchIterator","stop",0x76b1a1f3,"openfl.events._EventDispatcher.DispatchIterator.stop","openfl/events/EventDispatcher.hx",553,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_eed9e911a94343be_480_boot,"openfl.events._EventDispatcher.DispatchIterator","boot",0x6b713623,"openfl.events._EventDispatcher.DispatchIterator.boot","openfl/events/EventDispatcher.hx",480,0xe2270714)
namespace openfl{
namespace events{
namespace _EventDispatcher{

void DispatchIterator_obj::__construct(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_489_new)
HXLINE( 490)		this->active = false;
HXLINE( 491)		this->reset(list);
            	}
...
void DispatchIterator_obj::copy(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_496_copy)
HXDLIN( 496)		if (!(this->isCopy)) {
HXLINE( 498)			this->list = this->list->copy();
HXLINE( 499)			this->isCopy = true;
            		}
            	}
...
bool DispatchIterator_obj::hasNext(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_505_hasNext)
HXDLIN( 505)		return (this->index < this->list->length);
            	}
...
HX_DEFINE_DYNAMIC_FUNC0(DispatchIterator_obj,hasNext,return )
 ...
 ::openfl::events::_EventDispatcher::Listener DispatchIterator_obj::next(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_510_next)
HXDLIN( 510)		return this->list->__get(this->index++).StaticCast<  ::openfl::events::_EventDispatcher::Listener >();
            	}
...
void DispatchIterator_obj::remove( ::openfl::events::_EventDispatcher::Listener listener,int listIndex){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_515_remove)
HXDLIN( 515)		if (this->active) {
HXLINE( 517)			if (!(this->isCopy)) {
HXLINE( 519)				if ((listIndex < this->index)) {
HXLINE( 521)					this->index--;
            				}
            			}
            			else {
HXLINE( 526)				int _g = this->index;
HXDLIN( 526)				int _g1 = this->list->length;
HXDLIN( 526)				while((_g < _g1)){
HXLINE( 526)					_g = (_g + 1);
HXDLIN( 526)					int i = (_g - 1);
HXLINE( 528)					if (::hx::IsInstanceEq( this->list->__get(i).StaticCast<  ::openfl::events::_EventDispatcher::Listener >(),listener )) {
HXLINE( 530)						this->list->removeRange(i,1);
HXLINE( 531)						goto _hx_goto_4;
            					}
            				}
            				_hx_goto_4:;
            			}
...
void DispatchIterator_obj::reset(::Array< ::Dynamic> list){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_539_reset)
HXLINE( 540)		this->list = list;
HXLINE( 542)		this->isCopy = false;
HXLINE( 543)		this->index = 0;
            	}
...
void DispatchIterator_obj::start(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_548_start)
HXDLIN( 548)		this->active = true;
            	}
...
void DispatchIterator_obj::stop(){
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_553_stop)
HXDLIN( 553)		this->active = false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_eed9e911a94343be_480_boot)
HXDLIN( 480)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
