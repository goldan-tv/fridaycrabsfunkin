...
HX_DEFINE_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_643_new,"openfl.events.MouseEvent","new",0x5c6da59e,"openfl.events.MouseEvent.new","openfl/events/MouseEvent.hx",643,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_667_clone,"openfl.events.MouseEvent","clone",0x3e8b341b,"openfl.events.MouseEvent.clone","openfl/events/MouseEvent.hx",667,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_678_toString,"openfl.events.MouseEvent","toString",0x2fb13aae,"openfl.events.MouseEvent.toString","openfl/events/MouseEvent.hx",678,0xd3783172)
...
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_693_updateAfterEvent,"openfl.events.MouseEvent","updateAfterEvent",0xc76737c9,"openfl.events.MouseEvent.updateAfterEvent","openfl/events/MouseEvent.hx",693,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_709___init,"openfl.events.MouseEvent","__init",0x61a823b2,"openfl.events.MouseEvent.__init","openfl/events/MouseEvent.hx",709,0xd3783172)
HX_LOCAL_STACK_FRAME(_hx_pos_93a9f8214e96e0e7_698___create,"openfl.events.MouseEvent","__create",0x1b813c1e,"openfl.events.MouseEvent.__create","openfl/events/MouseEvent.hx",698,0xd3783172)
...
void MouseEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_buttonDown,::hx::Null< int >  __o_delta,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< int >  __o_clickCount){
            	...
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_643_new)
HXLINE( 644)		super::__construct(type,bubbles,cancelable);
HXLINE( 646)		this->shiftKey = shiftKey;
HXLINE( 647)		this->altKey = altKey;
HXLINE( 648)		this->ctrlKey = ctrlKey;
HXLINE( 649)		this->bubbles = bubbles;
HXLINE( 650)		this->relatedObject = relatedObject;
HXLINE( 651)		this->delta = delta;
HXLINE( 652)		this->localX = localX;
HXLINE( 653)		this->localY = localY;
HXLINE( 654)		this->buttonDown = buttonDown;
HXLINE( 655)		this->commandKey = commandKey;
HXLINE( 656)		this->controlKey = controlKey;
HXLINE( 657)		this->clickCount = clickCount;
HXLINE( 659)		this->isRelatedObjectInaccessible = false;
HXLINE( 660)		this->stageX = ::Math_obj::NaN;
HXLINE( 661)		this->stageY = ::Math_obj::NaN;
HXLINE( 663)		this->_hx___updateAfterEventFlag = false;
            	}
...
bool MouseEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event MouseEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_667_clone)
HXLINE( 668)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->localX,this->localY,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->buttonDown,this->delta,this->commandKey,this->controlKey,this->clickCount);
HXLINE( 670)		event->target = this->target;
HXLINE( 671)		event->currentTarget = this->currentTarget;
HXLINE( 672)		event->eventPhase = this->eventPhase;
HXLINE( 673)		return event;
            	}


::String MouseEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_678_toString)
HXDLIN( 678)		return this->_hx___formatToString(HX_("MouseEvent",d5,bf,42,8a),::Array_obj< ::String >::fromData( _hx_array_data_094f3eac_3,11));
            	}


void MouseEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_693_updateAfterEvent)
HXDLIN( 693)		this->_hx___updateAfterEventFlag = true;
            	}
...
void MouseEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_709___init)
HXLINE( 710)		this->super::_hx___init();
HXLINE( 711)		this->shiftKey = false;
HXLINE( 712)		this->altKey = false;
HXLINE( 713)		this->ctrlKey = false;
HXLINE( 714)		this->bubbles = false;
HXLINE( 715)		this->relatedObject = null();
HXLINE( 716)		this->delta = 0;
HXLINE( 717)		this->localX = ( (Float)(0) );
HXLINE( 718)		this->localY = ( (Float)(0) );
HXLINE( 719)		this->buttonDown = false;
HXLINE( 720)		this->commandKey = false;
HXLINE( 721)		this->controlKey = false;
HXLINE( 722)		this->clickCount = 0;
HXLINE( 724)		this->isRelatedObjectInaccessible = false;
HXLINE( 725)		this->stageX = ::Math_obj::NaN;
HXLINE( 726)		this->stageY = ::Math_obj::NaN;
HXLINE( 728)		this->_hx___updateAfterEventFlag = false;
            	}
...
bool MouseEvent_obj::_hx___controlKey;
...
bool MouseEvent_obj::_hx___shiftKey;
 ...
 ::openfl::events::MouseEvent MouseEvent_obj::_hx___create(::String type,int button,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target,::hx::Null< int >  __o_delta){
            		int delta = __o_delta.Default(0);
            	HX_GC_STACKFRAME(&_hx_pos_93a9f8214e96e0e7_698___create)
HXLINE( 699)		 ::openfl::events::MouseEvent event =  ::openfl::events::MouseEvent_obj::__alloc( HX_CTX ,type,true,false,local->x,local->y,null(),::openfl::events::MouseEvent_obj::_hx___ctrlKey,::openfl::events::MouseEvent_obj::_hx___altKey,::openfl::events::MouseEvent_obj::_hx___shiftKey,::openfl::events::MouseEvent_obj::_hx___buttonDown,delta,::openfl::events::MouseEvent_obj::_hx___commandKey,::openfl::events::MouseEvent_obj::_hx___controlKey,null());
HXLINE( 701)		event->stageX = stageX;
HXLINE( 702)		event->stageY = stageY;
HXLINE( 703)		event->target = target;
HXLINE( 705)		return event;
            	}
...
::hx::ObjectPtr< MouseEvent_obj > MouseEvent_obj::__new(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_buttonDown,::hx::Null< int >  __o_delta,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< int >  __o_clickCount) {
	...
	__this->__construct(type,__o_bubbles,__o_cancelable,__o_localX,__o_localY,relatedObject,__o_ctrlKey,__o_altKey,__o_shiftKey,__o_buttonDown,__o_delta,__o_commandKey,__o_controlKey,__o_clickCount);
	return __this;
}
...
void MouseEvent_obj::__Mark(HX_MARK_PARAMS)
{
	...
	HX_MARK_MEMBER_NAME(_hx___updateAfterEventFlag,"__updateAfterEventFlag");
...
void MouseEvent_obj::__Visit(HX_VISIT_PARAMS)
{
	...
	HX_VISIT_MEMBER_NAME(_hx___updateAfterEventFlag,"__updateAfterEventFlag");
...
bool MouseEvent_obj::__GetStatic(const ::String &inName, Dynamic &outValue, ::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__controlKey") ) { outValue = ( _hx___controlKey ); return true; }
	}
	return false;
}
...
bool MouseEvent_obj::__SetStatic(const ::String &inName,Dynamic &ioValue,::hx::PropertyAccess inCallProp)
{
	...
	case 12:
		...
		if (HX_FIELD_EQ(inName,"__controlKey") ) { _hx___controlKey=ioValue.Cast< bool >(); return true; }
	}
	return false;
}
...
static ::hx::StorageInfo MouseEvent_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(MouseEvent_obj,controlKey),HX_("controlKey",42,8e,a5,04)},
	...
	{::hx::fsBool,(int)offsetof(MouseEvent_obj,_hx___updateAfterEventFlag),HX_("__updateAfterEventFlag",33,c6,de,b0)},
	{ ::hx::fsUnknown, 0, null()}
};
static ::hx::StaticInfo MouseEvent_obj_sStaticStorageInfo[] = {
	...
	{::hx::fsBool,(void *) &MouseEvent_obj::_hx___controlKey,HX_("__controlKey",62,09,39,3d)},
...
static void MouseEvent_obj_sMarkStatics(HX_MARK_PARAMS) {
	...
	HX_MARK_MEMBER_NAME(MouseEvent_obj::_hx___controlKey,"__controlKey");
...
static void MouseEvent_obj_sVisitStatics(HX_VISIT_PARAMS) {
	...
	HX_VISIT_MEMBER_NAME(MouseEvent_obj::_hx___controlKey,"__controlKey");
