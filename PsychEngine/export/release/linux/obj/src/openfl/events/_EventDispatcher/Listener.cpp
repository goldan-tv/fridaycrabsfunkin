...
HX_DEFINE_STACK_FRAME(_hx_pos_4056b9d72619ced0_576_new,"openfl.events._EventDispatcher.Listener","new",0x63be323b,"openfl.events._EventDispatcher.Listener.new","openfl/events/EventDispatcher.hx",576,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_599_match,"openfl.events._EventDispatcher.Listener","match",0xdf4e17e0,"openfl.events._EventDispatcher.Listener.match","openfl/events/EventDispatcher.hx",599,0xe2270714)
HX_LOCAL_STACK_FRAME(_hx_pos_4056b9d72619ced0_562_boot,"openfl.events._EventDispatcher.Listener","boot",0xdac6c1f7,"openfl.events._EventDispatcher.Listener.boot","openfl/events/EventDispatcher.hx",562,0xe2270714)
namespace openfl{
namespace events{
...
void Listener_obj::__construct( ::Dynamic callback,bool useCapture,int priority,bool useWeakReference){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_576_new)
HXLINE( 591)		this->callback = callback;
HXLINE( 593)		this->useCapture = useCapture;
HXLINE( 594)		this->priority = priority;
HXLINE( 595)		this->useWeakReference = useWeakReference;
            	}
...
bool Listener_obj::match( ::Dynamic callback,bool useCapture){
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_599_match)
HXLINE( 600)		 ::Dynamic resolvedCallback = this->callback;
HXLINE( 615)		if (::Reflect_obj::compareMethods(resolvedCallback,callback)) {
HXLINE( 615)			return (this->useCapture == useCapture);
            		}
            		else {
HXLINE( 615)			return false;
            		}
HXDLIN( 615)		return false;
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_4056b9d72619ced0_562_boot)
HXDLIN( 562)		__mClass->__meta__ =  ::Dynamic(::hx::Anon_obj::Create(1)
