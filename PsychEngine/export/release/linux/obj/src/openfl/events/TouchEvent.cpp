...
HX_DEFINE_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_455_new,"openfl.events.TouchEvent","new",0xe223a0c4,"openfl.events.TouchEvent.new","openfl/events/TouchEvent.hx",455,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_479_clone,"openfl.events.TouchEvent","clone",0x1a12c4c1,"openfl.events.TouchEvent.clone","openfl/events/TouchEvent.hx",479,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_490_toString,"openfl.events.TouchEvent","toString",0x9efd15c8,"openfl.events.TouchEvent.toString","openfl/events/TouchEvent.hx",490,0x2fe85d0c)
...
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_502_updateAfterEvent,"openfl.events.TouchEvent","updateAfterEvent",0xeb0abce3,"openfl.events.TouchEvent.updateAfterEvent","openfl/events/TouchEvent.hx",502,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_517___init,"openfl.events.TouchEvent","__init",0x9cbf244c,"openfl.events.TouchEvent.__init","openfl/events/TouchEvent.hx",517,0x2fe85d0c)
HX_LOCAL_STACK_FRAME(_hx_pos_a67c52c2b0f75a05_507___create,"openfl.events.TouchEvent","__create",0x8acd1738,"openfl.events.TouchEvent.__create","openfl/events/TouchEvent.hx",507,0x2fe85d0c)
...
void TouchEvent_obj::__construct(::String type,::hx::Null< bool >  __o_bubbles,::hx::Null< bool >  __o_cancelable,::hx::Null< int >  __o_touchPointID,::hx::Null< bool >  __o_isPrimaryTouchPoint,::hx::Null< Float >  __o_localX,::hx::Null< Float >  __o_localY,::hx::Null< Float >  __o_sizeX,::hx::Null< Float >  __o_sizeY,::hx::Null< Float >  __o_pressure, ::openfl::display::InteractiveObject relatedObject,::hx::Null< bool >  __o_ctrlKey,::hx::Null< bool >  __o_altKey,::hx::Null< bool >  __o_shiftKey,::hx::Null< bool >  __o_commandKey,::hx::Null< bool >  __o_controlKey,::hx::Null< Float >  __o_timestamp,::String touchIntent, ::openfl::utils::ByteArrayData samples,::hx::Null< bool >  __o_isTouchPointCanceled){
            	...
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_455_new)
HXLINE( 456)		super::__construct(type,bubbles,cancelable);
HXLINE( 458)		this->touchPointID = touchPointID;
HXLINE( 459)		this->isPrimaryTouchPoint = isPrimaryTouchPoint;
HXLINE( 460)		this->localX = localX;
HXLINE( 461)		this->localY = localY;
HXLINE( 462)		this->sizeX = sizeX;
HXLINE( 463)		this->sizeY = sizeY;
HXLINE( 464)		this->pressure = pressure;
HXLINE( 465)		this->relatedObject = relatedObject;
HXLINE( 466)		this->ctrlKey = ctrlKey;
HXLINE( 467)		this->altKey = altKey;
HXLINE( 468)		this->shiftKey = shiftKey;
HXLINE( 469)		this->commandKey = commandKey;
HXLINE( 470)		this->controlKey = controlKey;
HXLINE( 472)		this->stageX = ::Math_obj::NaN;
HXLINE( 473)		this->stageY = ::Math_obj::NaN;
HXLINE( 475)		this->_hx___updateAfterEventFlag = false;
            	}
...
bool TouchEvent_obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::openfl::events::Event TouchEvent_obj::clone(){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_479_clone)
HXLINE( 480)		 ::openfl::events::TouchEvent event =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,this->type,this->bubbles,this->cancelable,this->touchPointID,this->isPrimaryTouchPoint,this->localX,this->localY,this->sizeX,this->sizeY,this->pressure,this->relatedObject,this->ctrlKey,this->altKey,this->shiftKey,this->commandKey,this->controlKey,null(),null(),null(),null());
HXLINE( 482)		event->target = this->target;
HXLINE( 483)		event->currentTarget = this->currentTarget;
HXLINE( 484)		event->eventPhase = this->eventPhase;
HXLINE( 485)		return event;
            	}


::String TouchEvent_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_490_toString)
HXDLIN( 490)		return this->_hx___formatToString(HX_("TouchEvent",fb,af,06,66),::Array_obj< ::String >::fromData( _hx_array_data_e5132ed2_3,16));
            	}


void TouchEvent_obj::updateAfterEvent(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_502_updateAfterEvent)
HXDLIN( 502)		this->_hx___updateAfterEventFlag = true;
            	}
...
void TouchEvent_obj::_hx___init(){
            	HX_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_517___init)
HXLINE( 518)		this->super::_hx___init();
HXLINE( 519)		this->touchPointID = 0;
HXLINE( 520)		this->isPrimaryTouchPoint = false;
HXLINE( 521)		this->localX = ( (Float)(0) );
HXLINE( 522)		this->localY = ( (Float)(0) );
HXLINE( 523)		this->sizeX = ( (Float)(0) );
HXLINE( 524)		this->sizeY = ( (Float)(0) );
HXLINE( 525)		this->pressure = ( (Float)(0) );
HXLINE( 526)		this->relatedObject = null();
HXLINE( 527)		this->ctrlKey = false;
HXLINE( 528)		this->altKey = false;
HXLINE( 529)		this->shiftKey = false;
HXLINE( 530)		this->commandKey = false;
HXLINE( 531)		this->controlKey = false;
HXLINE( 533)		this->stageX = ::Math_obj::NaN;
HXLINE( 534)		this->stageY = ::Math_obj::NaN;
HXLINE( 536)		this->_hx___updateAfterEventFlag = false;
            	}
...
::String TouchEvent_obj::TOUCH_TAP;
 ...
 ::openfl::events::TouchEvent TouchEvent_obj::_hx___create(::String type, ::Dynamic touch,Float stageX,Float stageY, ::openfl::geom::Point local, ::openfl::display::InteractiveObject target){
            	HX_GC_STACKFRAME(&_hx_pos_a67c52c2b0f75a05_507___create)
HXLINE( 508)		 ::openfl::events::TouchEvent evt =  ::openfl::events::TouchEvent_obj::__alloc( HX_CTX ,type,true,false,0,true,local->x,local->y,1,1,1,null(),null(),null(),null(),null(),null(),null(),null(),null(),null());
HXLINE( 509)		evt->stageX = stageX;
HXLINE( 510)		evt->stageY = stageY;
HXLINE( 511)		evt->target = target;
HXLINE( 513)		return evt;
            	}
...
static ::hx::StorageInfo TouchEvent_obj_sMemberStorageInfo[] = {
	...
	{::hx::fsBool,(int)offsetof(TouchEvent_obj,_hx___updateAfterEventFlag),HX_("__updateAfterEventFlag",33,c6,de,b0)},
	{ ::hx::fsUnknown, 0, null()}
};
