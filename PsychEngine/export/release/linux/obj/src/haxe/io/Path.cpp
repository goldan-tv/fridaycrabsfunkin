...
HX_LOCAL_STACK_FRAME(_hx_pos_6cfed01bf295c856_123_withoutExtension,"haxe.io.Path","withoutExtension",0xb4016fa0,"haxe.io.Path.withoutExtension","/usr/share/haxe/std/haxe/io/Path.hx",123,0x457392de)
...
::String Path_obj::withoutExtension(::String path){
            	HX_GC_STACKFRAME(&_hx_pos_6cfed01bf295c856_123_withoutExtension)
...
HXLINE( 249)											acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_13,1);
            										}
            										else {
...
HXLINE( 242)								acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_14,1);
            							}
            							else {
...
HXDLIN( 249)									if (::hx::IsNull( acc->b )) {
HXLINE( 249)										acc->b = ::Array_obj< ::String >::fromData( _hx_array_data_4ec6cf05_15,1);
            									}
            									else {
HXLINE( 249)										acc->b->push(HX_("/",2f,00,00,00));
            									}
