...
HX_DEFINE_STACK_FRAME(_hx_pos_75c02f6763217556_12_new,"haxe.exceptions.PosException","new",0x9ed038cf,"haxe.exceptions.PosException.new","/usr/share/haxe/std/haxe/exceptions/PosException.hx",12,0xc5b72686)
HX_LOCAL_STACK_FRAME(_hx_pos_75c02f6763217556_25_toString,"haxe.exceptions.PosException","toString",0x179675dd,"haxe.exceptions.PosException.toString","/usr/share/haxe/std/haxe/exceptions/PosException.hx",25,0xc5b72686)
namespace haxe{
namespace exceptions{

void PosException_obj::__construct(::String message, ::haxe::Exception previous, ::Dynamic pos){
            	HX_STACKFRAME(&_hx_pos_75c02f6763217556_12_new)
HXDLIN(  12)		{
...
::String PosException_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_75c02f6763217556_25_toString)
