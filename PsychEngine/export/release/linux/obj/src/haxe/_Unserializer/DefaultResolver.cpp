...
HX_DEFINE_STACK_FRAME(_hx_pos_2772e051d7a64ef8_512_new,"haxe._Unserializer.DefaultResolver","new",0xe2809ead,"haxe._Unserializer.DefaultResolver.new","/usr/share/haxe/std/haxe/Unserializer.hx",512,0x4786e765)
HX_LOCAL_STACK_FRAME(_hx_pos_2772e051d7a64ef8_515_resolveClass,"haxe._Unserializer.DefaultResolver","resolveClass",0xbc0d3dbf,"haxe._Unserializer.DefaultResolver.resolveClass","/usr/share/haxe/std/haxe/Unserializer.hx",515,0x4786e765)
HX_LOCAL_STACK_FRAME(_hx_pos_2772e051d7a64ef8_518_resolveEnum,"haxe._Unserializer.DefaultResolver","resolveEnum",0x8198f35a,"haxe._Unserializer.DefaultResolver.resolveEnum","/usr/share/haxe/std/haxe/Unserializer.hx",518,0x4786e765)
namespace haxe{
namespace _Unserializer{

void DefaultResolver_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_2772e051d7a64ef8_512_new)
            	}
...
::hx::Class DefaultResolver_obj::resolveClass(::String name){
            	HX_STACKFRAME(&_hx_pos_2772e051d7a64ef8_515_resolveClass)
...
::hx::Class DefaultResolver_obj::resolveEnum(::String name){
            	HX_STACKFRAME(&_hx_pos_2772e051d7a64ef8_518_resolveEnum)
