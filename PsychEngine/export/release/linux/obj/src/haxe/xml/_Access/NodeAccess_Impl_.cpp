...
HX_LOCAL_STACK_FRAME(_hx_pos_8d71935c2cd8d36e_27_resolve,"haxe.xml._Access.NodeAccess_Impl_","resolve",0xc66a9d2e,"haxe.xml._Access.NodeAccess_Impl_.resolve","/usr/share/haxe/std/haxe/xml/Access.hx",27,0x4bec0b94)
namespace haxe{
namespace xml{
namespace _Access{
...
bool NodeAccess_Impl__obj::_hx_isInstanceOf(int inClassId) {
 ...
 ::Xml NodeAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_8d71935c2cd8d36e_27_resolve)
...
HXLINE(  30)					HX_STACK_DO_THROW((HX_("Bad node type, expected Element but found ",d8,90,8b,bb) + ::_Xml::XmlType_Impl__obj::toString(this1->nodeType)));
            				}
HXDLIN(  30)				xname = this1->nodeName;
            			}
HXLINE(  31)			HX_STACK_DO_THROW(((xname + HX_(" is missing element ",b4,ea,58,cb)) + name));
            		}
