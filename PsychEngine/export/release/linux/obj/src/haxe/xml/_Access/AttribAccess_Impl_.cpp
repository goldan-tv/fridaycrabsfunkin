...
HX_LOCAL_STACK_FRAME(_hx_pos_4546771e36afd27a_39_resolve,"haxe.xml._Access.AttribAccess_Impl_","resolve",0xf06df4f6,"haxe.xml._Access.AttribAccess_Impl_.resolve","/usr/share/haxe/std/haxe/xml/Access.hx",39,0x4bec0b94)
namespace haxe{
namespace xml{
namespace _Access{
...
::String AttribAccess_Impl__obj::resolve( ::Xml this1,::String name){
            	HX_STACKFRAME(&_hx_pos_4546771e36afd27a_39_resolve)
...
HXLINE(  44)				HX_STACK_DO_THROW((HX_("Bad node type, expected Element but found ",d8,90,8b,bb) + ::_Xml::XmlType_Impl__obj::toString(this1->nodeType)));
            			}
HXDLIN(  44)			HX_STACK_DO_THROW(((this1->nodeName + HX_(" is missing attribute ",54,31,39,75)) + name));
            		}
HXLINE(  45)		return v;
            	}
