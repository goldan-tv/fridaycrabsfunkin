...
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_56_toString,"haxe.Exception","toString",0x11a32013,"haxe.Exception.toString","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",56,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_60_details,"haxe.Exception","details",0x13a1b73b,"haxe.Exception.details","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",60,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_66___shiftStack,"haxe.Exception","__shiftStack",0x45445d6d,"haxe.Exception.__shiftStack","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",66,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_72___unshiftStack,"haxe.Exception","__unshiftStack",0xb32f5cc6,"haxe.Exception.__unshiftStack","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",72,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_76_get_message,"haxe.Exception","get_message",0x7b47a0d7,"haxe.Exception.get_message","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",76,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_80_get_previous,"haxe.Exception","get_previous",0x5217ff27,"haxe.Exception.get_previous","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",80,0xd6630874)
HX_LOCAL_STACK_FRAME(_hx_pos_c7e014ce41a096e9_88_get_stack,"haxe.Exception","get_stack",0xfc45ee58,"haxe.Exception.get_stack","/usr/share/haxe/std/cpp/_std/haxe/Exception.hx",88,0xd6630874)
...
::String Exception_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_56_toString)
...
::String Exception_obj::details(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_60_details)
HXDLIN(  60)		if (::hx::IsNull( this->get_previous() )) {
HXDLIN(  60)			::String _hx_tmp = (HX_("Exception: ",95,cc,ac,54) + this->toString());
HXDLIN(  60)			::Array< ::Dynamic> tmp = this->get_stack();
HXDLIN(  60)			::String _hx_tmp1;
HXDLIN(  60)			if (::hx::IsNull( tmp )) {
HXDLIN(  60)				_hx_tmp1 = HX_("null",87,9e,0e,49);
            			}
            			else {
HXDLIN(  60)				_hx_tmp1 = ::haxe::_CallStack::CallStack_Impl__obj::toString(tmp);
            			}
HXDLIN(  60)			return (_hx_tmp + _hx_tmp1);
            		}
            		else {
HXDLIN(  60)			::String result = HX_("",00,00,00,00);
HXDLIN(  60)			 ::haxe::Exception e = ::hx::ObjectPtr<OBJ_>(this);
HXDLIN(  60)			 ::haxe::Exception prev = null();
HXDLIN(  60)			while(::hx::IsNotNull( e )){
HXDLIN(  60)				if (::hx::IsNull( prev )) {
HXDLIN(  60)					::String result1 = (HX_("Exception: ",95,cc,ac,54) + e->get_message());
HXDLIN(  60)					::Array< ::Dynamic> tmp1 = e->get_stack();
HXDLIN(  60)					::String result2;
HXDLIN(  60)					if (::hx::IsNull( tmp1 )) {
HXDLIN(  60)						result2 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  60)						result2 = ::haxe::_CallStack::CallStack_Impl__obj::toString(tmp1);
            					}
HXDLIN(  60)					result = ((result1 + result2) + result);
            				}
            				else {
HXDLIN(  60)					::Array< ::Dynamic> prevStack = e->get_stack();
HXDLIN(  60)					::Array< ::Dynamic> prevStack1 = ::haxe::_CallStack::CallStack_Impl__obj::subtract(prevStack,prev->get_stack());
HXDLIN(  60)					::String result3 = (HX_("Exception: ",95,cc,ac,54) + e->get_message());
HXDLIN(  60)					::String result4;
HXDLIN(  60)					if (::hx::IsNull( prevStack1 )) {
HXDLIN(  60)						result4 = HX_("null",87,9e,0e,49);
            					}
            					else {
HXDLIN(  60)						result4 = ::haxe::_CallStack::CallStack_Impl__obj::toString(prevStack1);
            					}
HXDLIN(  60)					result = (((result3 + result4) + HX_("\n\nNext ",ed,7e,c7,cb)) + result);
            				}
HXDLIN(  60)				prev = e;
HXDLIN(  60)				e = e->get_previous();
            			}
...
void Exception_obj::_hx___shiftStack(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_66___shiftStack)
...
void Exception_obj::_hx___unshiftStack(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_72___unshiftStack)
...
::String Exception_obj::get_message(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_76_get_message)
...
HX_DEFINE_DYNAMIC_FUNC0(Exception_obj,get_message,return )
 ...
 ::haxe::Exception Exception_obj::get_previous(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_80_get_previous)
HXDLIN(  80)		return this->_hx___previousException;
            	}
...
::Array< ::Dynamic> Exception_obj::get_stack(){
            	HX_STACKFRAME(&_hx_pos_c7e014ce41a096e9_88_get_stack)
