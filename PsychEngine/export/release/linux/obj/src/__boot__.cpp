...
#endif
#ifndef INCLUDED___ASSET__flxanimate_images_indicator_png
#include <__ASSET__flxanimate_images_indicator_png.h>
#endif
#ifndef INCLUDED___ASSET__flxanimate_images_pivot_png
#include <__ASSET__flxanimate_images_pivot_png.h>
#endif
...
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_arrow_up_png
#include <__ASSET__assets_embed_images_psych_ui_arrow_up_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_dropdown_button_png
#include <__ASSET__assets_embed_images_psych_ui_dropdown_button_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_radio_png
#include <__ASSET__assets_embed_images_psych_ui_radio_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_stepper_minus_png
#include <__ASSET__assets_embed_images_psych_ui_stepper_minus_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_arrow_down_png
#include <__ASSET__assets_embed_images_psych_ui_arrow_down_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_checkbox_png
#include <__ASSET__assets_embed_images_psych_ui_checkbox_png.h>
#endif
#ifndef INCLUDED___ASSET__assets_embed_images_psych_ui_stepper_plus_png
#include <__ASSET__assets_embed_images_psych_ui_stepper_plus_png.h>
#endif
...
::states::stages::objects::SpraycanState_obj::__register();
...
::objects::Alignment_obj::__register();
...
::flxanimate::data::LayerType_obj::__register();
::flxanimate::data::SymbolT_obj::__register();
::flxanimate::data::Loop_obj::__register();
::flxanimate::data::ColorEffect_obj::__register();
...
::crowplexus::iris::ErrorSeverity_obj::__register();
...
::states::stages::objects::TankmenBG_obj::__register();
::states::editors::content::VSlice_obj::__register();
::states::editors::content::MetaNote_obj::__register();
::states::editors::WeekEditorState_obj::__register();
::states::editors::NoteSplashEditorState_obj::__register();
...
::psychlua::FunkinLua_obj::__register();
::psychlua::CustomSubstate_obj::__register();
::options::OptionsState_obj::__register();
::options::ControlsSubState_obj::__register();
...
::objects::NoteSplash_obj::__register();
::objects::Note_obj::__register();
::objects::MenuCharacter_obj::__register();
::objects::Character_obj::__register();
::objects::Alphabet_obj::__register();
...
::flxanimate::motion::DynamicMatrix_obj::__register();
::flxanimate::motion::AdjustColor_obj::__register();
::openfl::geom::Matrix3D_obj::__register();
::flxanimate::frames::FlxAnimateFrames_obj::__register();
::flxanimate::format::PropertyList_obj::__register();
::flxanimate::filters::GradientGlowFilter_obj::__register();
::flxanimate::filters::GradientBevelFilter_obj::__register();
::flxanimate::filters::BevelFilter_obj::__register();
::flxanimate::animate::FlxElement_obj::__register();
...
::cutscenes::DialogueCharacter_obj::__register();
::cutscenes::DialogueBoxPsych_obj::__register();
::crowplexus::iris::utils::Ansi_obj::__register();
::crowplexus::iris::Iris_obj::__register();
::crowplexus::iris::ErrorSeverityTools_obj::__register();
::backend::ui::PsychUISlider_obj::__register();
::backend::ui::PsychUIRadioGroup_obj::__register();
::backend::ui::PsychUINumericStepper_obj::__register();
::backend::ui::PsychUIDropDownMenu_obj::__register();
::backend::ui::PsychUIInputText_obj::__register();
::backend::ui::PsychUICheckBox_obj::__register();
::backend::ui::PsychUIButton_obj::__register();
::backend::ui::PsychUIBox_obj::__register();
...
::backend::Language_obj::__register();
...
::backend::Achievements_obj::__register();
::backend::ALSoftConfig_obj::__register();
::Xml_obj::__register();
::haxe::SysTools_obj::__register();
::openfl::text::Font_obj::__register();
::__ASSET__flxanimate_images_indicator_png_obj::__register();
::__ASSET__flxanimate_images_pivot_png_obj::__register();
...
::__ASSET__assets_embed_images_psych_ui_arrow_up_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_dropdown_button_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_radio_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_stepper_minus_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_arrow_down_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_checkbox_png_obj::__register();
::__ASSET__assets_embed_images_psych_ui_stepper_plus_png_obj::__register();
...
::substates::ResetScoreSubState_obj::__register();
::states::stages::objects::SpraycanAtlasSprite_obj::__register();
::states::stages::objects::PicoBlazinHandler_obj::__register();
::states::stages::objects::PhillyTrain_obj::__register();
::states::stages::objects::PhillyGlowParticle_obj::__register();
::states::stages::objects::PhillyGlowGradient_obj::__register();
::states::stages::objects::MallCrowd_obj::__register();
::states::stages::objects::DarnellBlazinHandler_obj::__register();
::states::stages::objects::DadBattleFog_obj::__register();
::states::stages::objects::BackgroundTank_obj::__register();
::states::stages::objects::BackgroundGirls_obj::__register();
::states::stages::objects::BackgroundDancer_obj::__register();
::states::stages::objects::ABotSpeaker_obj::__register();
::states::stages::Tank_obj::__register();
::states::stages::StageWeek1_obj::__register();
::states::stages::Spooky_obj::__register();
::states::stages::SchoolEvil_obj::__register();
::states::stages::School_obj::__register();
::states::stages::PhillyStreets_obj::__register();
::states::stages::PhillyBlazin_obj::__register();
::states::stages::Philly_obj::__register();
::states::stages::MallEvil_obj::__register();
::states::stages::Mall_obj::__register();
::states::stages::Limo_obj::__register();
::states::editors::content::PsychJsonPrinter_obj::__register();
::states::editors::content::ExitConfirmationPrompt_obj::__register();
::states::editors::content::Prompt_obj::__register();
::states::editors::content::BasePrompt_obj::__register();
::states::editors::content::PreloadListSubState_obj::__register();
::states::editors::content::EventMetaNote_obj::__register();
::states::editors::content::FileReferenceCustom_obj::__register();
::states::editors::content::FileDialogHandler_obj::__register();
::states::editors::content::EditorPlayState_obj::__register();
::states::editors::content::ChartingGridSprite_obj::__register();
::states::editors::WeekEditorFreeplayState_obj::__register();
::states::editors::StageEditorAnimationSubstate_obj::__register();
::states::editors::StageEditorMetaSprite_obj::__register();
::states::editors::StageEditorState_obj::__register();
::states::editors::NoteSplashEditorHelpSubState_obj::__register();
::states::editors::MenuCharacterEditorState_obj::__register();
::states::editors::MasterEditorMenu_obj::__register();
::states::editors::CharacterEditorState_obj::__register();
::states::MenuButton_obj::__register();
::states::ModItem_obj::__register();
::states::ModsMenuState_obj::__register();
...
::shaders::RGBShaderReference_obj::__register();
::shaders::RGBPalette_obj::__register();
::shaders::ErrorHandledRuntimeShader_obj::__register();
::shaders::ErrorHandledShader_obj::__register();
::shaders::IErrorHandler_obj::__register();
::shaders::ColorSwapShader_obj::__register();
::shaders::ColorSwap_obj::__register();
::psychlua::TextFunctions_obj::__register();
::psychlua::ShaderFunctions_obj::__register();
::psychlua::ModchartSprite_obj::__register();
::psychlua::ModchartAnimateSprite_obj::__register();
::psychlua::CustomInterp_obj::__register();
::psychlua::HScript_obj::__register();
::psychlua::FlxAnimateFunctions_obj::__register();
::psychlua::ExtraFunctions_obj::__register();
::psychlua::DeprecatedFunctions_obj::__register();
::psychlua::DebugLuaText_obj::__register();
::psychlua::CallbackHandler_obj::__register();
::options::VisualsSettingsSubState_obj::__register();
::options::Option_obj::__register();
::options::NotesColorSubState_obj::__register();
::options::NoteOffsetState_obj::__register();
::options::ModSettingsSubState_obj::__register();
::options::LanguageSubState_obj::__register();
::options::GraphicsSettingsSubState_obj::__register();
::options::GameplaySettingsSubState_obj::__register();
::options::GameplayOption_obj::__register();
::options::GameplayChangersSubstate_obj::__register();
::options::BaseOptionsMenu_obj::__register();
...
::objects::VideoSprite_obj::__register();
...
::objects::MusicPlayer_obj::__register();
::objects::MenuItem_obj::__register();
::objects::HealthIcon_obj::__register();
::objects::CheckboxThingie_obj::__register();
::objects::Bar_obj::__register();
::objects::BGSprite_obj::__register();
::objects::AttachedText_obj::__register();
::objects::AttachedSprite_obj::__register();
::objects::AlphaCharacter_obj::__register();
::objects::AchievementPopup_obj::__register();
...
::flxanimate::zip::Zip_obj::__register();
::flxanimate::motion::ColorMatrix_obj::__register();
::flxanimate::geom::FlxMatrix3D_obj::__register();
::flxanimate::filters::MaskShader_obj::__register();
::flxanimate::filters::_GradientGlowFilter::FullCombineShader_obj::__register();
::flxanimate::filters::_GradientGlowFilter::ColorRatioShader_obj::__register();
...
::flxanimate::filters::_GradientBevelFilter::ColorRatioBevelShader_obj::__register();
::flxanimate::filters::_BevelFilter::InnerCombineShader_obj::__register();
::flxanimate::filters::_BevelFilter::FullCombineShader_obj::__register();
::openfl::display::_ShaderData::ShaderData_Impl__obj::__register();
::flxanimate::filters::_BevelFilter::CombineShader_obj::__register();
::flxanimate::filters::_BevelFilter::BevelShader_obj::__register();
::openfl::filters::BitmapFilterShader_obj::__register();
::openfl::filters::BitmapFilter_obj::__register();
::flxanimate::effects::FlxTint_obj::__register();
::flxanimate::effects::FlxBrightness_obj::__register();
::flxanimate::effects::FlxAlpha_obj::__register();
::flxanimate::effects::FlxAdvanced_obj::__register();
::flxanimate::effects::FlxColorEffect_obj::__register();
::flxanimate::display::FlxAnimateFilterRenderer_obj::__register();
::flxanimate::data::_SpriteMapData::Meta_Impl__obj::__register();
::flxanimate::data::MacroAnimationData_obj::__register();
::flxanimate::data::_AnimationData::AtlasSymbolInstance_Impl__obj::__register();
::flxanimate::data::_AnimationData::Bitmap_Impl__obj::__register();
::flxanimate::data::_AnimationData::GradientEntry_Impl__obj::__register();
::flxanimate::data::_AnimationData::GradientFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::BevelFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::DropShadowFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::GlowFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::BlurFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::AdjustColorFilter_Impl__obj::__register();
::flxanimate::data::_AnimationData::Filters_Impl__obj::__register();
::flxanimate::data::_AnimationData::ColorEffects_Impl__obj::__register();
::flxanimate::data::_AnimationData::SymbolInstance_Impl__obj::__register();
::flxanimate::data::_AnimationData::Element_Impl__obj::__register();
::flxanimate::data::_AnimationData::Frame_Impl__obj::__register();
::flxanimate::data::_AnimationData::MetaData_Impl__obj::__register();
::flxanimate::data::_AnimationData::Layers_Impl__obj::__register();
::flxanimate::data::_AnimationData::Timeline_Impl__obj::__register();
::flxanimate::data::_AnimationData::SymbolData_Impl__obj::__register();
::flxanimate::data::_AnimationData::StageInstance_Impl__obj::__register();
::flxanimate::data::_AnimationData::Animation_Impl__obj::__register();
::flxanimate::data::_AnimationData::SymbolDictionary_Impl__obj::__register();
::flxanimate::data::_AnimationData::AnimAtlas_Impl__obj::__register();
::flxanimate::data::AnimationData_obj::__register();
::flxanimate::animate::SymbolParameters_obj::__register();
::flxanimate::animate::FlxTimeline_obj::__register();
::flxanimate::animate::FlxSymbolDictionary_obj::__register();
::flxanimate::animate::FlxSymbol_obj::__register();
::flxanimate::animate::FlxLayer_obj::__register();
::flxanimate::interfaces::IFilterable_obj::__register();
::flxanimate::animate::FlxLabel_obj::__register();
::flxanimate::animate::FlxKeyFrame_obj::__register();
::flxanimate::animate::FlxMetaData_obj::__register();
::flxanimate::animate::FlxAnim_obj::__register();
::flxanimate::animate::ButtonEvent_obj::__register();
::flxanimate::PsychFlxAnimate_obj::__register();
::flxanimate::FlxAnimate_obj::__register();
...
::crowplexus::iris::IrisCall_obj::__register();
::crowplexus::iris::IrisUsingClass_obj::__register();
::crowplexus::hscript::proxy::ProxyType_obj::__register();
...
::backend::ui::PsychUITab_obj::__register();
::backend::ui::PsychUIRadioItem_obj::__register();
::backend::ui::PsychUIEvent_obj::__register();
::backend::ui::PsychUIEventHandler_obj::__register();
::backend::ui::PsychUIDropDownItem_obj::__register();
::flixel::group::FlxTypedSpriteGroup_obj::__register();
::backend::animation::PsychAnimationController_obj::__register();
::flixel::animation::FlxAnimationController_obj::__register();
::backend::Song_obj::__register();
::backend::Rating_obj::__register();
::backend::PsychCamera_obj::__register();
::flixel::util::FlxPool_obj::__register();
::flixel::util::IFlxPool_obj::__register();
::flixel::util::IFlxPooled_obj::__register();
::backend::InputFormatter_obj::__register();
::backend::_Discord::DiscordPresence_obj::__register();
::backend::CustomFadeTransition_obj::__register();
::backend::MusicBeatSubstate_obj::__register();
...
::states::stages::objects::SpraycanState_obj::__boot();
...
::flxanimate::data::LayerType_obj::__boot();
::flxanimate::data::SymbolT_obj::__boot();
::flxanimate::data::Loop_obj::__boot();
::flxanimate::data::ColorEffect_obj::__boot();
...
::crowplexus::iris::ErrorSeverity_obj::__boot();
...
::backend::ALSoftConfig_obj::__init__();
...
::__ASSET__assets_embed_images_psych_ui_stepper_plus_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_checkbox_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_arrow_down_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_stepper_minus_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_radio_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_dropdown_button_png_obj::__boot();
::__ASSET__assets_embed_images_psych_ui_arrow_up_png_obj::__boot();
...
::__ASSET__flxanimate_images_pivot_png_obj::__boot();
::__ASSET__flxanimate_images_indicator_png_obj::__boot();
::openfl::text::Font_obj::__boot();
::haxe::SysTools_obj::__boot();
::Xml_obj::__boot();
::backend::ALSoftConfig_obj::__boot();
::backend::Achievements_obj::__boot();
...
::backend::ui::PsychUIBox_obj::__boot();
::backend::ui::PsychUIButton_obj::__boot();
::backend::ui::PsychUICheckBox_obj::__boot();
::backend::ui::PsychUIInputText_obj::__boot();
::backend::ui::PsychUIDropDownMenu_obj::__boot();
::backend::ui::PsychUINumericStepper_obj::__boot();
::backend::ui::PsychUIRadioGroup_obj::__boot();
::backend::ui::PsychUISlider_obj::__boot();
::crowplexus::iris::ErrorSeverityTools_obj::__boot();
::crowplexus::iris::Iris_obj::__boot();
::crowplexus::iris::utils::Ansi_obj::__boot();
::cutscenes::DialogueBoxPsych_obj::__boot();
::cutscenes::DialogueCharacter_obj::__boot();
...
::flixel::addons::transition::TransitionFade_obj::__boot();
...
::flixel::_hx_system::debug::interaction::Interaction_obj::__boot();
...
::flxanimate::animate::FlxElement_obj::__boot();
::flxanimate::filters::BevelFilter_obj::__boot();
::flxanimate::filters::GradientBevelFilter_obj::__boot();
::flxanimate::filters::GradientGlowFilter_obj::__boot();
::flxanimate::format::PropertyList_obj::__boot();
::flxanimate::frames::FlxAnimateFrames_obj::__boot();
::openfl::geom::Matrix3D_obj::__boot();
::flxanimate::motion::AdjustColor_obj::__boot();
::flxanimate::motion::DynamicMatrix_obj::__boot();
...
::objects::Alphabet_obj::__boot();
::objects::Character_obj::__boot();
::objects::MenuCharacter_obj::__boot();
::objects::Note_obj::__boot();
::objects::NoteSplash_obj::__boot();
...
::options::ControlsSubState_obj::__boot();
::options::OptionsState_obj::__boot();
::psychlua::CustomSubstate_obj::__boot();
::psychlua::FunkinLua_obj::__boot();
...
::states::editors::NoteSplashEditorState_obj::__boot();
::states::editors::WeekEditorState_obj::__boot();
::states::editors::content::MetaNote_obj::__boot();
::states::editors::content::VSlice_obj::__boot();
::states::stages::objects::TankmenBG_obj::__boot();
