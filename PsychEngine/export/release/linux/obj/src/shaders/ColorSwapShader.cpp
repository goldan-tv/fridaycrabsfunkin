...
HX_DEFINE_STACK_FRAME(_hx_pos_fe79ca0ba5a76a7b_213_new,"shaders.ColorSwapShader","new",0x3cfee0ed,"shaders.ColorSwapShader.new","shaders/ColorSwap.hx",213,0xb3f18f49)
namespace shaders{

void ColorSwapShader_obj::__construct(){
            	HX_STACKFRAME(&_hx_pos_fe79ca0ba5a76a7b_213_new)
...
HXLINE(  36)		this->_hx___isGenerated = true;
HXDLIN(  36)		this->_hx___initGL();
            	}
...
bool ColorSwapShader_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x19ee4531) {
		if (inClassId<=(int)0x04f93fcd) {
			return inClassId==(int)0x00000001 || inClassId==(int)0x04f93fcd;
		} else {
			return inClassId==(int)0x19ee4531;
		}
	} else {
...
::hx::ObjectPtr< ColorSwapShader_obj > ColorSwapShader_obj::__alloc(::hx::Ctx *_hx_ctx) {
	ColorSwapShader_obj *__this = (ColorSwapShader_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(ColorSwapShader_obj), true, "shaders.ColorSwapShader"));
...
void ColorSwapShader_obj::__register()
{
	...
	__mClass->mName = HX_("shaders.ColorSwapShader",7b,e6,8e,43);
