...
HX_DEFINE_STACK_FRAME(_hx_pos_cc9ea02fe2e2085e_292_new,"__ASSET__flixel_images_transitions_square_png","new",0x4d3675ae,"__ASSET__flixel_images_transitions_square_png.new","lime/_internal/macros/AssetsMacro.hx",292,0xc651f030)
HX_LOCAL_STACK_FRAME(_hx_pos_cc9ea02fe2e2085e_146_boot,"__ASSET__flixel_images_transitions_square_png","boot",0x3a898324,"__ASSET__flixel_images_transitions_square_png.boot","lime/_internal/macros/AssetsMacro.hx",146,0xc651f030)
...
void __ASSET__flixel_images_transitions_square_png_obj::__construct( ::lime::graphics::ImageBuffer buffer, ::Dynamic offsetX, ::Dynamic offsetY, ::Dynamic width, ::Dynamic height, ::Dynamic color, ::lime::graphics::ImageType type){
            	HX_STACKFRAME(&_hx_pos_cc9ea02fe2e2085e_292_new)
HXLINE( 293)		super::__construct(null(),null(),null(),null(),null(),null(),null());
HXLINE( 295)		this->_hx___fromBytes(::haxe::Resource_obj::getBytes(HX_("__ASSET__:image___ASSET__flixel_images_transitions_square_png",6e,55,71,54)),null());
            	}
...
{
{
            	HX_STACKFRAME(&_hx_pos_cc9ea02fe2e2085e_146_boot)
HXDLIN( 146)		resourceName = HX_("__ASSET__:image___ASSET__flixel_images_transitions_square_png",6e,55,71,54);
            	}
}
