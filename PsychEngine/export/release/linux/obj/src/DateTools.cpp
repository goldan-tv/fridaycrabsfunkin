...
HXLINE(  70)			 ::Dynamic _hx_tmp2;
HXDLIN(  70)			if ((hour == 0)) {
HXLINE(  70)				_hx_tmp2 = 12;
            			}
            			else {
HXLINE(  70)				_hx_tmp2 = hour;
            			}
HXDLIN(  70)			::String _hx_tmp3 = ::Std_obj::string(_hx_tmp2);
HXDLIN(  70)			::String _hx_tmp4;
HXDLIN(  70)			if ((e == HX_("I",49,00,00,00))) {
HXLINE(  70)				_hx_tmp4 = HX_("0",30,00,00,00);
            			}
            			else {
HXLINE(  70)				_hx_tmp4 = HX_(" ",20,00,00,00);
            			}
HXDLIN(  70)			return ::StringTools_obj::lpad(_hx_tmp3,_hx_tmp4,2);
...
HXLINE( 114)					::Array< ::String > r2 = r->b;
HXDLIN( 114)					r2->push(::Std_obj::string(x));
            				}
            			}
HXLINE( 116)			p = (np + 2);
            		}
            		_hx_goto_2:;
HXLINE( 118)		{
HXLINE( 118)			 ::Dynamic len1 = (f.length - p);
HXDLIN( 118)			if (::hx::IsNotNull( r->charBuf )) {
HXLINE( 118)				r->flush();
            			}
HXDLIN( 118)			if (::hx::IsNull( r->b )) {
HXLINE( 118)				r->b = ::Array_obj< ::String >::__new(1)->init(0,f.substr(p,len1));
            			}
            			else {
HXLINE( 118)				::Array< ::String > r3 = r->b;
HXDLIN( 118)				r3->push(f.substr(p,len1));
            			}
            		}
