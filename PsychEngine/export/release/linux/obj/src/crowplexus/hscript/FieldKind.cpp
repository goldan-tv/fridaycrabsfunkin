...
::crowplexus::hscript::FieldKind FieldKind_obj::KFunction( ::Dynamic f)
{
	return ::hx::CreateEnum< FieldKind_obj >(HX_("KFunction",83,2a,be,ba),0,1)->_hx_init(0,f);
}

::crowplexus::hscript::FieldKind FieldKind_obj::KVar( ::Dynamic v)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("crowplexus.hscript.FieldKind",c9,de,9a,51), ::hx::TCanCast< FieldKind_obj >,FieldKind_obj_sStaticFields,0,
