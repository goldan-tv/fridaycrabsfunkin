...
::crowplexus::hscript::Const Const_obj::CFloat(Float f)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CFloat",59,62,ad,5f),1,1)->_hx_init(0,f);
}

::crowplexus::hscript::Const Const_obj::CInt(int v)
{
	return ::hx::CreateEnum< Const_obj >(HX_("CInt",6c,10,81,2c),0,1)->_hx_init(0,v);
}

::crowplexus::hscript::Const Const_obj::CString(::String s)
{
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("crowplexus.hscript.Const",7e,a7,5f,e4), ::hx::TCanCast< Const_obj >,Const_obj_sStaticFields,0,
