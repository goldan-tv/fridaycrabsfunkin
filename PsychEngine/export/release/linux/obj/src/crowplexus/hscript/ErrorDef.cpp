...
::crowplexus::hscript::ErrorDef ErrorDef_obj::ECustom(::String msg)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("ECustom",d6,fd,6f,a9),9,1)->_hx_init(0,msg);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EInvalidAccess(::String f)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidAccess",76,c0,1f,d1),8,1)->_hx_init(0,f);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EInvalidChar(int c)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidChar",28,d1,99,46),0,1)->_hx_init(0,c);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EInvalidIterator(::String v)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidIterator",40,4d,71,f2),6,1)->_hx_init(0,v);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EInvalidOp(::String op)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidOp",f3,3a,13,f7),7,1)->_hx_init(0,op);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EInvalidPreprocessor(::String msg)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EInvalidPreprocessor",21,d5,28,58),4,1)->_hx_init(0,msg);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EUnexpected(::String s)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EUnexpected",76,02,98,78),1,1)->_hx_init(0,s);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EUnknownVariable(::String v)
{
	return ::hx::CreateEnum< ErrorDef_obj >(HX_("EUnknownVariable",21,a9,3e,5f),5,1)->_hx_init(0,v);
}

::crowplexus::hscript::ErrorDef ErrorDef_obj::EUnterminatedComment;

::crowplexus::hscript::ErrorDef ErrorDef_obj::EUnterminatedString;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("crowplexus.hscript.ErrorDef",a2,87,c5,d0), ::hx::TCanCast< ErrorDef_obj >,ErrorDef_obj_sStaticFields,0,
...
{
EUnterminatedComment = ::hx::CreateConstEnum< ErrorDef_obj >(HX_("EUnterminatedComment",fe,ed,ab,07),3);
EUnterminatedString = ::hx::CreateConstEnum< ErrorDef_obj >(HX_("EUnterminatedString",12,4e,75,07),2);
}
