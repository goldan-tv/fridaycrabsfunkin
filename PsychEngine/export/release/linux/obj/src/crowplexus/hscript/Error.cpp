...
HX_DEFINE_STACK_FRAME(_hx_pos_c2c9be46dde141ff_147_new,"crowplexus.hscript.Error","new",0xcd8d4855,"crowplexus.hscript.Error.new","crowplexus/hscript/Expr.hx",147,0x8be9fac2)
HX_LOCAL_STACK_FRAME(_hx_pos_c2c9be46dde141ff_156_toString,"crowplexus.hscript.Error","toString",0x49f56097,"crowplexus.hscript.Error.toString","crowplexus/hscript/Expr.hx",156,0x8be9fac2)
namespace crowplexus{
namespace hscript{

void Error_obj::__construct( ::crowplexus::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line){
            	HX_STACKFRAME(&_hx_pos_c2c9be46dde141ff_147_new)
HXLINE( 148)		this->e = e;
HXLINE( 149)		this->pmin = pmin;
HXLINE( 150)		this->pmax = pmax;
HXLINE( 151)		this->origin = origin;
HXLINE( 152)		this->line = line;
            	}
...
bool Error_obj::_hx_isInstanceOf(int inClassId) {
	return inClassId==(int)0x00000001 || inClassId==(int)0x2faf54b9;
}

::String Error_obj::toString(){
            	HX_STACKFRAME(&_hx_pos_c2c9be46dde141ff_156_toString)
HXDLIN( 156)		return ::crowplexus::hscript::Printer_obj::errorToString(::hx::ObjectPtr<OBJ_>(this),null());
            	}
...
::hx::ObjectPtr< Error_obj > Error_obj::__new( ::crowplexus::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line) {
	::hx::ObjectPtr< Error_obj > __this = new Error_obj();
	__this->__construct(e,pmin,pmax,origin,line);
	return __this;
}

::hx::ObjectPtr< Error_obj > Error_obj::__alloc(::hx::Ctx *_hx_ctx, ::crowplexus::hscript::ErrorDef e,int pmin,int pmax,::String origin,int line) {
	Error_obj *__this = (Error_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(Error_obj), true, "crowplexus.hscript.Error"));
...
::hx::Val Error_obj::__SetField(const ::String &inName,const ::hx::Val &inValue,::hx::PropertyAccess inCallProp)
{
	switch(inName.length) {
	case 1:
		if (HX_FIELD_EQ(inName,"e") ) { e=inValue.Cast<  ::crowplexus::hscript::ErrorDef >(); return inValue; }
		break;
	case 4:
...
static ::hx::StorageInfo Error_obj_sMemberStorageInfo[] = {
	{::hx::fsObject /*  ::crowplexus::hscript::ErrorDef */ ,(int)offsetof(Error_obj,e),HX_("e",65,00,00,00)},
...
void Error_obj::__register()
{
	...
	__mClass->mName = HX_("crowplexus.hscript.Error",e3,79,2b,0d);
