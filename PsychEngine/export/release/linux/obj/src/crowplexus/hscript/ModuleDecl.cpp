...
::crowplexus::hscript::ModuleDecl ModuleDecl_obj::DClass( ::Dynamic c)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DClass",54,71,ca,0b),2,1)->_hx_init(0,c);
}

::crowplexus::hscript::ModuleDecl ModuleDecl_obj::DImport(::Array< ::String > path, ::Dynamic everything,::String as)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DImport",c9,a0,ca,48),1,3)->_hx_init(0,path)->_hx_init(1,everything)->_hx_init(2,as);
}

::crowplexus::hscript::ModuleDecl ModuleDecl_obj::DPackage(::Array< ::String > path)
{
	return ::hx::CreateEnum< ModuleDecl_obj >(HX_("DPackage",a2,a3,68,40),0,1)->_hx_init(0,path);
}

::crowplexus::hscript::ModuleDecl ModuleDecl_obj::DTypedef( ::Dynamic c)
{
...
STATIC_HX_DEFINE_DYNAMIC_FUNC3(ModuleDecl_obj,DImport,return)
...
int ModuleDecl_obj::__FindArgCount(::String inName)
{
	...
	if (inName==HX_("DImport",c9,a0,ca,48)) return 3;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("crowplexus.hscript.ModuleDecl",3b,c7,72,99), ::hx::TCanCast< ModuleDecl_obj >,ModuleDecl_obj_sStaticFields,0,
