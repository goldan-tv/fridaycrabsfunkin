...
::crowplexus::hscript::Token Token_obj::TBkClose;

::crowplexus::hscript::Token Token_obj::TBkOpen;

::crowplexus::hscript::Token Token_obj::TBrClose;

::crowplexus::hscript::Token Token_obj::TBrOpen;

::crowplexus::hscript::Token Token_obj::TComma;

::crowplexus::hscript::Token Token_obj::TConst( ::crowplexus::hscript::Const c)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TConst",6f,b8,85,73),1,1)->_hx_init(0,c);
}

::crowplexus::hscript::Token Token_obj::TDot;

::crowplexus::hscript::Token Token_obj::TDoubleDot;

::crowplexus::hscript::Token Token_obj::TEof;

::crowplexus::hscript::Token Token_obj::TId(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TId",4f,fd,3f,00),2,1)->_hx_init(0,s);
}

::crowplexus::hscript::Token Token_obj::TMeta(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TMeta",39,31,db,90),15,1)->_hx_init(0,s);
}

::crowplexus::hscript::Token Token_obj::TOp(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TOp",95,02,40,00),3,1)->_hx_init(0,s);
}

::crowplexus::hscript::Token Token_obj::TPClose;

::crowplexus::hscript::Token Token_obj::TPOpen;

::crowplexus::hscript::Token Token_obj::TPrepro(::String s)
{
	return ::hx::CreateEnum< Token_obj >(HX_("TPrepro",5e,e3,5d,88),16,1)->_hx_init(0,s);
}

::crowplexus::hscript::Token Token_obj::TQuestion;

::crowplexus::hscript::Token Token_obj::TQuestionDot;

::crowplexus::hscript::Token Token_obj::TSemicolon;
...
int Token_obj::__FindIndex(::String inName)
{
	...
	if (inName==HX_("TQuestionDot",0f,eb,b6,2b)) return 17;
...
::hx::Static(__mClass) = ::hx::_hx_RegisterClass(HX_("crowplexus.hscript.Token",14,31,2d,ae), ::hx::TCanCast< Token_obj >,Token_obj_sStaticFields,0,
...
TQuestionDot = ::hx::CreateConstEnum< Token_obj >(HX_("TQuestionDot",0f,eb,b6,2b),17);
