...
HX_DEFINE_STACK_FRAME(_hx_pos_1b1b35cf9434ab89_3_new,"objects.AttachedText","new",0x25c6189d,"objects.AttachedText.new","objects/AttachedText.hx",3,0xe1c2d292)
HX_LOCAL_STACK_FRAME(_hx_pos_1b1b35cf9434ab89_19_update,"objects.AttachedText","update",0x948241ec,"objects.AttachedText.update","objects/AttachedText.hx",19,0xe1c2d292)
namespace objects{
...
void AttachedText_obj::__construct(::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold, ::Dynamic __o_scale){
            	...
            	HX_STACKFRAME(&_hx_pos_1b1b35cf9434ab89_3_new)
HXLINE(   9)		this->copyAlpha = false;
HXLINE(   8)		this->copyVisible = true;
HXLINE(   6)		this->offsetY = ((Float)0);
HXLINE(   5)		this->offsetX = ((Float)0);
HXLINE(  11)		super::__construct(0,0,text,bold);
HXLINE(  13)		this->setScale(( (Float)(scale) ),null());
...
bool AttachedText_obj::_hx_isInstanceOf(int inClassId) {
	if (inClassId<=(int)0x3c49ca5d) {
		if (inClassId<=(int)0x2c01639b) {
			...
			return inClassId==(int)0x3c49ca5d;
		}
	} else {
...
void AttachedText_obj::update(Float elapsed){
            	HX_STACKFRAME(&_hx_pos_1b1b35cf9434ab89_19_update)
...
HXLINE(  22)			if (this->copyVisible) {
HXLINE(  23)				this->set_visible(this->sprTracker->visible);
            			}
...
::hx::ObjectPtr< AttachedText_obj > AttachedText_obj::__alloc(::hx::Ctx *_hx_ctx,::String __o_text, ::Dynamic __o_offsetX, ::Dynamic __o_offsetY, ::Dynamic __o_bold, ::Dynamic __o_scale) {
	AttachedText_obj *__this = (AttachedText_obj*)(::hx::Ctx::alloc(_hx_ctx, sizeof(AttachedText_obj), true, "objects.AttachedText"));
...
void AttachedText_obj::__register()
{
	...
	__mClass->mName = HX_("objects.AttachedText",2b,86,14,79);
